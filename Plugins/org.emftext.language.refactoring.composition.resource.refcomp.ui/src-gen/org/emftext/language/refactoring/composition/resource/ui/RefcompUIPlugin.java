 ...
 */
public class RefcompUIPlugin extends AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.refactoring.composition.resource.refcomp.ui";
	public static final String EDITOR_ID = "org.emftext.language.refactoring.composition.resource.ui.RefcompEditor";
	...
	private static RefcompUIPlugin plugin;
	
	public RefcompUIPlugin() {
		super();
	}
	...
	public static RefcompUIPlugin getDefault() {
		return plugin;
	}
	...
	protected static IStatus log(int type, String message, Throwable throwable) {
		IStatus status;
		if (throwable != null) {
			status = new Status(type, RefcompUIPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new Status(type, RefcompUIPlugin.PLUGIN_ID, message);
		}
		final RefcompUIPlugin pluginInstance = RefcompUIPlugin.getDefault();

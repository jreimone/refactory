...
public class RefcompOutlinePageTreeViewerComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof EObject && o2 instanceof EObject) {
			...
			org.emftext.language.refactoring.composition.resource.IRefcompNameProvider nameProvider = new org.emftext.language.refactoring.composition.resource.mopp.RefcompMetaInformation().createNameProvider();

 ...
 */
public class RefcompHighlighting implements ISelectionProvider, ISelectionChangedListener {
	...
	private org.emftext.language.refactoring.composition.resource.ui.RefcompEditor editor;
	private ProjectionViewer projectionViewer;
	private org.emftext.language.refactoring.composition.resource.ui.RefcompOccurrence occurrence;
	private org.emftext.language.refactoring.composition.resource.ui.RefcompBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements KeyListener, VerifyListener, MouseListener, org.emftext.language.refactoring.composition.resource.IRefcompBackgroundParsingListener {
	 ...
	 */
	public RefcompHighlighting(org.emftext.language.refactoring.composition.resource.IRefcompTextResource textResource, ProjectionViewer projectionViewer, org.emftext.language.refactoring.composition.resource.ui.RefcompColorManager colorManager, org.emftext.language.refactoring.composition.resource.ui.RefcompEditor editor) {
		this.display = Display.getCurrent();
		projectionViewer.getSelectionProvider();
		this.preferenceStore = org.emftext.language.refactoring.composition.resource.ui.RefcompUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		this.textWidget = projectionViewer.getTextWidget();
		this.projectionViewer = projectionViewer;
		this.occurrence = new org.emftext.language.refactoring.composition.resource.ui.RefcompOccurrence(textResource, projectionViewer);
		this.bracketSet = new org.emftext.language.refactoring.composition.resource.ui.RefcompBracketSet();
		this.colorManager = colorManager;
		this.isHighlightBrackets = preferenceStore.getBoolean(org.emftext.language.refactoring.composition.resource.ui.RefcompPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		this.bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, org.emftext.language.refactoring.composition.resource.ui.RefcompPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		this.black = colorManager.getColor(new RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.emftext.language.refactoring.composition.resource.ui.RefcompEditor editor) {
	...
	private void setBracketHighlighting(IDocument document) {
		...
		Position[] positions = positionHelper.getPositions(document, org.emftext.language.refactoring.composition.resource.ui.RefcompPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.emftext.language.refactoring.composition.resource.ui.RefcompPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(IDocument document, String category) {
		...
		if (category.equals(org.emftext.language.refactoring.composition.resource.ui.RefcompPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.emftext.language.refactoring.composition.resource.ui.RefcompEObjectSelection(selectedEObject));
				}
			}
		});
	}
	...
	public void resetValues() {
		isHighlightBrackets = preferenceStore.getBoolean(org.emftext.language.refactoring.composition.resource.ui.RefcompPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, org.emftext.language.refactoring.composition.resource.ui.RefcompPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));

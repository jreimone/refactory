 ...
 * </p>
 */
public class RefcompSyntaxColoringPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public RefcompSyntaxColoringPreferencePage() {
		super();
		
		org.emftext.language.refactoring.composition.resource.mopp.RefcompMetaInformation metaInformation = new org.emftext.language.refactoring.composition.resource.mopp.RefcompMetaInformation();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.language.refactoring.composition.resource.ui.RefcompSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.composition.resource.ui.RefcompSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.language.refactoring.composition.resource.ui.RefcompSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.composition.resource.ui.RefcompSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.language.refactoring.composition.resource.ui.RefcompSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.composition.resource.ui.RefcompSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.language.refactoring.composition.resource.ui.RefcompSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.composition.resource.ui.RefcompSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.language.refactoring.composition.resource.ui.RefcompSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.composition.resource.ui.RefcompSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.language.refactoring.composition.resource.ui.RefcompSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.composition.resource.ui.RefcompSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(Composite composite, int horizontalSpan) {
		org.emftext.language.refactoring.composition.resource.ui.RefcompPixelConverter pixelConverter = new org.emftext.language.refactoring.composition.resource.ui.RefcompPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.language.refactoring.composition.resource.ui.RefcompEditor) {
			org.emftext.language.refactoring.composition.resource.ui.RefcompEditor emfTextEditor = (org.emftext.language.refactoring.composition.resource.ui.RefcompEditor) editor;

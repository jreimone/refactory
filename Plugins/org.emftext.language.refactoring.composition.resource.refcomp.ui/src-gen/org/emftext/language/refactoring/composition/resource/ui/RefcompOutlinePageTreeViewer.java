 ...
 * a specified depth.
 */
public class RefcompOutlinePageTreeViewer extends TreeViewer {
	...
	public RefcompOutlinePageTreeViewer(Composite parent, int style) {
		super(parent, style);
	...
	public void setSelection(ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.emftext.language.refactoring.composition.resource.ui.RefcompEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.emftext.language.refactoring.composition.resource.mopp.RefcompPlugin.logError("Exception while refreshing outline view", e);
		}
	}

...
public class RefcompPropertySheetPage extends PropertySheetPage implements ISelectionChangedListener {
	...
	public void selectionChanged(IWorkbenchPart part, ISelection iSelection) {
		...
		if (iSelection instanceof org.emftext.language.refactoring.composition.resource.ui.RefcompEObjectSelection) {
			final org.emftext.language.refactoring.composition.resource.ui.RefcompEObjectSelection selection = (org.emftext.language.refactoring.composition.resource.ui.RefcompEObjectSelection) iSelection;

 ...
 */
public class RefcompHyperlink implements IHyperlink {
	 ...
	 */
	public RefcompHyperlink(IRegion region, EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.emftext.language.refactoring.composition.resource.mopp.RefcompPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}

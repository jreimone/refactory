 ...
 */
public class RefcompBackgroundParsingStrategy {
	 ...
	 */
	public void parse(DocumentEvent event, final org.emftext.language.refactoring.composition.resource.IRefcompTextResource resource, final org.emftext.language.refactoring.composition.resource.ui.RefcompEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(IDocument document, final org.emftext.language.refactoring.composition.resource.IRefcompTextResource resource, final org.emftext.language.refactoring.composition.resource.ui.RefcompEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.emftext.language.refactoring.composition.resource.IRefcompTextResource resource, final org.emftext.language.refactoring.composition.resource.ui.RefcompEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.emftext.language.refactoring.composition.resource.mopp.RefcompResource) {
							org.emftext.language.refactoring.composition.resource.mopp.RefcompResource concreteResource = (org.emftext.language.refactoring.composition.resource.mopp.RefcompResource) resource;

 ...
 */
public class RefcompEnumerationTerminal extends org.emftext.language.refactoring.composition.resource.grammar.RefcompTerminal {
	
	private Map<String, String> mapping = new LinkedHashMap<String, String>();
	
	public RefcompEnumerationTerminal(EStructuralFeature attribute, String[] literalMappings, org.emftext.language.refactoring.composition.resource.grammar.RefcompCardinality cardinality, int mandatoryOccurrencesAfter) {

 ...
 */
public class RefcompEObjectUtil {
	...
	public static Object invokeOperation(EObject element, EOperation o) {
		...
		try {
			...
			new org.emftext.language.refactoring.composition.resource.util.RefcompRuntimeUtil().logError("Exception while matching proxy URI.", e);

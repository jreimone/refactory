 ...
 */
public class RefcompResourceUtil {
	...
	public static Set<EObject> findUnresolvedProxies(ResourceSet resourceSet) {
		return new org.emftext.language.refactoring.composition.resource.util.RefcompInterruptibleEcoreResolver().findUnresolvedProxies(resourceSet);
	}
	...
	public static Set<EObject> findUnresolvedProxies(Resource resource) {
		return new org.emftext.language.refactoring.composition.resource.util.RefcompInterruptibleEcoreResolver().findUnresolvedProxies(resource);
	}
	...
	public static org.emftext.language.refactoring.composition.resource.mopp.RefcompResource getResource(File file) {
	...
	public static org.emftext.language.refactoring.composition.resource.mopp.RefcompResource getResource(URI uri, Map<?,?> options) {
		...
		return (org.emftext.language.refactoring.composition.resource.mopp.RefcompResource) resource;
	}
	 ...
	 */
	public static org.emftext.language.refactoring.refactoringcomposition.CompositeRoleMapping getResourceContent(URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static org.emftext.language.refactoring.refactoringcomposition.CompositeRoleMapping getResourceContent(URI uri, Map<?,?> options) {
		...
		return (org.emftext.language.refactoring.refactoringcomposition.CompositeRoleMapping) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static org.emftext.language.refactoring.refactoringcomposition.CompositeRoleMapping getResourceContent(String text) {
		return (org.emftext.language.refactoring.refactoringcomposition.CompositeRoleMapping) getResourceContent(text, null);
	}
	...
	public static EObject getResourceContent(String text, EClass startEClass) {
		...
		if (startEClass != null) {
			loadOptions.put(org.emftext.language.refactoring.composition.resource.IRefcompOptions.RESOURCE_CONTENT_TYPE, startEClass);
		}
	...
	public static String getText(EObject eObject) {
		...
		metaInformation.registerResourceFactory();
		ResourceSet rs = null;
		org.emftext.language.refactoring.composition.resource.mopp.RefcompResource resource = (org.emftext.language.refactoring.composition.resource.mopp.RefcompResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			URI uri = URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (org.emftext.language.refactoring.composition.resource.mopp.RefcompResource) rs.createResource(uri);
		}
		// Convert layout information to EAdapters because the printer retrieves layout
		// information from these adapters.
		org.emftext.language.refactoring.composition.resource.util.RefcompLayoutUtil layoutUtil = new org.emftext.language.refactoring.composition.resource.util.RefcompLayoutUtil();
		if (resource.isLayoutInformationRecordingEnabled()) {
			layoutUtil.transferAllLayoutInformationFromModel(eObject);
		}
		ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
		org.emftext.language.refactoring.composition.resource.IRefcompTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {

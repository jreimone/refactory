...
public class RefcompNature implements IProjectNature {
	
	public static final String NATURE_ID = "org.emftext.language.refactoring.composition.resource.refcomp.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.emftext.language.refactoring.composition.resource.mopp.RefcompBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.emftext.language.refactoring.composition.resource.mopp.RefcompBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}

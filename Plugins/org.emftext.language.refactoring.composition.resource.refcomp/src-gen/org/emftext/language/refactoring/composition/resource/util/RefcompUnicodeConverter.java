 ...
 * to 4 bytes).
 */
public class RefcompUnicodeConverter extends org.emftext.language.refactoring.composition.resource.mopp.RefcompInputStreamProcessor {
	 ...
	 */
	public RefcompUnicodeConverter(InputStream inputStream) {

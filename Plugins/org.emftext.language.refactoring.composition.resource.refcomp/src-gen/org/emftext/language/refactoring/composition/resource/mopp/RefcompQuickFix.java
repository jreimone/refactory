...
public abstract class RefcompQuickFix implements org.emftext.language.refactoring.composition.resource.IRefcompQuickFix {
	...
	public RefcompQuickFix(String displayString, String imageKey, EObject contextObject) {
		this(displayString, imageKey, Collections.singleton(contextObject), contextObject.eResource());
	}
	
	public RefcompQuickFix(String displayString, String imageKey, Collection<EObject> contextObjects) {
		this(displayString, imageKey, contextObjects, contextObjects.iterator().next().eResource());
	}
	
	public RefcompQuickFix(String displayString, String imageKey, Collection<EObject> contextObjects, Resource resource) {
		super();
	...
	public String apply(String currentText) {
		...
		try {
			...
			new org.emftext.language.refactoring.composition.resource.util.RefcompRuntimeUtil().logError("Exception while applying quick fix", e);
		}
		return null;
	}

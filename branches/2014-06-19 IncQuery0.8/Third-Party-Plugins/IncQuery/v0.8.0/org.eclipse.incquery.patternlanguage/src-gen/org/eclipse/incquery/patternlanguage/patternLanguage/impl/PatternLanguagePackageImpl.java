...
public class PatternLanguagePackageImpl extends EPackageImpl implements PatternLanguagePackage
{
   ...
   * @generated
   */
  private EClass functionEvaluationValueEClass = null;
  ...
  {
    return functionEvaluationValueEClass;
  }
  ...
  {
    return (EReference)functionEvaluationValueEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    functionEvaluationValueEClass = createEClass(FUNCTION_EVALUATION_VALUE);
    createEReference(functionEvaluationValueEClass, FUNCTION_EVALUATION_VALUE__EXPRESSION);
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(functionEvaluationValueEClass, FunctionEvaluationValue.class, "FunctionEvaluationValue", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getFunctionEvaluationValue_Expression(), theXbasePackage.getXExpression(), null, "expression", null, 0, 1, FunctionEvaluationValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

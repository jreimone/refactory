 ...
 * @generated
 */
public class vapoditraceSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case vapoditracePackage.TRACE_LINK: {
				TraceLink traceLink = (TraceLink)theEObject;
				T result = caseTraceLink(traceLink);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case vapoditracePackage.TRACE_COLLECTION: {
				TraceCollection traceCollection = (TraceCollection)theEObject;
				T result = caseTraceCollection(traceCollection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case vapoditracePackage.EENTITY: {
				EEntity eEntity = (EEntity)theEObject;
				T result = caseEEntity(eEntity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case vapoditracePackage.TRACE_ENTITY: {
				TraceEntity traceEntity = (TraceEntity)theEObject;
				T result = caseTraceEntity(traceEntity);
				if (result == null) result = caseEEntity(traceEntity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case vapoditracePackage.DYNAMIC_ENTITY: {
				DynamicEntity dynamicEntity = (DynamicEntity)theEObject;
				T result = caseDynamicEntity(dynamicEntity);
				if (result == null) result = caseTraceEntity(dynamicEntity);
				if (result == null) result = caseEEntity(dynamicEntity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case vapoditracePackage.STATIC_ENTITY: {
				StaticEntity staticEntity = (StaticEntity)theEObject;
				T result = caseStaticEntity(staticEntity);
				if (result == null) result = caseTraceEntity(staticEntity);
				if (result == null) result = caseEEntity(staticEntity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Trace Collection</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Trace Collection</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTraceCollection(TraceCollection object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseTraceEntity(TraceEntity object) {
		return null;
	}

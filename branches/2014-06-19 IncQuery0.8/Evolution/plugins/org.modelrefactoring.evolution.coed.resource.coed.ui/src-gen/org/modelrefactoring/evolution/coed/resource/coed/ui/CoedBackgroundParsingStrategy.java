 ...
 */
public class CoedBackgroundParsingStrategy {
	 ...
	 */
	public void parse(DocumentEvent event, final org.modelrefactoring.evolution.coed.resource.coed.ICoedTextResource resource, final org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(IDocument document, final org.modelrefactoring.evolution.coed.resource.coed.ICoedTextResource resource, final org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.modelrefactoring.evolution.coed.resource.coed.ICoedTextResource resource, final org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.modelrefactoring.evolution.coed.resource.coed.mopp.CoedResource) {
							org.modelrefactoring.evolution.coed.resource.coed.mopp.CoedResource concreteResource = (org.modelrefactoring.evolution.coed.resource.coed.mopp.CoedResource) resource;

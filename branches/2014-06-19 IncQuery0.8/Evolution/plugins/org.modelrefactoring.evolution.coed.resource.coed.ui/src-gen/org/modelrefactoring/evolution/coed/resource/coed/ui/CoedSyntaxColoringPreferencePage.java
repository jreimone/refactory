 ...
 */
public class CoedSyntaxColoringPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public CoedSyntaxColoringPreferencePage() {
		super();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.modelrefactoring.evolution.coed.resource.coed.ui.CoedSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.modelrefactoring.evolution.coed.resource.coed.ui.CoedSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.modelrefactoring.evolution.coed.resource.coed.ui.CoedSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.modelrefactoring.evolution.coed.resource.coed.ui.CoedSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.modelrefactoring.evolution.coed.resource.coed.ui.CoedSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.modelrefactoring.evolution.coed.resource.coed.ui.CoedSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.modelrefactoring.evolution.coed.resource.coed.ui.CoedSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.modelrefactoring.evolution.coed.resource.coed.ui.CoedSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.modelrefactoring.evolution.coed.resource.coed.ui.CoedSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.modelrefactoring.evolution.coed.resource.coed.ui.CoedSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.modelrefactoring.evolution.coed.resource.coed.ui.CoedSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.modelrefactoring.evolution.coed.resource.coed.ui.CoedSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(Composite composite, int horizontalSpan) {
		org.modelrefactoring.evolution.coed.resource.coed.ui.CoedPixelConverter pixelConverter = new org.modelrefactoring.evolution.coed.resource.coed.ui.CoedPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor) {
			org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor emfTextEditor = (org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor) editor;

...
public class CoedPropertySheetPage extends PropertySheetPage implements ISelectionChangedListener {
	...
	public void selectionChanged(IWorkbenchPart part, ISelection iSelection) {
		...
		if (iSelection instanceof org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEObjectSelection) {
			final org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEObjectSelection selection = (org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEObjectSelection) iSelection;

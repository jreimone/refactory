 ...
 * @since 3.2
 */
public class CoedBrowserInformationControl extends AbstractInformationControl implements IInformationControlExtension2, IDelayedInputChangeProvider {
	...
	private org.modelrefactoring.evolution.coed.resource.coed.ui.CoedDocBrowserInformationControlInput fInput;
	 ...
	 */
	public CoedBrowserInformationControl(Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public CoedBrowserInformationControl(Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public CoedBrowserInformationControl(Shell parent, String symbolicFontName, ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		Assert.isLegal(input == null || input instanceof String || input instanceof org.modelrefactoring.evolution.coed.resource.coed.ui.CoedDocBrowserInformationControlInput);
		...
		fInput= (org.modelrefactoring.evolution.coed.resource.coed.ui.CoedDocBrowserInformationControlInput) input;
		...
		org.modelrefactoring.evolution.coed.resource.coed.ui.CoedHTMLPrinter.insertStyles(buffer, styles);
	...
	public Point computeSizeHint() {
		...
		String text;
		try {
			text = org.modelrefactoring.evolution.coed.resource.coed.ui.CoedHTMLPrinter.html2text(new StringReader(fInput.getHtml()), presentation);
		} catch (IOException e) {
			text = "";
		}
	 ...
	 */
	public org.modelrefactoring.evolution.coed.resource.coed.ui.CoedDocBrowserInformationControlInput getInput() {
		return fInput;
	}

...
public class CoedOutlinePageTreeViewerComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof EObject && o2 instanceof EObject) {
			...
			org.modelrefactoring.evolution.coed.resource.coed.ICoedNameProvider nameProvider = new org.modelrefactoring.evolution.coed.resource.coed.mopp.CoedMetaInformation().createNameProvider();

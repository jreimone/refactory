 ...
 */
public class CoedUIPlugin extends AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.modelrefactoring.evolution.coed.resource.coed.ui";
	public static final String EDITOR_ID = "org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor";
	...
	private static CoedUIPlugin plugin;
	...
	public static CoedUIPlugin getDefault() {
		return plugin;
	}
	...
	protected static IStatus log(int type, String message, Throwable throwable) {
		IStatus status;
		if (throwable != null) {
			status = new Status(type, CoedUIPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new Status(type, CoedUIPlugin.PLUGIN_ID, message);
		}
		final CoedUIPlugin pluginInstance = CoedUIPlugin.getDefault();

 ...
 * @since 3.2
 */
public class OperatorsBrowserInformationControl extends AbstractInformationControl implements IInformationControlExtension2, IDelayedInputChangeProvider {
	...
	private org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsDocBrowserInformationControlInput fInput;
	 ...
	 */
	public OperatorsBrowserInformationControl(Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public OperatorsBrowserInformationControl(Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public OperatorsBrowserInformationControl(Shell parent, String symbolicFontName, ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		Assert.isLegal(input == null || input instanceof String || input instanceof org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsDocBrowserInformationControlInput);
		...
		fInput= (org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsDocBrowserInformationControlInput) input;
		...
		org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsHTMLPrinter.insertStyles(buffer, styles);
	...
	public Point computeSizeHint() {
		...
		String text;
		try {
			text = org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsHTMLPrinter.html2text(new StringReader(fInput.getHtml()), presentation);
		} catch (IOException e) {
			text = "";
		}
	 ...
	 */
	public org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsDocBrowserInformationControlInput getInput() {
		return fInput;
	}

...
public class OperatorsNature implements IProjectNature {
	
	public static final String NATURE_ID = "org.modelrefactoring.evolution.operators.resource.operators.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}

 ...
 */
public class OperatorsRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {

 ...
 */
public class OperatorsExpectedTerminal {
	...
	private org.modelrefactoring.evolution.operators.resource.operators.IOperatorsExpectedElement terminal;
	private int startIncludingHiddenTokens;
	private int startExcludingHiddenTokens;
	private String prefix;
	private org.modelrefactoring.evolution.operators.resource.operators.grammar.OperatorsContainmentTrace containmentTrace;
	
	public OperatorsExpectedTerminal(EObject container, org.modelrefactoring.evolution.operators.resource.operators.IOperatorsExpectedElement terminal, int followSetID, org.modelrefactoring.evolution.operators.resource.operators.grammar.OperatorsContainmentTrace containmentTrace) {
		super();
	...
	public org.modelrefactoring.evolution.operators.resource.operators.IOperatorsExpectedElement getTerminal() {
		return terminal;
	}
	...
	public boolean equals(Object o) {
		...
		OperatorsExpectedTerminal otherExpectedTerminal = (OperatorsExpectedTerminal) o;
	...
	public org.modelrefactoring.evolution.operators.resource.operators.grammar.OperatorsContainmentTrace getContainmentTrace() {

 ...
 */
public class OperatorsDefaultTokenResolver implements org.modelrefactoring.evolution.operators.resource.operators.IOperatorsTokenResolver {
	 ...
	 */
	public OperatorsDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public OperatorsDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, EStructuralFeature feature, org.modelrefactoring.evolution.operators.resource.operators.IOperatorsTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.modelrefactoring.evolution.operators.resource.operators.grammar.OperatorsGrammarInformationProvider.INSTANCE.getKeywords()) {

 ...
 * <ul>
 *   <li>{@link org.modelrefactoring.evolution.coed.impl.EventImpl#getCoED <em>Co ED</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class EventImpl extends MinimalEObjectImpl.Container implements Event {
  ...
  {
    if (eContainerFeatureID() != CoedPackage.EVENT__CO_ED) return null;
  ...
  {
    msgs = eBasicSetContainer((InternalEObject)newCoED, CoedPackage.EVENT__CO_ED, msgs);
    return msgs;
  }
  ...
  {
    if (newCoED != eInternalContainer() || (eContainerFeatureID() != CoedPackage.EVENT__CO_ED && newCoED != null))
    {
      ...
      if (newCoED != null)
        msgs = ((InternalEObject)newCoED).eInverseAdd(this, CoedPackage.CO_EVOLUTION_DEFINITION__EVENT, CoEvolutionDefinition.class, msgs);
      msgs = basicSetCoED(newCoED, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CoedPackage.EVENT__CO_ED, newCoED, newCoED));
  }
  ...
  public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
  {
    ...
    {
      case CoedPackage.EVENT__CO_ED:
        return eInternalContainer().eInverseRemove(this, CoedPackage.CO_EVOLUTION_DEFINITION__EVENT, CoEvolutionDefinition.class, msgs);
    }

...
public class CoedCopiedEObjectInternalEList extends org.modelrefactoring.evolution.coed.resource.coed.util.CoedCopiedEList<EObject> implements InternalEList<EObject> {
	
	private InternalEList<EObject> original;
	private InternalEList<EObject> copy;
	
	public CoedCopiedEObjectInternalEList(InternalEList<EObject> original) {
		super(original);

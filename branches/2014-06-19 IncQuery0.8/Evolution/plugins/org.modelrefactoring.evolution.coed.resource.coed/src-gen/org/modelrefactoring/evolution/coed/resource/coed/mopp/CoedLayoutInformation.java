...
/**
 * CoedLayoutInformation objects are used to store layout information that is
 ...
 * CoedLayoutInformations are aggregated in LayoutInformationAdapters. One
 * CoedLayoutInformation contains the layout that was found before a keyword,
 * attribute or reference.
 */
public class CoedLayoutInformation {
	 ...
	 */
	private final org.modelrefactoring.evolution.coed.resource.coed.grammar.CoedSyntaxElement syntaxElement;
	...
	public CoedLayoutInformation(org.modelrefactoring.evolution.coed.resource.coed.grammar.CoedSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public org.modelrefactoring.evolution.coed.resource.coed.grammar.CoedSyntaxElement getSyntaxElement() {

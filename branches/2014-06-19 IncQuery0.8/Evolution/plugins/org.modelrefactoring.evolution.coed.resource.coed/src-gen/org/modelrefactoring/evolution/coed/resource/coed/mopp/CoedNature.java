...
public class CoedNature implements IProjectNature {
	
	public static final String NATURE_ID = "org.modelrefactoring.evolution.coed.resource.coed.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.modelrefactoring.evolution.coed.resource.coed.mopp.CoedBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.modelrefactoring.evolution.coed.resource.coed.mopp.CoedBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}

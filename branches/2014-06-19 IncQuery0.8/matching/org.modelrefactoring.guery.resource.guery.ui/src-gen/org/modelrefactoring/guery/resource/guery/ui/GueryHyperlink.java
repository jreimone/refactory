 ...
 */
public class GueryHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public GueryHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.modelrefactoring.guery.resource.guery.mopp.GueryPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}

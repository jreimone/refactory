...
public class GueryBracketSet {
	...
	private java.util.ArrayList<org.modelrefactoring.guery.resource.guery.IGueryBracketPair> bracketPairs;
	private String languageID;
	
	/**
	 * Creates a new bracket set to manage bracket pairs.
	 */
	public GueryBracketSet() {
		super();
		this.languageID = new org.modelrefactoring.guery.resource.guery.mopp.GueryMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.modelrefactoring.guery.resource.guery.IGueryBracketPair>();
	}
	...
	public org.modelrefactoring.guery.resource.guery.IGueryBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public org.modelrefactoring.guery.resource.guery.IGueryBracketPair getBracketPair(String opening, String closing) {
		for (org.modelrefactoring.guery.resource.guery.IGueryBracketPair bracketPair : bracketPairs) {
	...
	public boolean addBracketPair(String opening, String closing, boolean closingEnabledInside, boolean closeAfterEnter) {
		...
		bracketPairs.add(new org.modelrefactoring.guery.resource.guery.mopp.GueryBracketPair(opening, closing, closingEnabledInside, closeAfterEnter));
		return true;
	}
	...
	public boolean resetBrackets(org.eclipse.jface.preference.IPreferenceStore preferenceStore) {
		String bracketPairs = preferenceStore.getString(languageID + org.modelrefactoring.guery.resource.guery.ui.GueryPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.modelrefactoring.guery.resource.guery.IGueryBracketPair remove(String opening, String closing) {
		for (org.modelrefactoring.guery.resource.guery.IGueryBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public void deserialize(String bracketSet) {
		bracketPairs = new java.util.ArrayList<org.modelrefactoring.guery.resource.guery.IGueryBracketPair>();
	...
	public void findAndHighlightMatchingBrackets(org.eclipse.jface.text.IDocument document, int caretOffset) {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.modelrefactoring.guery.resource.guery.ui.GueryPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.modelrefactoring.guery.resource.guery.ui.GueryPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}

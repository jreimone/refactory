 ...
 */
public class GuerySourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private org.modelrefactoring.guery.resource.guery.ui.GueryQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public GuerySourceViewerConfiguration(org.modelrefactoring.guery.resource.guery.IGueryResourceProvider resourceProvider, org.modelrefactoring.guery.resource.guery.ui.IGueryAnnotationModelProvider annotationModelProvider, org.modelrefactoring.guery.resource.guery.ui.GueryColorManager colorManager) {
		super(org.modelrefactoring.guery.resource.guery.ui.GueryUIPlugin.getDefault().getPreferenceStore());
	 ...
	 * org.modelrefactoring.guery.resource.guery.ui.GueryAutoEditStrategy.
	 */
	public org.eclipse.jface.text.IAutoEditStrategy[] getAutoEditStrategies(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.eclipse.jface.text.IAutoEditStrategy[] {new org.modelrefactoring.guery.resource.guery.ui.GueryAutoEditStrategy()};
	}
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new org.modelrefactoring.guery.resource.guery.ui.GueryCompletionProcessor(resourceProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new org.modelrefactoring.guery.resource.guery.ui.GueryUIMetaInformation().createTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.modelrefactoring.guery.resource.guery.ui.GueryTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new org.modelrefactoring.guery.resource.guery.ui.GueryHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new org.modelrefactoring.guery.resource.guery.ui.GueryQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new org.modelrefactoring.guery.resource.guery.ui.GueryIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}

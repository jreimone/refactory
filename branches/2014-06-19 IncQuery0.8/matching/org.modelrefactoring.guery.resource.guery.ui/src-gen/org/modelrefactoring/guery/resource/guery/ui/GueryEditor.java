...
/**
 * A text editor for 'guery' models.
 * <p>
 * This editor has id
 * <code>org.modelrefactoring.guery.resource.guery.ui.GueryEditor</code>
 * The editor's context menu has id
 * <code>org.modelrefactoring.guery.resource.guery.EditorContext</code>.
 * The editor's ruler context menu has id
 * <code>org.modelrefactoring.guery.resource.guery.EditorRuler</code>.
 * The editor's editing context has id
 * <code>org.modelrefactoring.guery.resource.guery.EditorScope</code>.
 * </p>
 */
public class GueryEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.modelrefactoring.guery.resource.guery.IGueryResourceProvider, org.modelrefactoring.guery.resource.guery.ui.IGueryBracketHandlerProvider, org.modelrefactoring.guery.resource.guery.ui.IGueryAnnotationModelProvider {
	
	private org.modelrefactoring.guery.resource.guery.ui.GueryHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.modelrefactoring.guery.resource.guery.ui.GueryCodeFoldingManager codeFoldingManager;
	private org.modelrefactoring.guery.resource.guery.ui.GueryBackgroundParsingStrategy bgParsingStrategy = new org.modelrefactoring.guery.resource.guery.ui.GueryBackgroundParsingStrategy();
	private java.util.Collection<org.modelrefactoring.guery.resource.guery.IGueryBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.modelrefactoring.guery.resource.guery.IGueryBackgroundParsingListener>();
	private org.modelrefactoring.guery.resource.guery.ui.GueryColorManager colorManager = new org.modelrefactoring.guery.resource.guery.ui.GueryColorManager();
	private org.modelrefactoring.guery.resource.guery.ui.GueryOutlinePage outlinePage;
	...
	private org.modelrefactoring.guery.resource.guery.ui.GueryPropertySheetPage propertySheetPage;
	...
	private org.modelrefactoring.guery.resource.guery.ui.IGueryBracketHandler bracketHandler;
	...
	public GueryEditor() {
		super();
		setSourceViewerConfiguration(new org.modelrefactoring.guery.resource.guery.ui.GuerySourceViewerConfiguration(this, this, colorManager));
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), GueryEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.modelrefactoring.guery.resource.guery.IGueryTextResource currentResource = getResource();
				...
				org.modelrefactoring.guery.resource.guery.ui.GueryUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.modelrefactoring.guery.resource.guery.EditorContext");
		setRulerContextMenuId("org.modelrefactoring.guery.resource.guery.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.modelrefactoring.guery.resource.guery.ui.GueryHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.modelrefactoring.guery.resource.guery.ui.GueryCodeFoldingManager(viewer, this);
		...
		contextService.activateContext("org.modelrefactoring.guery.resource.guery.EditorScope");
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.modelrefactoring.guery.resource.guery.mopp.GueryNature.activate(inputFile.getProject());
		...
		org.modelrefactoring.guery.resource.guery.IGueryTextResource loadedResource = (org.modelrefactoring.guery.resource.guery.IGueryTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.modelrefactoring.guery.resource.guery.IGueryTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.modelrefactoring.guery.resource.guery.IGueryTextResource) {
					setResource((org.modelrefactoring.guery.resource.guery.IGueryTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.modelrefactoring.guery.resource.guery.ui.GueryUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the GueryEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.modelrefactoring.guery.resource.guery.ui.GueryUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.modelrefactoring.guery.resource.guery.IGueryTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.modelrefactoring.guery.resource.guery.ui.GueryOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.modelrefactoring.guery.resource.guery.ui.GueryPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.modelrefactoring.guery.resource.guery.IGueryTextResource textResource = (org.modelrefactoring.guery.resource.guery.IGueryTextResource) element.eResource();
			...
			org.modelrefactoring.guery.resource.guery.IGueryTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.modelrefactoring.guery.resource.guery.IGueryTextToken token = lexer.getNextToken();
			...
			org.modelrefactoring.guery.resource.guery.ui.GueryUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!GueryEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.modelrefactoring.guery.resource.guery.IGueryBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.modelrefactoring.guery.resource.guery.IGueryBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.modelrefactoring.guery.resource.guery.ui.IGueryBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.modelrefactoring.guery.resource.guery.ui.IGueryBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof org.modelrefactoring.guery.resource.guery.IGueryTextResource)) {
					return false;
				}
				org.modelrefactoring.guery.resource.guery.IGueryTextResource textResource = (org.modelrefactoring.guery.resource.guery.IGueryTextResource) resource;
				org.modelrefactoring.guery.resource.guery.IGueryLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;

 ...
 */
public class GueryDefaultTokenResolver implements org.modelrefactoring.guery.resource.guery.IGueryTokenResolver {
	 ...
	 */
	public GueryDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public GueryDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.modelrefactoring.guery.resource.guery.IGueryTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.modelrefactoring.guery.resource.guery.grammar.GueryGrammarInformationProvider.INSTANCE.getKeywords()) {

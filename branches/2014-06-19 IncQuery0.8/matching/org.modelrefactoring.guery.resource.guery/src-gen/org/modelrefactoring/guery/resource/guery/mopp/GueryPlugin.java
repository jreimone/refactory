 ...
 */
public class GueryPlugin extends org.eclipse.core.runtime.Plugin {
	
	public static final String PLUGIN_ID = "org.modelrefactoring.guery.resource.guery";
	/**
	...
	private static GueryPlugin plugin;
	...
	public static GueryPlugin getDefault() {
		return plugin;
	}
	...
	protected static org.eclipse.core.runtime.IStatus log(int type, String message, Throwable throwable) {
		...
		if (throwable != null) {
			status = new org.eclipse.core.runtime.Status(type, GueryPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new org.eclipse.core.runtime.Status(type, GueryPlugin.PLUGIN_ID, message);
		}
		final GueryPlugin pluginInstance = GueryPlugin.getDefault();

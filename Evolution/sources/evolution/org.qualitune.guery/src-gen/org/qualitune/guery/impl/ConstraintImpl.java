 ...
 * <ul>
 *   <li>{@link org.qualitune.guery.impl.ConstraintImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConstraintImpl extends EObjectImpl implements Constraint {
	...
	public EList<String> getExpressions() {
		if (expressions == null) {
			expressions = new EDataTypeUniqueEList<String>(String.class, this, GueryPackage.CONSTRAINT__EXPRESSIONS);
		}
		return expressions;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GueryPackage.CONSTRAINT__EXPRESSIONS:

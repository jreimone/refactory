 ...
 * <ul>
 *   <li>{@link org.qualitune.guery.impl.PreProcessorImpl#getClassName <em>Class Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PreProcessorImpl extends EObjectImpl implements PreProcessor {
	...
	public void setClassName(String newClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GueryPackage.PRE_PROCESSOR__CLASS_NAME, oldClassName, className));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GueryPackage.PRE_PROCESSOR__CLASS_NAME:
				return getClassName();
		}

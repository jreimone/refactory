...
public class GueryNature implements org.eclipse.core.resources.IProjectNature {
	...
	public static final String NATURE_ID = "org.qualitune.guery.resource.guery.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.qualitune.guery.resource.guery.mopp.GueryBuilderAdapter.BUILDER_ID, org.qualitune.guery.resource.guery.mopp.GueryTaskItemBuilder.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.qualitune.guery.resource.guery.mopp.GueryBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}

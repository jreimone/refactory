...
public class GueryRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.qualitune.guery.resource.guery.mopp.GueryPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.qualitune.guery.resource.guery.mopp.GueryPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {

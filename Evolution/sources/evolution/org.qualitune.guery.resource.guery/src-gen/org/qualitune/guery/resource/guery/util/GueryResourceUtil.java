...
public class GueryResourceUtil {
	...
	public static org.qualitune.guery.resource.guery.mopp.GueryResource getResource(java.io.File file) {
	...
	public static org.qualitune.guery.resource.guery.mopp.GueryResource getResource(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		new org.qualitune.guery.resource.guery.mopp.GueryMetaInformation().registerResourceFactory();
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {
			rs.getLoadOptions().putAll(options);
		}
		org.eclipse.emf.ecore.resource.Resource resource = rs.getResource(uri, true);
		return (org.qualitune.guery.resource.guery.mopp.GueryResource) resource;
	}
	 ...
	 */
	public static org.qualitune.guery.MotifModel getResourceContent(org.eclipse.emf.common.util.URI uri) {
	 ...
	 * Returns the root element of the resource with the given URI.
	 */
	public static org.qualitune.guery.MotifModel getResourceContent(org.eclipse.emf.common.util.URI uri, java.util.Map<?,?> options) {
		...
		return (org.qualitune.guery.MotifModel) root;
	}
	
	/**
	 * Returns the root element after parsing the given text.
	 */
	public static org.qualitune.guery.MotifModel getResourceContent(String text) {
	...
	public static String getText(org.eclipse.emf.ecore.EObject eObject) {
		...
		org.qualitune.guery.resource.guery.IGueryTextResource resource = (org.qualitune.guery.resource.guery.IGueryTextResource) eObject.eResource();
		if (resource != null) {
		...
		if (resource == null) {
			org.eclipse.emf.common.util.URI uri = org.eclipse.emf.common.util.URI.createURI("temp." + metaInformation.getSyntaxName());
			resource = (org.qualitune.guery.resource.guery.IGueryTextResource) rs.createResource(uri);
		}
		java.io.ByteArrayOutputStream outputStream = new java.io.ByteArrayOutputStream();
		org.qualitune.guery.resource.guery.IGueryTextPrinter printer = metaInformation.createPrinter(outputStream, resource);
		try {

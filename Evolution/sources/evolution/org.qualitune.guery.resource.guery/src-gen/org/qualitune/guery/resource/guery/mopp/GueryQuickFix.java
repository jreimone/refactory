...
public abstract class GueryQuickFix implements org.qualitune.guery.resource.guery.IGueryQuickFix {
	...
	public String apply(String currentText) {
		...
		try {
			...
			new org.qualitune.guery.resource.guery.util.GueryRuntimeUtil().logError("Exception while applying quick fix", e);
		}
		return null;
	}

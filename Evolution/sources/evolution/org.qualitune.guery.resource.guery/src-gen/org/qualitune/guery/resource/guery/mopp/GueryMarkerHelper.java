 ...
 * contains <code>org.qualitune.guery.resource.guery.IGueryTextDiagnostic</code>s
...
public class GueryMarkerHelper {
	 ...
	 */
	public static final String MARKER_TYPE = org.qualitune.guery.resource.guery.mopp.GueryPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.qualitune.guery.resource.guery.IGueryCommand<Object>> commands = new java.util.ArrayList<org.qualitune.guery.resource.guery.IGueryCommand<Object>>();
		private final Object jobLock = new Object();
		
		public void addCommand(org.qualitune.guery.resource.guery.IGueryCommand<Object> command) {
			...
			new org.eclipse.core.runtime.jobs.Job("updating markers") {
				...
				protected org.eclipse.core.runtime.IStatus run(org.eclipse.core.runtime.IProgressMonitor monitor) {
					synchronized(jobLock) {
						java.util.List<org.qualitune.guery.resource.guery.IGueryCommand<Object>> commandsToProcess = new java.util.ArrayList<org.qualitune.guery.resource.guery.IGueryCommand<Object>>();
						synchronized(commands) {
							commandsToProcess.addAll(commands);
							commands.clear();
						}
						for (org.qualitune.guery.resource.guery.IGueryCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public static void mark(org.eclipse.emf.ecore.resource.Resource resource, final org.qualitune.guery.resource.guery.IGueryTextDiagnostic diagnostic) {
	...
	private static void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.qualitune.guery.resource.guery.IGueryTextDiagnostic diagnostic) {
		final org.qualitune.guery.resource.guery.IGueryProblem problem = diagnostic.getProblem();
		org.qualitune.guery.resource.guery.GueryEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.qualitune.guery.resource.guery.IGueryCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.qualitune.guery.resource.guery.GueryEProblemSeverity.ERROR) {
					...
					org.qualitune.guery.resource.guery.IGueryTextDiagnostic textDiagnostic = (org.qualitune.guery.resource.guery.IGueryTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.qualitune.guery.resource.guery.mopp.GueryResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.qualitune.guery.resource.guery.mopp.GueryResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.qualitune.guery.resource.guery.IGueryQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.qualitune.guery.resource.guery.util.GueryStringUtil.explode(sourceIDs, "|"));
					}
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.qualitune.guery.resource.guery.GueryEProblemType nextType : org.qualitune.guery.resource.guery.GueryEProblemType.values()) {
	 ...
	 */
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.qualitune.guery.resource.guery.GueryEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public static void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.qualitune.guery.resource.guery.GueryEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public static String getMarkerID(org.qualitune.guery.resource.guery.GueryEProblemType problemType) {
	...
	private static void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new org.qualitune.guery.resource.guery.util.GueryRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new org.qualitune.guery.resource.guery.IGueryCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					org.qualitune.guery.resource.guery.mopp.GueryPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});

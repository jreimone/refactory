 ...
 */
public class GueryEnumerationTerminal extends org.qualitune.guery.resource.guery.grammar.GueryTerminal {
	
	private java.util.Map<String, String> mapping = new java.util.LinkedHashMap<String, String>();
	
	public GueryEnumerationTerminal(org.eclipse.emf.ecore.EStructuralFeature attribute, String[] literalMappings, org.qualitune.guery.resource.guery.grammar.GueryCardinality cardinality, int mandatoryOccurrencesAfter) {

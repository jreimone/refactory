...
public class OperatorsPackageImpl extends EPackageImpl implements OperatorsPackage {
  ...
  protected void createDeAnnotations()
  {
    ...
    addAnnotation
      (createEClass.getEOperations().get(0), 
       source, 
       new String[] 
       {
       });					
    addAnnotation
      (deleteEClass.getEOperations().get(0), 
       source, 
       new String[] 
       {
       });			
    addAnnotation
      (assignEClass.getEOperations().get(0), 
       source, 
       new String[] 
       {
       });			
    ...
    addAnnotation
      (varEClass.getEOperations().get(0), 
       source, 
       new String[] 
       {
       });			
  ...
  /**
   * Initializes the annotations for <b>java.lang.Override</b>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  {
    String source = "java.lang.Override";						
    addAnnotation
      (createEClass.getEOperations().get(0), 
       source, 
       new String[] 
  ...
  /**
   * Initializes the annotations for <b>java.lang.SuppressWarnings</b>.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  protected void createJava_1Annotations()
  {
    String source = "java.lang.SuppressWarnings";																
    addAnnotation
      (moveEClass.getEOperations().get(0), 
       source, 
       new String[] 

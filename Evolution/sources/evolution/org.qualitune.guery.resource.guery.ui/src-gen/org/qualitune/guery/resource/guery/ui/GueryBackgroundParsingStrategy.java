...
public class GueryBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.qualitune.guery.resource.guery.IGueryTextResource resource, final org.qualitune.guery.resource.guery.ui.GueryEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.qualitune.guery.resource.guery.IGueryTextResource resource, final org.qualitune.guery.resource.guery.ui.GueryEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.qualitune.guery.resource.guery.IGueryTextResource resource, final org.qualitune.guery.resource.guery.ui.GueryEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {

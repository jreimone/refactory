 ...
 * a specified depth.
 */
public class GueryOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public GueryOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.qualitune.guery.resource.guery.util.GueryStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.qualitune.guery.resource.guery.ui.GueryEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.qualitune.guery.resource.guery.mopp.GueryPlugin.logError("Exception while refreshing outline view", e);
		}
	}

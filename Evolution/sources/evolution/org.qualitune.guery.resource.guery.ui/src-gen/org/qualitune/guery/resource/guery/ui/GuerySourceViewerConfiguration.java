...
public class GuerySourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private org.qualitune.guery.resource.guery.ui.GueryQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public GuerySourceViewerConfiguration(org.qualitune.guery.resource.guery.IGueryResourceProvider resourceProvider, org.qualitune.guery.resource.guery.ui.IGueryAnnotationModelProvider annotationModelProvider, org.qualitune.guery.resource.guery.ui.IGueryBracketHandlerProvider bracketHandlerProvider, org.qualitune.guery.resource.guery.ui.GueryColorManager colorManager) {
		super(org.qualitune.guery.resource.guery.ui.GueryUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new org.qualitune.guery.resource.guery.ui.GueryCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new org.qualitune.guery.resource.guery.ui.GueryTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.qualitune.guery.resource.guery.ui.GueryTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new org.qualitune.guery.resource.guery.ui.GueryHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new org.qualitune.guery.resource.guery.ui.GueryQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new org.qualitune.guery.resource.guery.ui.GueryIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}

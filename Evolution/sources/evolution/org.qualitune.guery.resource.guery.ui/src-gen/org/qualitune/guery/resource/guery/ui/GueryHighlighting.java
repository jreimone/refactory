...
public class GueryHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private final static org.qualitune.guery.resource.guery.ui.GueryPositionHelper positionHelper = new org.qualitune.guery.resource.guery.ui.GueryPositionHelper();
	...
	private org.qualitune.guery.resource.guery.ui.GueryTokenScanner scanner;
	...
	private org.qualitune.guery.resource.guery.ui.GueryEditor editor;
	private org.eclipse.jface.text.source.projection.ProjectionViewer projectionViewer;
	private org.qualitune.guery.resource.guery.ui.GueryOccurrence occurrence;
	private org.qualitune.guery.resource.guery.ui.GueryBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.qualitune.guery.resource.guery.IGueryBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public GueryHighlighting(org.qualitune.guery.resource.guery.IGueryTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.qualitune.guery.resource.guery.ui.GueryColorManager colorManager, org.qualitune.guery.resource.guery.ui.GueryEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.qualitune.guery.resource.guery.ui.GueryUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.qualitune.guery.resource.guery.ui.GueryTokenScanner(textResource, colorManager);
		occurrence = new org.qualitune.guery.resource.guery.ui.GueryOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.qualitune.guery.resource.guery.ui.GueryBracketSet(editor, sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.qualitune.guery.resource.guery.ui.GueryPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.qualitune.guery.resource.guery.ui.GueryPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.qualitune.guery.resource.guery.ui.GueryEditor editor) {
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.qualitune.guery.resource.guery.ui.GueryPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.qualitune.guery.resource.guery.ui.GueryPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.qualitune.guery.resource.guery.ui.GueryPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.qualitune.guery.resource.guery.ui.GueryEObjectSelection(selectedEObject, false));
				}
			}
		});
	}

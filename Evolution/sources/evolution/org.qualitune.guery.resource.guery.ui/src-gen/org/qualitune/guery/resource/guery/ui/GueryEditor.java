 ...
 */
public class GueryEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.qualitune.guery.resource.guery.IGueryResourceProvider, org.qualitune.guery.resource.guery.ui.IGueryBracketHandlerProvider, org.qualitune.guery.resource.guery.ui.IGueryAnnotationModelProvider {
	
	private org.qualitune.guery.resource.guery.ui.GueryHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.qualitune.guery.resource.guery.ui.GueryCodeFoldingManager codeFoldingManager;
	private org.qualitune.guery.resource.guery.ui.GueryBackgroundParsingStrategy bgParsingStrategy = new org.qualitune.guery.resource.guery.ui.GueryBackgroundParsingStrategy();
	private java.util.Collection<org.qualitune.guery.resource.guery.IGueryBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.qualitune.guery.resource.guery.IGueryBackgroundParsingListener>();
	private org.qualitune.guery.resource.guery.ui.GueryColorManager colorManager = new org.qualitune.guery.resource.guery.ui.GueryColorManager();
	private org.qualitune.guery.resource.guery.ui.GueryOutlinePage outlinePage;
	...
	private org.qualitune.guery.resource.guery.ui.GueryPropertySheetPage propertySheetPage;
	...
	private org.qualitune.guery.resource.guery.ui.IGueryBracketHandler bracketHandler;
	...
	public GueryEditor() {
		super();
		setSourceViewerConfiguration(new org.qualitune.guery.resource.guery.ui.GuerySourceViewerConfiguration(this, this, this, colorManager));
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.qualitune.guery.resource.guery.IGueryTextResource currentResource = getResource();
				...
				org.qualitune.guery.resource.guery.ui.GueryUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.qualitune.guery.resource.guery.EditorContext");
		setRulerContextMenuId("org.qualitune.guery.resource.guery.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.qualitune.guery.resource.guery.ui.GueryHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.qualitune.guery.resource.guery.ui.GueryCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.qualitune.guery.resource.guery.mopp.GueryNature.activate(inputFile.getProject());
		...
		org.qualitune.guery.resource.guery.IGueryTextResource loadedResource = (org.qualitune.guery.resource.guery.IGueryTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.qualitune.guery.resource.guery.IGueryTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.qualitune.guery.resource.guery.IGueryTextResource) {
					setResource((org.qualitune.guery.resource.guery.IGueryTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.qualitune.guery.resource.guery.ui.GueryUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the GueryEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.qualitune.guery.resource.guery.ui.GueryUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.qualitune.guery.resource.guery.IGueryTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.qualitune.guery.resource.guery.ui.GueryOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.qualitune.guery.resource.guery.ui.GueryPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.qualitune.guery.resource.guery.IGueryTextResource textResource = (org.qualitune.guery.resource.guery.IGueryTextResource) element.eResource();
			org.qualitune.guery.resource.guery.IGueryLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			org.qualitune.guery.resource.guery.IGueryTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.qualitune.guery.resource.guery.IGueryTextToken token = lexer.getNextToken();
			...
			org.qualitune.guery.resource.guery.ui.GueryUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(org.qualitune.guery.resource.guery.IGueryBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.qualitune.guery.resource.guery.IGueryBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.qualitune.guery.resource.guery.ui.IGueryBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.qualitune.guery.resource.guery.ui.IGueryBracketHandler bracketHandler) {
	...
	private boolean setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		if (selection instanceof org.eclipse.jface.viewers.IStructuredSelection) {
			...
			if (object instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (!(resource instanceof org.qualitune.guery.resource.guery.IGueryTextResource)) {
					return false;
				}
				org.qualitune.guery.resource.guery.IGueryTextResource textResource = (org.qualitune.guery.resource.guery.IGueryTextResource) resource;
				org.qualitune.guery.resource.guery.IGueryLocationMap locationMap = textResource.getLocationMap();
				int destination = locationMap.getCharStart(element);
				if (destination < 0) {
					destination = 0;

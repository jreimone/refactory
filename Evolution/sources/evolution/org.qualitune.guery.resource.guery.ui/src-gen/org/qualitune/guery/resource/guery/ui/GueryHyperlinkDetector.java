...
public class GueryHyperlinkDetector implements org.eclipse.jface.text.hyperlink.IHyperlinkDetector {
	...
	public GueryHyperlinkDetector(org.eclipse.emf.ecore.resource.Resource resource) {
		textResource = (org.qualitune.guery.resource.guery.IGueryTextResource) resource;
	}
		...
		for (org.eclipse.emf.ecore.EObject eObject : elementsAtOffset) {
			if (eObject.eIsProxy()) {
				...
				if (resolvedEObject.eResource() != null) {
					org.eclipse.jface.text.hyperlink.IHyperlink hyperlink = new org.qualitune.guery.resource.guery.ui.GueryHyperlink(new org.eclipse.jface.text.Region(offset, length), resolvedEObject, text);

...
public class GueryNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	...
	private org.qualitune.guery.resource.guery.ui.GueryNewFileWizardPage page;
	...
	public void addPages() {
		page = new org.qualitune.guery.resource.guery.ui.GueryNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.qualitune.guery.resource.guery.ui.GueryUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.qualitune.guery.resource.guery.ui.GueryUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.qualitune.guery.resource.guery.mopp.GueryMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public String getFileExtension() {
		return new org.qualitune.guery.resource.guery.mopp.GueryMetaInformation().getSyntaxName();
	}

...
public class OperatorsTaskItemDetector {
	...
	public List<org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsTaskItem> findTaskItems(String text, int line, int charStart) {
		List<org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsTaskItem> foundItems = new ArrayList<org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsTaskItem>();

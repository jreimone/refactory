...
/**
 * A OperatorsLayoutInformationAdapter is used to store layout information that is
 ...
 * OperatorsLayoutInformationAdapters are attached to EObjects and aggregate
 ...
 */
public class OperatorsLayoutInformationAdapter implements Adapter {
	 ...
	 * reference.
	 */
	private List<org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsLayoutInformation> layoutInformations = new ArrayList<org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsLayoutInformation>();
	...
	public List<org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsLayoutInformation> getLayoutInformations() {
		return layoutInformations;
	}
	
	public void addLayoutInformation(org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsLayoutInformation layoutInformation) {

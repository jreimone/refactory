...
public class OperatorsToggleCommentHandler extends AbstractHandler {
	...
	public boolean isEnabled() {
		...
		if (activeEditor instanceof org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEditor) {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEditor editor = null;
		
		if (editorPart instanceof org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEditor) {
			editor = (org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEditor) editorPart;

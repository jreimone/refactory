...
/**
 * The OperatorsAutoEditStrategy extends the default auto edit strategy such that
 ...
 */
public class OperatorsAutoEditStrategy extends DefaultIndentLineAutoEditStrategy {
	
	private org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsBracketSet bracketSet;
	
	public OperatorsAutoEditStrategy() {
		super();
		...
		if (plugin != null) {
			...
			bracketSet = new org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsBracketSet();
	 ...
	 */
	@Deprecated
	public void setBracketSet(org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsBracketSet bracketSet) {

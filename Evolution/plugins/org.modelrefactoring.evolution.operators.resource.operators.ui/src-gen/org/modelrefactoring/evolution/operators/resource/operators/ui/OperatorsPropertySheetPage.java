...
public class OperatorsPropertySheetPage extends PropertySheetPage implements ISelectionChangedListener {
	...
	public void selectionChanged(IWorkbenchPart part, ISelection iSelection) {
		...
		if (iSelection instanceof org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEObjectSelection) {
			final org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEObjectSelection selection = (org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEObjectSelection) iSelection;

...
public class OperatorsCompletionProposal implements Comparable<OperatorsCompletionProposal> {
	 ...
	 */
	private org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsExpectedTerminal expectedTerminal;
	...
	public org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof OperatorsCompletionProposal) {
			OperatorsCompletionProposal other = (OperatorsCompletionProposal) object;
	...
	public int compareTo(OperatorsCompletionProposal object) {
		if (object instanceof OperatorsCompletionProposal) {
			OperatorsCompletionProposal other = (OperatorsCompletionProposal) object;

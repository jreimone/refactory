 ...
 */
public class OperatorsBracketSet {
	...
	private ArrayList<org.modelrefactoring.evolution.operators.resource.operators.IOperatorsBracketPair> bracketPairs;
	private String languageID;
	
	/**
	 * Creates a new bracket set to manage bracket pairs.
	 */
	public OperatorsBracketSet() {
		super();
		...
		this.bracketPairs = new ArrayList<org.modelrefactoring.evolution.operators.resource.operators.IOperatorsBracketPair>();
	}
	...
	public org.modelrefactoring.evolution.operators.resource.operators.IOperatorsBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public org.modelrefactoring.evolution.operators.resource.operators.IOperatorsBracketPair getBracketPair(String opening, String closing) {
		for (org.modelrefactoring.evolution.operators.resource.operators.IOperatorsBracketPair bracketPair : bracketPairs) {
	...
	public boolean addBracketPair(String opening, String closing, boolean closingEnabledInside, boolean closeAfterEnter) {
		...
		bracketPairs.add(new org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsBracketPair(opening, closing, closingEnabledInside, closeAfterEnter));
		return true;
	}
	...
	public boolean resetBrackets(IPreferenceStore preferenceStore) {
		String bracketPairs = preferenceStore.getString(languageID + org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.modelrefactoring.evolution.operators.resource.operators.IOperatorsBracketPair remove(String opening, String closing) {
		for (org.modelrefactoring.evolution.operators.resource.operators.IOperatorsBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public void deserialize(String bracketSet) {
		bracketPairs = new ArrayList<org.modelrefactoring.evolution.operators.resource.operators.IOperatorsBracketPair>();
	...
	public void findAndHighlightMatchingBrackets(IDocument document, int caretOffset) {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}

 ...
 */
public class OperatorsCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.modelrefactoring.evolution.operators.resource.operators.IOperatorsBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements IPartListener2 {
		...
		public EditorOnCloseListener(org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEditor) {
				org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEditor editor = (org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEditor) workbenchPart;
	 ...
	 */
	public OperatorsCodeFoldingManager(ProjectionViewer sourceViewer,org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEditor textEditor) {
	...
	private void addCloseListener(final org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsResource textResource = (org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsResource) editor.getResource();
		IDocument document = sourceViewer.getDocument();

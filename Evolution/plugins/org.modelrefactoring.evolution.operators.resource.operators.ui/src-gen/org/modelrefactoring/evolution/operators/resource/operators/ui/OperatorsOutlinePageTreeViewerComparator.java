...
public class OperatorsOutlinePageTreeViewerComparator extends ViewerComparator {
	...
	public int compare(Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof EObject && o2 instanceof EObject) {
			...
			org.modelrefactoring.evolution.operators.resource.operators.IOperatorsNameProvider nameProvider = new org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsMetaInformation().createNameProvider();

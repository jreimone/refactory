 ...
 * </p>
 */
public class OperatorsNewProjectWizard extends Wizard implements INewWizard, IExecutableExtension {
	
	/**
	 * The name of the ZIP file that is used as content for the new project (relative
	 * to the root of the resource UI plug-in).
	 */
	public final static String NEW_PROJECT_ZIP_FILE_NAME = org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsUIResourceBundle.NEW_PROJECT_ZIP_FILE_NAME;
	 ...
	 */
	protected String pageName = org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_NAME;
	 ...
	 */
	protected String pageDescription = org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_DESCRIPTION;
	
	/**
	 * The name of the project in the project creation page
	 */
	protected String pageProjectName = org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsUIResourceBundle.NEW_PROJECT_WIZARD_PROJECT_NAME;
	 ...
	 * org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsNewProje
	 * ctWizardLogic.
	 */
	...
	protected void doPerformFinish(IProgressMonitor monitor) throws Exception {
		new org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsNewProjectWizardLogic().createExampleProject(monitor, wizardNewProjectCreationPage.getLocationPath(), wizardNewProjectCreationPage.getProjectName(), org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsUIPlugin.PLUGIN_ID, NEW_PROJECT_ZIP_FILE_NAME);
	}
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		IPath path = new Path(org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_ICON);
		Bundle bundle = org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsUIPlugin.getDefault().getBundle();
		...
		setWindowTitle(org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsUIResourceBundle.NEW_PROJECT_WIZARD_WINDOW_TITLE);
	}

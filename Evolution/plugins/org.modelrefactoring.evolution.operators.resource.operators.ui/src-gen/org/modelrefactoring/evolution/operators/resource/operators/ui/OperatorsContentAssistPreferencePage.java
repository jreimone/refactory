 ...
 */
public class OperatorsContentAssistPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public OperatorsContentAssistPreferencePage() {
		initialize();
	}
	...
	public void init(IWorkbench workbench) {
		...
		// init values
		assistEnabled = preferenceStore.getBoolean(org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPreferenceConstants.EDITOR_CONTENT_ASSIST_ENABLED);
		activationDelay = preferenceStore.getInt(org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPreferenceConstants.EDITOR_CONTENT_ASSIST_DELAY);
		activationTriggers = preferenceStore.getString(org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPreferenceConstants.EDITOR_CONTENT_ASSIST_TRIGGERS);
	}
	...
	protected void performDefaults() {
		IPreferenceStore preferenceStore = getPreferenceStore();
		assistEnabled = preferenceStore.getDefaultBoolean(org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPreferenceConstants.EDITOR_CONTENT_ASSIST_ENABLED);
		activationDelay = preferenceStore.getDefaultInt(org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPreferenceConstants.EDITOR_CONTENT_ASSIST_DELAY);
		activationTriggers = preferenceStore.getDefaultString(org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPreferenceConstants.EDITOR_CONTENT_ASSIST_TRIGGERS);
		// defaults in widgets
	...
	private boolean updatePreferences() {
		...
		try {
			...
			org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsPlugin.getDefault().getLog().log(			new Status(IStatus.ERROR			, org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsUIPlugin.getDefault().getBundle().getSymbolicName()			, "Value '" + delayText + "' is no valid delay value"			, exception)			);
			return false;
		}
		activationTriggers = txtTriggers.getText();
		IPreferenceStore preferenceStore = getPreferenceStore();
		preferenceStore.setValue(org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPreferenceConstants.EDITOR_CONTENT_ASSIST_ENABLED, assistEnabled);
		preferenceStore.setValue(org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPreferenceConstants.EDITOR_CONTENT_ASSIST_DELAY, activationDelay);
		preferenceStore.setValue(org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPreferenceConstants.EDITOR_CONTENT_ASSIST_TRIGGERS, activationTriggers);
		return true;
	}

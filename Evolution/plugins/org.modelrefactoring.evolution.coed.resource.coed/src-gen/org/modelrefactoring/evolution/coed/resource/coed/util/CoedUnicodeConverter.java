 ...
 * to 4 bytes).
 */
public class CoedUnicodeConverter extends org.modelrefactoring.evolution.coed.resource.coed.mopp.CoedInputStreamProcessor {
	 ...
	 */
	public CoedUnicodeConverter(InputStream inputStream) {

 ...
 */
public class CoedBracketPair implements org.modelrefactoring.evolution.coed.resource.coed.ICoedBracketPair {
	...
	public CoedBracketPair(String openingBracket, String closingBracket, boolean closingEnabledInside, boolean closeAfterEnter) {
		super();
		this.openingBracket = openingBracket;
		this.closingBracket = closingBracket;
		this.closingEnabledInside = closingEnabledInside;

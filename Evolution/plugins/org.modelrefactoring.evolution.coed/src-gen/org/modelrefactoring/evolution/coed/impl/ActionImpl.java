 ...
 * <ul>
 *   <li>{@link org.modelrefactoring.evolution.coed.impl.ActionImpl#getCoED <em>Co ED</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class ActionImpl extends MinimalEObjectImpl.Container implements Action {
  ...
  {
    if (eContainerFeatureID() != CoedPackage.ACTION__CO_ED) return null;
  ...
  {
    msgs = eBasicSetContainer((InternalEObject)newCoED, CoedPackage.ACTION__CO_ED, msgs);
    return msgs;
  }
  ...
  {
    if (newCoED != eInternalContainer() || (eContainerFeatureID() != CoedPackage.ACTION__CO_ED && newCoED != null))
    {
      ...
      if (newCoED != null)
        msgs = ((InternalEObject)newCoED).eInverseAdd(this, CoedPackage.CO_EVOLUTION_DEFINITION__ACTION, CoEvolutionDefinition.class, msgs);
      msgs = basicSetCoED(newCoED, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CoedPackage.ACTION__CO_ED, newCoED, newCoED));
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CoedPackage.ACTION__CO_ED:
        if (eInternalContainer() != null)
          msgs = eBasicRemoveFromContainer(msgs);
  ...
  public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs)
  {
    ...
    {
      case CoedPackage.ACTION__CO_ED:
        return eInternalContainer().eInverseRemove(this, CoedPackage.CO_EVOLUTION_DEFINITION__ACTION, CoEvolutionDefinition.class, msgs);
    }

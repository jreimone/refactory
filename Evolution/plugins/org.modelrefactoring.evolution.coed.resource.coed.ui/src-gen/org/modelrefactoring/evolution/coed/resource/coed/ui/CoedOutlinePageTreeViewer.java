 ...
 * a specified depth.
 */
public class CoedOutlinePageTreeViewer extends TreeViewer {
	...
	public CoedOutlinePageTreeViewer(Composite parent, int style) {
		super(parent, style);
	...
	public void setSelection(ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.modelrefactoring.evolution.coed.resource.coed.mopp.CoedPlugin.logError("Exception while refreshing outline view", e);
		}
	}

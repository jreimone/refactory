...
public class CoedToggleCommentHandler extends AbstractHandler {
	...
	public boolean isEnabled() {
		...
		if (activeEditor instanceof org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor) {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor editor = null;
		
		if (editorPart instanceof org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor) {
			editor = (org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor) editorPart;

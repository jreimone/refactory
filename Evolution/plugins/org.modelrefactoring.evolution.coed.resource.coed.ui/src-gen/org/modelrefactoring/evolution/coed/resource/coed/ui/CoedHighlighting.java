 ...
 */
public class CoedHighlighting implements ISelectionProvider, ISelectionChangedListener {
	...
	private org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor editor;
	private ProjectionViewer projectionViewer;
	private org.modelrefactoring.evolution.coed.resource.coed.ui.CoedOccurrence occurrence;
	 ...
	 */
	private final class UpdateHighlightingListener implements KeyListener, VerifyListener, MouseListener, org.modelrefactoring.evolution.coed.resource.coed.ICoedBackgroundParsingListener {
	 ...
	 */
	public CoedHighlighting(org.modelrefactoring.evolution.coed.resource.coed.ICoedTextResource textResource, ProjectionViewer projectionViewer, org.modelrefactoring.evolution.coed.resource.coed.ui.CoedColorManager colorManager, org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor editor) {
		this.display = Display.getCurrent();
		projectionViewer.getSelectionProvider();
		this.preferenceStore = org.modelrefactoring.evolution.coed.resource.coed.ui.CoedUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		this.textWidget = projectionViewer.getTextWidget();
		this.projectionViewer = projectionViewer;
		this.occurrence = new org.modelrefactoring.evolution.coed.resource.coed.ui.CoedOccurrence(textResource, projectionViewer);
		this.bracketSet = new org.modelrefactoring.evolution.coed.resource.coed.ui.CoedBracketSet();
		this.colorManager = colorManager;
		this.isHighlightBrackets = preferenceStore.getBoolean(org.modelrefactoring.evolution.coed.resource.coed.ui.CoedPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		this.bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, org.modelrefactoring.evolution.coed.resource.coed.ui.CoedPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		this.black = colorManager.getColor(new RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor editor) {
	...
	private void setBracketHighlighting(IDocument document) {
		...
		Position[] positions = positionHelper.getPositions(document, org.modelrefactoring.evolution.coed.resource.coed.ui.CoedPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.modelrefactoring.evolution.coed.resource.coed.ui.CoedPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(IDocument document, String category) {
		...
		if (category.equals(org.modelrefactoring.evolution.coed.resource.coed.ui.CoedPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEObjectSelection(selectedEObject));
				}
			}
		});
	}
	...
	public void resetValues() {
		isHighlightBrackets = preferenceStore.getBoolean(org.modelrefactoring.evolution.coed.resource.coed.ui.CoedPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, org.modelrefactoring.evolution.coed.resource.coed.ui.CoedPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));

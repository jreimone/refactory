...
public class TestpropertiesCopiedEObjectInternalEList extends org.emftext.refactoring.tests.properties.resource.testproperties.util.TestpropertiesCopiedEList<EObject> implements InternalEList<EObject> {
	
	private InternalEList<EObject> original;
	private InternalEList<EObject> copy;
	
	public TestpropertiesCopiedEObjectInternalEList(InternalEList<EObject> original) {
		super(original);

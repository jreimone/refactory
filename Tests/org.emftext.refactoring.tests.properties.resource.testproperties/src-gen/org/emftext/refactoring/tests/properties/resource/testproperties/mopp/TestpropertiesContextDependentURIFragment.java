 ...
 * this fragment.
 */
public abstract class TestpropertiesContextDependentURIFragment<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> implements org.emftext.refactoring.tests.properties.resource.testproperties.ITestpropertiesContextDependentURIFragment<ReferenceType> {
	...
	public TestpropertiesContextDependentURIFragment(String identifier, ContainerType container, org.eclipse.emf.ecore.EReference reference, int positionInReference, org.eclipse.emf.ecore.EObject proxy) {
	...
	private void addResultToList(org.emftext.refactoring.tests.properties.resource.testproperties.ITestpropertiesReferenceMapping<ReferenceType> mapping, org.eclipse.emf.ecore.EObject proxy, org.eclipse.emf.common.util.EList<org.eclipse.emf.ecore.EObject> list) {
		...
		if (mapping instanceof org.emftext.refactoring.tests.properties.resource.testproperties.ITestpropertiesElementMapping<?>) {
			...
			org.eclipse.emf.common.util.URI uri = ((org.emftext.refactoring.tests.properties.resource.testproperties.ITestpropertiesURIMapping<ReferenceType>) mapping).getTargetIdentifier();

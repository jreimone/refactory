...
public class TestpropertiesRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.emftext.refactoring.tests.properties.resource.testproperties.mopp.TestpropertiesPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.emftext.refactoring.tests.properties.resource.testproperties.mopp.TestpropertiesPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {

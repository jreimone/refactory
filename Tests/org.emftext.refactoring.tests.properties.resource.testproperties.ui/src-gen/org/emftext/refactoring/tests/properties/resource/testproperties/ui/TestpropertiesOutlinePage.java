 ...
 */
public class TestpropertiesOutlinePage extends Page implements ISelectionProvider, ISelectionChangedListener, IContentOutlinePage {
	...
	public void createControl(Composite parent) {
		treeViewer = new org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesOutlinePageTreeViewer(parent, SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL);
	...
	private void createActions() {
		...
		List<IAction> actions = new org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesOutlinePageActionProvider().getActions(treeViewer);

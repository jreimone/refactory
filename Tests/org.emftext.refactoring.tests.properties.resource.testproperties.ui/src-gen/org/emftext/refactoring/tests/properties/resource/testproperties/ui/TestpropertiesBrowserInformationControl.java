 ...
 * @since 3.2
 */
public class TestpropertiesBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesDocBrowserInformationControlInput fInput;
	 ...
	 */
	public TestpropertiesBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public TestpropertiesBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public TestpropertiesBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesDocBrowserInformationControlInput) input;
		...
		org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesDocBrowserInformationControlInput getInput() {
		return fInput;
	}

...
public class TestpropertiesMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
		...
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				if (emfResource instanceof org.emftext.refactoring.tests.properties.resource.testproperties.mopp.TestpropertiesResource) {
					...
					java.util.Collection<org.emftext.refactoring.tests.properties.resource.testproperties.ITestpropertiesQuickFix> quickFixes = getQuickFixes(customResource, marker);
	...
	public java.util.Collection<org.emftext.refactoring.tests.properties.resource.testproperties.ITestpropertiesQuickFix> getQuickFixes(org.emftext.refactoring.tests.properties.resource.testproperties.ITestpropertiesTextResource resource, org.eclipse.core.resources.IMarker marker) {

 ...
 */
public class TestpropertiesCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.emftext.refactoring.tests.properties.resource.testproperties.ITestpropertiesBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesEditor) {
				org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesEditor editor = (org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesEditor) workbenchPart;
	...
	protected org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesEditor editor;
	 ...
	 */
	public TestpropertiesCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesEditor textEditor) {
	...
	private void addCloseListener(final org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesEditor editor) {
	...
	private java.io.File getCodeFoldingStateFile(String uriString) {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesUIPlugin.PLUGIN_ID);
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.refactoring.tests.properties.resource.testproperties.ITestpropertiesTextResource textResource = (org.emftext.refactoring.tests.properties.resource.testproperties.ITestpropertiesTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();

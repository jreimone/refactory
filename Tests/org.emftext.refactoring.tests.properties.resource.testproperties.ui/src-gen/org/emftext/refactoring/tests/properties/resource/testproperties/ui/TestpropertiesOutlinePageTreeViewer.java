...
public class TestpropertiesOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.emftext.refactoring.tests.properties.resource.testproperties.mopp.TestpropertiesPlugin.logError("Exception while refreshing outline view", e);
		}
	}

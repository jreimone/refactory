 ...
 */
public class TestpropertiesHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public TestpropertiesHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.emftext.refactoring.tests.properties.resource.testproperties.mopp.TestpropertiesPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}

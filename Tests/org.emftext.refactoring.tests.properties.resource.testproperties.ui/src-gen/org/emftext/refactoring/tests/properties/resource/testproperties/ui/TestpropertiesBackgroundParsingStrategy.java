 ...
 */
public class TestpropertiesBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.emftext.refactoring.tests.properties.resource.testproperties.ITestpropertiesTextResource resource, final org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.emftext.refactoring.tests.properties.resource.testproperties.ITestpropertiesTextResource resource, final org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.emftext.refactoring.tests.properties.resource.testproperties.ITestpropertiesTextResource resource, final org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.emftext.refactoring.tests.properties.resource.testproperties.mopp.TestpropertiesResource) {
							org.emftext.refactoring.tests.properties.resource.testproperties.mopp.TestpropertiesResource concreteResource = (org.emftext.refactoring.tests.properties.resource.testproperties.mopp.TestpropertiesResource) resource;

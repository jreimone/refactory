...
public class GraphView extends JPanel {
	...
	public GraphView(Graph g, String label, String edgeTypePredicate,  Map<String, String> edgeTypeColorMap, boolean useStraightLineForSingleEdges) {
...
//		m_edgeRenderer.setArrowHeadSize(15, 15);
		m_edgeRenderer.setEdgeType(prefuse.Constants.EDGE_TYPE_CURVE);

		// to fill the arrows
		FillColorAction fillArrow = new FillColorAction(edges);
			...
			if(edgeTypeColorMap != null){
				for (Entry<String, String> entry : edgeTypeColorMap.entrySet()) {
					...
					if(colorValues.length == 3 && edgeTypePredicate != null && key != null){
						try {
							ColorAction edgeColor = new ColorAction(edges, VisualItem.STROKECOLOR

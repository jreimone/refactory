...
public class EMFPatternLanguageAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected EMFPatternLanguageSwitch<Adapter> modelSwitch =
    new EMFPatternLanguageSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseXtype_XImportSection(org.eclipse.xtext.xtype.XImportSection object)
      {
        return createXtype_XImportSectionAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.incquery.patternlanguage.emf.eMFPatternLanguage.XImportSection <em>XImport Section</em>}'.
   * <!-- begin-user-doc -->

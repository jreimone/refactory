...
public interface EMFPatternLanguagePackage extends EPackage
{
  ...
  /**
   * The meta object id for the '{@link org.eclipse.incquery.patternlanguage.emf.eMFPatternLanguage.impl.ImportDeclarationImpl <em>Import Declaration</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see org.eclipse.incquery.patternlanguage.emf.eMFPatternLanguage.impl.ImportDeclarationImpl
   * @see org.eclipse.incquery.patternlanguage.emf.eMFPatternLanguage.impl.EMFPatternLanguagePackageImpl#getImportDeclaration()
   * @generated
   */
  int IMPORT_DECLARATION = 0;
   ...
   * @ordered
   */
  int IMPORT_DECLARATION_FEATURE_COUNT = 0;
   ...
   * @ordered
   */
  int PACKAGE_IMPORT__EPACKAGE = IMPORT_DECLARATION_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int PACKAGE_IMPORT_FEATURE_COUNT = IMPORT_DECLARATION_FEATURE_COUNT + 1;

  /**
   * The meta object id for the '{@link org.eclipse.incquery.patternlanguage.emf.eMFPatternLanguage.impl.JavaImportImpl <em>Java Import</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see org.eclipse.incquery.patternlanguage.emf.eMFPatternLanguage.impl.JavaImportImpl
   * @see org.eclipse.incquery.patternlanguage.emf.eMFPatternLanguage.impl.EMFPatternLanguagePackageImpl#getJavaImport()
   * @generated
   */
  int JAVA_IMPORT = 2;
   ...
   * @ordered
   */
  int JAVA_IMPORT__IMPORTED_NAMESPACE = IMPORT_DECLARATION_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int JAVA_IMPORT_FEATURE_COUNT = IMPORT_DECLARATION_FEATURE_COUNT + 1;
  ...
  /**
   * Returns the meta object for class '{@link org.eclipse.incquery.patternlanguage.emf.eMFPatternLanguage.ImportDeclaration <em>Import Declaration</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for class '{@link org.eclipse.incquery.patternlanguage.emf.eMFPatternLanguage.JavaImport <em>Java Import</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the attribute '{@link org.eclipse.incquery.patternlanguage.emf.eMFPatternLanguage.JavaImport#getImportedNamespace <em>Imported Namespace</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Imported Namespace</em>'.
   * @see org.eclipse.incquery.patternlanguage.emf.eMFPatternLanguage.JavaImport#getImportedNamespace()
   * @see #getJavaImport()
   * @generated
   */
  EAttribute getJavaImport_ImportedNamespace();
  ...
  /**
   * Returns the meta object for the containment reference list '{@link org.eclipse.incquery.patternlanguage.emf.eMFPatternLanguage.PatternModel#getImportPackages <em>Import Packages</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  {
    /**
     * The meta object literal for the '{@link org.eclipse.incquery.patternlanguage.emf.eMFPatternLanguage.impl.ImportDeclarationImpl <em>Import Declaration</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see org.eclipse.incquery.patternlanguage.emf.eMFPatternLanguage.impl.ImportDeclarationImpl
     * @see org.eclipse.incquery.patternlanguage.emf.eMFPatternLanguage.impl.EMFPatternLanguagePackageImpl#getImportDeclaration()
    ...
    /**
     * The meta object literal for the '{@link org.eclipse.incquery.patternlanguage.emf.eMFPatternLanguage.impl.JavaImportImpl <em>Java Import</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see org.eclipse.incquery.patternlanguage.emf.eMFPatternLanguage.impl.JavaImportImpl
     * @see org.eclipse.incquery.patternlanguage.emf.eMFPatternLanguage.impl.EMFPatternLanguagePackageImpl#getJavaImport()
     ...
     * @generated
     */
    EAttribute JAVA_IMPORT__IMPORTED_NAMESPACE = eINSTANCE.getJavaImport_ImportedNamespace();

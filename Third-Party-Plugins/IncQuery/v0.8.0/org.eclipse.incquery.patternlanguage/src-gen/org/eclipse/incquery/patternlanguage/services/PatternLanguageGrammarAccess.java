...
public class PatternLanguageGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class FunctionEvaluationValueElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "FunctionEvaluationValue");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cFunctionEvaluationValueAction_0 = (Action)cGroup.eContents().get(0);
		...
		//{FunctionEvaluationValue}
		public Action getFunctionEvaluationValueAction_0() { return cFunctionEvaluationValueAction_0; }
	...
	private FunctionEvaluationValueElements pFunctionEvaluationValue;
	...
	public FunctionEvaluationValueElements getFunctionEvaluationValueAccess() {
		return (pFunctionEvaluationValue != null) ? pFunctionEvaluationValue : (pFunctionEvaluationValue = new FunctionEvaluationValueElements());
	}

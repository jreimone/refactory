...
public abstract class AbstractPatternLanguageSemanticSequencer extends XbaseSemanticSequencer {

	@Inject
	private PatternLanguageGrammarAccess grammarAccess;
	...
	/**
	 * Constraint:
	 *     (aggregator=AggregatorExpression call=PatternCall)
	 */
	protected void sequence_AggregatedValue(EObject context, AggregatedValue semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, PatternLanguagePackage.Literals.AGGREGATED_VALUE__AGGREGATOR) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PatternLanguagePackage.Literals.AGGREGATED_VALUE__AGGREGATOR));
			if(transientValues.isValueTransient(semanticObject, PatternLanguagePackage.Literals.AGGREGATED_VALUE__CALL) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PatternLanguagePackage.Literals.AGGREGATED_VALUE__CALL));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getAggregatedValueAccess().getAggregatorAggregatorExpressionParserRuleCall_1_0(), semanticObject.getAggregator());
		feeder.accept(grammarAccess.getAggregatedValueAccess().getCallPatternCallParserRuleCall_2_0(), semanticObject.getCall());
		feeder.finish();
	}
	 ...
	 *     {CountAggregator}
	 */
	protected void sequence_AggregatorExpression(EObject context, CountAggregator semanticObject) {
	 ...
	 */
	protected void sequence_AnnotationParameter(EObject context, AnnotationParameter semanticObject) {
		if(errorAcceptor != null) {
	...
	protected void sequence_BoolValue(EObject context, BoolValue semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getBoolValueAccess().getValueBOOLEANParserRuleCall_1_0(), semanticObject.isValue());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_CheckConstraint(EObject context, CheckConstraint semanticObject) {
		if(errorAcceptor != null) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getCheckConstraintAccess().getExpressionXExpressionParserRuleCall_3_0(), semanticObject.getExpression());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_CompareConstraint(EObject context, CompareConstraint semanticObject) {
		if(errorAcceptor != null) {
	...
	protected void sequence_DoubleValue(EObject context, DoubleValue semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, PatternLanguagePackage.Literals.DOUBLE_VALUE__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PatternLanguagePackage.Literals.DOUBLE_VALUE__VALUE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getDoubleValueAccess().getValueDOUBLEParserRuleCall_1_0(), semanticObject.getValue());
		feeder.finish();
	}
	 ...
	 *     expression=XExpression
	 */
	protected void sequence_FunctionEvaluationValue(EObject context, FunctionEvaluationValue semanticObject) {
		if(errorAcceptor != null) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getFunctionEvaluationValueAccess().getExpressionXExpressionParserRuleCall_3_0(), semanticObject.getExpression());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_ListValue(EObject context, ListValue semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_Modifiers(EObject context, Modifiers semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, PatternLanguagePackage.Literals.MODIFIERS__PRIVATE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PatternLanguagePackage.Literals.MODIFIERS__PRIVATE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getModifiersAccess().getPrivatePrivateKeyword_0(), semanticObject.isPrivate());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_PathExpressionConstraint(EObject context, PathExpressionConstraint semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, PatternLanguagePackage.Literals.PATH_EXPRESSION_CONSTRAINT__HEAD) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PatternLanguagePackage.Literals.PATH_EXPRESSION_CONSTRAINT__HEAD));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getPathExpressionConstraintAccess().getHeadPathExpressionHeadParserRuleCall_1_0(), semanticObject.getHead());
		feeder.finish();
	}
	 ...
	 */
	protected void sequence_PathExpressionHead(EObject context, PathExpressionHead semanticObject) {
		if(errorAcceptor != null) {
	 ...
	 */
	protected void sequence_PathExpressionTail(EObject context, PathExpressionTail semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_PatternCompositionConstraint(EObject context, PatternCompositionConstraint semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (packageName=QualifiedName? patterns+=Pattern*)
	 */
	protected void sequence_PatternModel(EObject context, PatternModel semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     typename=ID
	 */
	protected void sequence_RefType(EObject context, RelationType semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, PatternLanguagePackage.Literals.TYPE__TYPENAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PatternLanguagePackage.Literals.TYPE__TYPENAME));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getRefTypeAccess().getTypenameIDTerminalRuleCall_1_0(), semanticObject.getTypename());
		feeder.finish();
	}
	 ...
	 *     typename=ID
	 */
	protected void sequence_Type(EObject context, EntityType semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, PatternLanguagePackage.Literals.TYPE__TYPENAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PatternLanguagePackage.Literals.TYPE__TYPENAME));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getTypeAccess().getTypenameIDTerminalRuleCall_1_0(), semanticObject.getTypename());
		feeder.finish();
	}
	...
	protected void sequence_VariableValue(EObject context, VariableValue semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, PatternLanguagePackage.Literals.VARIABLE_VALUE__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, PatternLanguagePackage.Literals.VARIABLE_VALUE__VALUE));
		}
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceFeeder feeder = createSequencerFeeder(semanticObject, nodes);
		feeder.accept(grammarAccess.getVariableValueAccess().getValueVariableReferenceParserRuleCall_1_0(), semanticObject.getValue());
		feeder.finish();
	}

 ...
 */
public interface IGueryOptions {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new org.modelrefactoring.guery.resource.guery.mopp.GueryMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new org.modelrefactoring.guery.resource.guery.mopp.GueryMetaInformation().getResourcePostProcessorProviderOptionKey();

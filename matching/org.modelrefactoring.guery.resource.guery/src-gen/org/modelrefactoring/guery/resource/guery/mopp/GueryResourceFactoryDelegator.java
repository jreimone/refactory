...
public class GueryResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	
	protected java.util.Map<String, org.eclipse.emf.ecore.resource.Resource.Factory> factories = null;
	
	public GueryResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (new org.modelrefactoring.guery.resource.guery.util.GueryRuntimeUtil().isEclipsePlatformAvailable()) {
			new org.modelrefactoring.guery.resource.guery.util.GueryEclipseProxy().getResourceFactoryExtensions(factories);
		}
		if (factories.get("") == null) {
			factories.put("", new org.modelrefactoring.guery.resource.guery.mopp.GueryResourceFactory());
		}
	}

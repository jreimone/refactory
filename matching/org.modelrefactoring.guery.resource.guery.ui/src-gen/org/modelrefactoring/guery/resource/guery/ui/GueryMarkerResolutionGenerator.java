	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(org.modelrefactoring.guery.resource.guery.IGueryOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof org.modelrefactoring.guery.resource.guery.mopp.GueryResource) {
					org.modelrefactoring.guery.resource.guery.mopp.GueryResource customResource = (org.modelrefactoring.guery.resource.guery.mopp.GueryResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<org.modelrefactoring.guery.resource.guery.IGueryQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final org.modelrefactoring.guery.resource.guery.IGueryQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									org.modelrefactoring.guery.resource.guery.ui.GueryUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			org.modelrefactoring.guery.resource.guery.ui.GueryUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<org.modelrefactoring.guery.resource.guery.IGueryQuickFix> getQuickFixes(org.modelrefactoring.guery.resource.guery.IGueryTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					org.modelrefactoring.guery.resource.guery.IGueryQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {

 ...
 */
public class GueryCompletionProposal implements java.lang.Comparable<GueryCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private org.modelrefactoring.guery.resource.guery.mopp.GueryExpectedTerminal expectedTerminal;
	...
	public GueryCompletionProposal(org.modelrefactoring.guery.resource.guery.mopp.GueryExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public org.modelrefactoring.guery.resource.guery.mopp.GueryExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof GueryCompletionProposal) {
			GueryCompletionProposal other = (GueryCompletionProposal) object;
	...
	public int compareTo(GueryCompletionProposal object) {
		if (object instanceof GueryCompletionProposal) {
			GueryCompletionProposal other = (GueryCompletionProposal) object;

 ...
 */
public class GueryNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.modelrefactoring.guery.resource.guery.mopp.GueryMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.modelrefactoring.guery.resource.guery.ui");
							...
							String natureID = org.modelrefactoring.guery.resource.guery.mopp.GueryNature.NATURE_ID;
							...
							for (String builderID : org.modelrefactoring.guery.resource.guery.mopp.GueryNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.modelrefactoring.guery.resource.guery.mopp.GueryMetaInformation info = new org.modelrefactoring.guery.resource.guery.mopp.GueryMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = org.modelrefactoring.guery.resource.guery.ui.GueryUIPlugin.getDefault().getBundle();

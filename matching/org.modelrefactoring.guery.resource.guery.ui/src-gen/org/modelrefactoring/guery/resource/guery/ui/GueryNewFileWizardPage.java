 ...
 */
public class GueryNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public GueryNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new guery file");

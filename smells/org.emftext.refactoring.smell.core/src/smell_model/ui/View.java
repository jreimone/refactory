...
public class View  extends ViewPart {
	...
	public void createPartControl(Composite parent) {
    	...
    	image_start = new Image(device, View.class.getResourceAsStream(("/smell_model/ui/start.gif")));
        image_load = new Image(device, View.class.getResourceAsStream(("/smell_model/ui/load.gif")));

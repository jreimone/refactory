...
public class Smell_modelPackageImpl extends EPackageImpl implements Smell_modelPackage {
  ...
  {
		return (EAttribute)modelSmellModelEClass.getEStructuralFeatures().get(5);
	}
  ...
  /**
	...
	public EReference getModelSmellModel_Result() {
		return (EReference)modelSmellModelEClass.getEStructuralFeatures().get(7);
	}
	...
	public EAttribute getModelSmellModel_MetricResultMap() {
		return (EAttribute)modelSmellModelEClass.getEStructuralFeatures().get(9);
	}
	...
	public EReference getModelSmellModel_LoadedMetaModel() {
		return (EReference)modelSmellModelEClass.getEStructuralFeatures().get(10);
	}
	 ...
	 * @generated
	 */
	public EAttribute getModelMetric_Name() {
	...
	public void createPackageContents() {
		...
		createEAttribute(modelMetricEClass, MODEL_METRIC__NAME);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getMetric_Quality_Mapping_Metric(), this.getModelMetric(), null, "metric", null, 1, 1, Metric_Quality_Mapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		EGenericType g2 = createEGenericType(this.getQuality());
		...
		g1 = createEGenericType(theEcorePackage.getEMap());
		g2 = createEGenericType(this.getModelMetric());
		g1.getETypeArguments().add(g2);
		...
		initEReference(getModelSmellModel_Metrics(), this.getModelMetric(), null, "metrics", null, 0, -1, ModelSmellModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		EOperation op = addEOperation(modelSmellResultEClass, null, "calculate", 0, 1, IS_UNIQUE, IS_ORDERED);

 ...
 * @generated
 */
public class RolessmellSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RolessmellPackage.DISTINCT_ROLE_NAMES: {
				DistinctRoleNames distinctRoleNames = (DistinctRoleNames)theEObject;
				T result = caseDistinctRoleNames(distinctRoleNames);
				if (result == null) result = caseMetric(distinctRoleNames);
				if (result == null) result = caseCalculation(distinctRoleNames);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Distinct Role Names</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Distinct Role Names</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDistinctRoleNames(DistinctRoleNames object) {
		return null;
	}

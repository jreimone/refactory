 ...
 */
public class TestpropertiesSourceViewerConfiguration extends TextSourceViewerConfiguration {
	...
	public IAutoEditStrategy[] getAutoEditStrategies(ISourceViewer sourceViewer, String contentType) {
		return new IAutoEditStrategy[] {new org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesAutoEditStrategy()};
	}
	
	public IContentAssistant getContentAssistant(ISourceViewer sourceViewer) {
		
		ContentAssistant assistant = new ContentAssistant();
		assistant.setContentAssistProcessor(new org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesCompletionProcessor(resourceProvider), IDocument.DEFAULT_CONTENT_TYPE);
	...
	public ITextHover getTextHover(ISourceViewer sourceViewer, String contentType) {
		return new org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesTextHover(resourceProvider);
	}
	...
	public IHyperlinkDetector[] getHyperlinkDetectors(ISourceViewer sourceViewer) {
		...
		return new IHyperlinkDetector[] { new org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesHyperlinkDetector(resourceProvider.getResource()) };
	}
	
	public IQuickAssistAssistant getQuickAssistAssistant(ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new ISpellingProblemCollector() {
					...
					public void accept(SpellingProblem problem) {
						...
						if (new org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}

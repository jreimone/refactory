 ...
 */
public class TestpropertiesNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public TestpropertiesNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");

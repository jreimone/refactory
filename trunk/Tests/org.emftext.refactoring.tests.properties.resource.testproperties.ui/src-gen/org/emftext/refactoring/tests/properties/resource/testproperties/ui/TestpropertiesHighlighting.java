 ...
 */
public class TestpropertiesHighlighting implements ISelectionProvider, ISelectionChangedListener {
	...
	private org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesEditor editor;
	private ProjectionViewer projectionViewer;
	private org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesOccurrence occurrence;
	 ...
	 */
	private final class UpdateHighlightingListener implements KeyListener, VerifyListener, MouseListener, org.emftext.refactoring.tests.properties.resource.testproperties.ITestpropertiesBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public TestpropertiesHighlighting(org.emftext.refactoring.tests.properties.resource.testproperties.ITestpropertiesTextResource textResource, ProjectionViewer projectionViewer, org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesColorManager colorManager, org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesEditor editor) {
		...
		this.bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
	...
	private void setBracketHighlighting(IDocument document) {
		...
		Position[] positions = positionHelper.getPositions(document, org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(IDocument document, String category) {
		...
		if (category.equals(org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesEObjectSelection(selectedEObject, false));
				}
			}
		});
	}
	...
	public void resetValues() {
		...
		bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));

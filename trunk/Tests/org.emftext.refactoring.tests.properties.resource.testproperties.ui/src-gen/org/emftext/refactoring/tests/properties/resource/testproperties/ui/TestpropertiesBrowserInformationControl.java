...
public class TestpropertiesBrowserInformationControl extends AbstractInformationControl implements IInformationControlExtension2, IDelayedInputChangeProvider {
	 ...
	 */
	public TestpropertiesBrowserInformationControl(Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public TestpropertiesBrowserInformationControl(Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public TestpropertiesBrowserInformationControl(Shell parent, String symbolicFontName, ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesDocBrowserInformationControlInput);
	...
	public Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesHTMLPrinter.html2text(new StringReader(fInput.getHtml()), presentation);
		} catch (IOException e) {
			text = "";
		}

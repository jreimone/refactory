 ...
 */
public class TestpropertiesNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 * The constructor.
	 */
	public TestpropertiesNewProjectWizard() {
		super();
	}
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.emftext.refactoring.tests.properties.resource.testproperties.ui");
							...
							String natureID = org.emftext.refactoring.tests.properties.resource.testproperties.mopp.TestpropertiesNature.NATURE_ID;
							...
							for (String builderID : org.emftext.refactoring.tests.properties.resource.testproperties.mopp.TestpropertiesNature.BUILDER_IDS) {
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = org.emftext.refactoring.tests.properties.resource.testproperties.ui.TestpropertiesUIPlugin.getDefault().getBundle();

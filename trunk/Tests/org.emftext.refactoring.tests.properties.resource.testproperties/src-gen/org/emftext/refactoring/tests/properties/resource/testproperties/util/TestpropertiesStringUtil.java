 ...
 */
public class TestpropertiesStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, org.emftext.refactoring.tests.properties.resource.testproperties.ITestpropertiesFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, org.emftext.refactoring.tests.properties.resource.testproperties.ITestpropertiesFunction1<String, T> toStringFunction) {

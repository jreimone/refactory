...
public class TestpropertiesSyntaxErrorMessageConverter {
	
	private String[] tokenNames;
	
	public TestpropertiesSyntaxErrorMessageConverter(String[] tokenNames) {
	 ...
	 */
	public org.emftext.refactoring.tests.properties.resource.testproperties.mopp.TestpropertiesLocalizedMessage translateLexicalError(org.antlr.runtime3_4_0.RecognitionException e, java.util.List<org.antlr.runtime3_4_0.RecognitionException> lexerExceptions, java.util.List<Integer> lexerExceptionPositions)  {
		String message = getMessage(e);
		return new org.emftext.refactoring.tests.properties.resource.testproperties.mopp.TestpropertiesLocalizedMessage(message, e.charPositionInLine, e.line, lexerExceptionPositions.get(lexerExceptions.indexOf(e)), lexerExceptionPositions.get(lexerExceptions.indexOf(e)));
	}
	
	/**
	 * Translates errors thrown by the parser into human readable messages.
	 */
	public org.emftext.refactoring.tests.properties.resource.testproperties.mopp.TestpropertiesLocalizedMessage translateParseError(org.antlr.runtime3_4_0.RecognitionException e)  {
		String message = getMessage(e);
		
		if (e.token instanceof org.antlr.runtime3_4_0.CommonToken) {
			org.antlr.runtime3_4_0.CommonToken ct = (org.antlr.runtime3_4_0.CommonToken) e.token;
			return new org.emftext.refactoring.tests.properties.resource.testproperties.mopp.TestpropertiesLocalizedMessage(message, ct.getCharPositionInLine(), ct.getLine(), ct.getStartIndex(), ct.getStopIndex());
		} else {
			int position = 1;
			int line = 1;
			if (e.token != null) {
			...
			return new org.emftext.refactoring.tests.properties.resource.testproperties.mopp.TestpropertiesLocalizedMessage(message, position, line, 1, 5);
		}
	}

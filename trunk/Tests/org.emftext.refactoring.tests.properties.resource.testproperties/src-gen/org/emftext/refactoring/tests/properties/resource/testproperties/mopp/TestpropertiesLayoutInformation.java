...
/**
 * TestpropertiesLayoutInformation objects are used to store layout information
 ...
 * other tokens.
 * TestpropertiesLayoutInformations are aggregated in LayoutInformationAdapters.
 * One TestpropertiesLayoutInformation contains the layout that was found before a
 * keyword, attribute or reference.
 */
public class TestpropertiesLayoutInformation {
	 ...
	 */
	private final org.emftext.refactoring.tests.properties.resource.testproperties.grammar.TestpropertiesSyntaxElement syntaxElement;
	...
	public TestpropertiesLayoutInformation(org.emftext.refactoring.tests.properties.resource.testproperties.grammar.TestpropertiesSyntaxElement syntaxElement, Object object, int startOffset, String hiddenTokenText, String visibleTokenText) {
		super();
	...
	public org.emftext.refactoring.tests.properties.resource.testproperties.grammar.TestpropertiesSyntaxElement getSyntaxElement() {

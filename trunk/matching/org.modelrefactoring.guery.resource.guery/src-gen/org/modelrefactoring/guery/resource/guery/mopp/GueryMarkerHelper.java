 ...
 * contains
 * <code>org.modelrefactoring.guery.resource.guery.IGueryTextDiagnostic</code>s it
 * uses the more precise information of this extended diagnostic type.
 */
public class GueryMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = org.modelrefactoring.guery.resource.guery.mopp.GueryPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.modelrefactoring.guery.resource.guery.IGueryCommand<Object>> commands = new java.util.ArrayList<org.modelrefactoring.guery.resource.guery.IGueryCommand<Object>>();
		
		private MutexRule schedulingRule = new MutexRule();
		
		public void addCommand(org.modelrefactoring.guery.resource.guery.IGueryCommand<Object> command) {
		...
		public void runCommands() {
			java.util.List<org.modelrefactoring.guery.resource.guery.IGueryCommand<Object>> commandsToProcess = new java.util.ArrayList<org.modelrefactoring.guery.resource.guery.IGueryCommand<Object>>();
			synchronized(commands) {
				commandsToProcess.addAll(commands);
				commands.clear();
			}
			for (org.modelrefactoring.guery.resource.guery.IGueryCommand<Object> command : commandsToProcess) {
	 ...
	 */
	public void mark(org.eclipse.emf.ecore.resource.Resource resource, org.modelrefactoring.guery.resource.guery.IGueryTextDiagnostic diagnostic) {
	...
	protected void createMarkerFromDiagnostic(final org.eclipse.core.resources.IFile file, final org.modelrefactoring.guery.resource.guery.IGueryTextDiagnostic diagnostic) {
		final org.modelrefactoring.guery.resource.guery.IGueryProblem problem = diagnostic.getProblem();
		org.modelrefactoring.guery.resource.guery.GueryEProblemType problemType = problem.getType();
		final String markerID = getMarkerID(problemType);
		COMMAND_QUEUE.addCommand(new org.modelrefactoring.guery.resource.guery.IGueryCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.modelrefactoring.guery.resource.guery.GueryEProblemSeverity.ERROR) {
					...
					org.modelrefactoring.guery.resource.guery.IGueryTextDiagnostic textDiagnostic = (org.modelrefactoring.guery.resource.guery.IGueryTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.modelrefactoring.guery.resource.guery.mopp.GueryResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.modelrefactoring.guery.resource.guery.mopp.GueryResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.modelrefactoring.guery.resource.guery.IGueryQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.modelrefactoring.guery.resource.guery.util.GueryStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource) {
		for (org.modelrefactoring.guery.resource.guery.GueryEProblemType nextType : org.modelrefactoring.guery.resource.guery.GueryEProblemType.values()) {
	 ...
	 */
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, org.modelrefactoring.guery.resource.guery.GueryEProblemType problemType) {
		final org.eclipse.core.resources.IFile file = getFile(resource);
		if (file == null) {
			return;
		}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.modelrefactoring.guery.resource.guery.GueryEProblemType.UNKNOWN);
	 ...
	 * given type.
	 */
	public String getMarkerID(org.modelrefactoring.guery.resource.guery.GueryEProblemType problemType) {
	...
	protected void handleException(org.eclipse.core.runtime.CoreException ce) {
		if (ce.getMessage().matches("Marker.*not found.")) {
			...
			new org.modelrefactoring.guery.resource.guery.util.GueryRuntimeUtil().logError("Error while removing markers from resource:", ce);
		}
	}
		...
		COMMAND_QUEUE.addCommand(new org.modelrefactoring.guery.resource.guery.IGueryCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					org.modelrefactoring.guery.resource.guery.mopp.GueryPlugin.logError("Can't create marker.", e);
					return false;
				}
			}
		});

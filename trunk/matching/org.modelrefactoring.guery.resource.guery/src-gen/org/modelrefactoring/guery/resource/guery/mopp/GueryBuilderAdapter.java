...
public class GueryBuilderAdapter extends org.eclipse.core.resources.IncrementalProjectBuilder implements org.eclipse.core.resources.IResourceDeltaVisitor, org.eclipse.core.resources.IResourceVisitor {
	
	/**
	 * The ID of the default, generated builder.
	 */
	public final static String BUILDER_ID = "org.modelrefactoring.guery.resource.guery.builder";
	
	private org.modelrefactoring.guery.resource.guery.IGueryBuilder defaultBuilder = new org.modelrefactoring.guery.resource.guery.mopp.GueryBuilder();
	...
	public void build(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		...
		org.modelrefactoring.guery.resource.guery.IGueryBuilder builder = getBuilder();
		if (builder.isBuildingNeeded(uri)) {
			org.modelrefactoring.guery.resource.guery.mopp.GueryResource customResource = (org.modelrefactoring.guery.resource.guery.mopp.GueryResource) resourceSet.getResource(uri, true);
			new org.modelrefactoring.guery.resource.guery.mopp.GueryMarkerHelper().removeAllMarkers(resource, getBuilderMarkerId());
	 ...
	 */
	public org.modelrefactoring.guery.resource.guery.IGueryBuilder getBuilder() {
	...
	public String getBuilderMarkerId() {
		return new org.modelrefactoring.guery.resource.guery.mopp.GueryMarkerHelper().getMarkerID(org.modelrefactoring.guery.resource.guery.GueryEProblemType.BUILDER_ERROR);
	}
	...
	public void runTaskItemBuilder(org.eclipse.core.resources.IFile resource, org.eclipse.emf.ecore.resource.ResourceSet resourceSet, org.eclipse.core.runtime.IProgressMonitor monitor) {
		org.modelrefactoring.guery.resource.guery.mopp.GueryTaskItemBuilder taskItemBuilder = new org.modelrefactoring.guery.resource.guery.mopp.GueryTaskItemBuilder();
		new org.modelrefactoring.guery.resource.guery.mopp.GueryMarkerHelper().removeAllMarkers(resource, taskItemBuilder.getBuilderMarkerId());
	...
	protected boolean doVisit(org.eclipse.core.resources.IResource resource, boolean removed) throws org.eclipse.core.runtime.CoreException {
		...
		if (resource instanceof org.eclipse.core.resources.IFile && resource.getName().endsWith("." + new org.modelrefactoring.guery.resource.guery.mopp.GueryMetaInformation().getSyntaxName())) {

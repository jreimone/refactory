 ...
 */
public class GueryEclipseProxy {
	...
	public void getDefaultLoadOptionProviderExtensions(java.util.Map<Object, Object> optionsMap) {
		if (org.eclipse.core.runtime.Platform.isRunning()) {
			...
			org.eclipse.core.runtime.IConfigurationElement configurationElements[] = extensionRegistry.getConfigurationElementsFor(org.modelrefactoring.guery.resource.guery.mopp.GueryPlugin.EP_DEFAULT_LOAD_OPTIONS_ID);
			for (org.eclipse.core.runtime.IConfigurationElement element : configurationElements) {
				try {
					org.modelrefactoring.guery.resource.guery.IGueryOptionProvider provider = (org.modelrefactoring.guery.resource.guery.IGueryOptionProvider) element.createExecutableExtension("class");
					final java.util.Map<?, ?> options = provider.getOptions();
					final java.util.Collection<?> keys = options.keySet();
					for (Object key : keys) {
						org.modelrefactoring.guery.resource.guery.util.GueryMapUtil.putAndMergeKeys(optionsMap, key, options.get(key));
					}
				} catch (org.eclipse.core.runtime.CoreException ce) {
					new org.modelrefactoring.guery.resource.guery.util.GueryRuntimeUtil().logError("Exception while getting default options.", ce);
				}
			}
		}
	}
	...
	public void getResourceFactoryExtensions(java.util.Map<String, org.eclipse.emf.ecore.resource.Resource.Factory> factories) {
		if (org.eclipse.core.runtime.Platform.isRunning()) {
			org.eclipse.core.runtime.IExtensionRegistry extensionRegistry = org.eclipse.core.runtime.Platform.getExtensionRegistry();
			org.eclipse.core.runtime.IConfigurationElement configurationElements[] = extensionRegistry.getConfigurationElementsFor(org.modelrefactoring.guery.resource.guery.mopp.GueryPlugin.EP_ADDITIONAL_EXTENSION_PARSER_ID);
			for (org.eclipse.core.runtime.IConfigurationElement element : configurationElements) {
				try {
	...
	public void checkEMFValidationConstraints(org.modelrefactoring.guery.resource.guery.IGueryTextResource resource, org.eclipse.emf.ecore.EObject root, boolean includeBatchConstraints) {
		...
		org.modelrefactoring.guery.resource.guery.util.GueryRuntimeUtil runtimeUtil = new org.modelrefactoring.guery.resource.guery.util.GueryRuntimeUtil();
			...
			if (org.eclipse.emf.validation.internal.EMFModelValidationPlugin.getPlugin() != null) {
				try {
					...
					if (includeBatchConstraints) {
						...
						addStatus(status, resource, root, org.modelrefactoring.guery.resource.guery.GueryEProblemType.BATCH_CONSTRAINT_PROBLEM);
					}
					...
					addStatus(status, resource, root, org.modelrefactoring.guery.resource.guery.GueryEProblemType.LIVE_CONSTRAINT_PROBLEM);
				} catch (Throwable t) {
					new org.modelrefactoring.guery.resource.guery.util.GueryRuntimeUtil().logError("Exception while checking contraints provided by EMF validator classes.", t);
				}
			}
		}
	}
	...
	public void addStatus(org.eclipse.core.runtime.IStatus status, org.modelrefactoring.guery.resource.guery.IGueryTextResource resource, org.eclipse.emf.ecore.EObject root, org.modelrefactoring.guery.resource.guery.GueryEProblemType problemType) {
	...
	public String getPlatformResourceEncoding(org.eclipse.emf.common.util.URI uri) {
		...
		if (!new org.modelrefactoring.guery.resource.guery.util.GueryRuntimeUtil().isEclipsePlatformRunning()) {
			return null;
		}
		if (uri != null && uri.isPlatform()) {
			...
			if (platformResource instanceof org.eclipse.core.resources.IFile) {
				...
				try {
					...
					new org.modelrefactoring.guery.resource.guery.util.GueryRuntimeUtil().logWarning("Could not determine encoding of platform resource: " + uri.toString(), ce);
				}
			}
		}
		return null;

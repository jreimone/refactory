 ...
 */
public class GueryTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2 {
	...
	private org.modelrefactoring.guery.resource.guery.IGueryHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.modelrefactoring.guery.resource.guery.ui.GueryBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.modelrefactoring.guery.resource.guery.ui.GueryBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.modelrefactoring.guery.resource.guery.ui.GueryDocBrowserInformationControlInput infoInput = (org.modelrefactoring.guery.resource.guery.ui.GueryDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.modelrefactoring.guery.resource.guery.ui.GueryHyperlink hyperlink = new org.modelrefactoring.guery.resource.guery.ui.GueryHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.modelrefactoring.guery.resource.guery.ui.GueryBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.modelrefactoring.guery.resource.guery.ui.GueryBrowserInformationControl iControl = new org.modelrefactoring.guery.resource.guery.ui.GueryBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(Object newInput) {
						...
						} else if (newInput instanceof org.modelrefactoring.guery.resource.guery.ui.GueryDocBrowserInformationControlInput) {
							org.modelrefactoring.guery.resource.guery.ui.GueryDocBrowserInformationControlInput input = (org.modelrefactoring.guery.resource.guery.ui.GueryDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.modelrefactoring.guery.resource.guery.ui.GueryBrowserInformationControl.isAvailable(parent)) {
				org.modelrefactoring.guery.resource.guery.ui.GueryBrowserInformationControl iControl = new org.modelrefactoring.guery.resource.guery.ui.GueryBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public GueryTextHover(org.modelrefactoring.guery.resource.guery.IGueryResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
		this.hoverTextProvider = new org.modelrefactoring.guery.resource.guery.ui.GueryUIMetaInformation().getHoverTextProvider();
	}
	...
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		...
		return ((org.modelrefactoring.guery.resource.guery.ui.GueryDocBrowserInformationControlInput) hoverInfo).getHtml();
	}
	...
	private org.modelrefactoring.guery.resource.guery.ui.GueryDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
	 ...
	 */
	private org.modelrefactoring.guery.resource.guery.ui.GueryDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.modelrefactoring.guery.resource.guery.ui.GueryDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.modelrefactoring.guery.resource.guery.ui.GueryHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(containerObject, declarationObject));
			}
		} else {
			org.modelrefactoring.guery.resource.guery.ui.GueryHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.modelrefactoring.guery.resource.guery.ui.GueryHTMLPrinter.insertPageProlog(buffer, 0, org.modelrefactoring.guery.resource.guery.ui.GueryTextHover.getStyleSheet());
			org.modelrefactoring.guery.resource.guery.ui.GueryHTMLPrinter.addPageEpilog(buffer);
			return new org.modelrefactoring.guery.resource.guery.ui.GueryDocBrowserInformationControlInput(previousInput, declarationObject, resourceProvider.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		css = org.modelrefactoring.guery.resource.guery.ui.GueryHTMLPrinter.convertTopLevelFont(css, fontData);
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.modelrefactoring.guery.resource.guery.ui.GueryUIPlugin.PLUGIN_ID);
		java.net.URL styleSheetURL = bundle.getEntry("/css/hover_style.css");
		if (styleSheetURL != null) {
			try {
				return org.modelrefactoring.guery.resource.guery.util.GueryStreamUtil.getContent(styleSheetURL.openStream());

 ...
 */
public class GueryUIPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.modelrefactoring.guery.resource.guery.ui";
	public static final String EDITOR_ID = "org.modelrefactoring.guery.resource.guery.ui.GueryEditor";
	...
	private static GueryUIPlugin plugin;
	
	public GueryUIPlugin() {
		super();
	}
	...
	public static GueryUIPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, GueryUIPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, GueryUIPlugin.PLUGIN_ID, message);
		}
		final GueryUIPlugin pluginInstance = GueryUIPlugin.getDefault();

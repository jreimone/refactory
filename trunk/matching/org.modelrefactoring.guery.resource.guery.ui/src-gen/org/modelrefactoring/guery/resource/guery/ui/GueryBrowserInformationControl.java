 ...
 * @since 3.2
 */
public class GueryBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.modelrefactoring.guery.resource.guery.ui.GueryDocBrowserInformationControlInput fInput;
	 ...
	 */
	public GueryBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public GueryBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public GueryBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.modelrefactoring.guery.resource.guery.ui.GueryDocBrowserInformationControlInput);
		...
		fInput= (org.modelrefactoring.guery.resource.guery.ui.GueryDocBrowserInformationControlInput) input;
		...
		org.modelrefactoring.guery.resource.guery.ui.GueryHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.modelrefactoring.guery.resource.guery.ui.GueryHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.modelrefactoring.guery.resource.guery.ui.GueryDocBrowserInformationControlInput getInput() {
		return fInput;
	}

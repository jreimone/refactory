 ...
 * </copyright>
 *
 * $Id: LayoutsSwitch.java,v 1.3 2009/06/24 20:22:06 htraetteb Exp $
 */
...
public class LayoutsSwitch<T1> {
	...
	protected T1 doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case LayoutsPackage.RECTANGLE_LAYOUT: {
				...
				T1 result = caseRectangleLayout(rectangleLayout);
				if (result == null) result = caseLayout(rectangleLayout);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LayoutsPackage.RECTANGLE_LAYOUT_DATA: {
				LayoutData rectangleLayoutData = (LayoutData)theEObject;
				T1 result = caseRectangleLayoutData(rectangleLayoutData);
				if (result == null) result = caseLayoutData(rectangleLayoutData);
				if (result == null) result = caseRectangle(rectangleLayoutData);
				if (result == null) result = casePosition(rectangleLayoutData);
				if (result == null) result = caseDimension(rectangleLayoutData);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LayoutsPackage.POSITION: {
				EObject position = (EObject)theEObject;
				T1 result = casePosition(position);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LayoutsPackage.DIMENSION: {
				EObject dimension = (EObject)theEObject;
				T1 result = caseDimension(dimension);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LayoutsPackage.RECTANGLE: {
				EObject rectangle = (EObject)theEObject;
				T1 result = caseRectangle(rectangle);
				if (result == null) result = casePosition(rectangle);
				if (result == null) result = caseDimension(rectangle);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Rectangle Layout</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Rectangle Layout</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Rectangle Layout Data</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Rectangle Layout Data</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T1 caseRectangleLayoutData(LayoutData object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T1 casePosition(EObject object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T1 caseRectangle(EObject object) {
		return null;
	}

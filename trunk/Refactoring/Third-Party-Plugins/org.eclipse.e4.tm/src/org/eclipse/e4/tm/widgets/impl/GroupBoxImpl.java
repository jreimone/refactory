 ...
 * </copyright>
 *
 * $Id: GroupBoxImpl.java,v 1.2 2009/05/07 15:10:39 pwebster Exp $
 */
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == Labeled.class) {
			switch (derivedFeatureID) {
				case WidgetsPackage.GROUP_BOX__TEXT: return WidgetsPackage.LABELED__TEXT;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == Labeled.class) {
			switch (baseFeatureID) {
				case WidgetsPackage.LABELED__TEXT: return WidgetsPackage.GROUP_BOX__TEXT;
				default: return -1;
			}
		}

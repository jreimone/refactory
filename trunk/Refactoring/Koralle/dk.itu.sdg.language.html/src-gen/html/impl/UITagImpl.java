...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>UI Tag</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link html.impl.UITagImpl#getListItems <em>List Items</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class UITagImpl extends TagImpl implements UITag {
	/**
	...
	protected EClass eStaticClass() {
		return HtmlPackage.Literals.UI_TAG;
	}
	...
	public EList<ListItem> getListItems() {
		if (listItems == null) {
			listItems = new EObjectContainmentEList<ListItem>(ListItem.class, this, HtmlPackage.UI_TAG__LIST_ITEMS);
		}
		return listItems;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HtmlPackage.UI_TAG__LIST_ITEMS:

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Ol Tag</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link html.impl.OlTagImpl#getListItems <em>List Items</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class OlTagImpl extends TagImpl implements OlTag {
	/**
	...
	protected EClass eStaticClass() {
		return HtmlPackage.Literals.OL_TAG;
	}
	...
	public EList<ListItem> getListItems() {
		if (listItems == null) {
			listItems = new EObjectContainmentEList<ListItem>(ListItem.class, this, HtmlPackage.OL_TAG__LIST_ITEMS);
		}
		return listItems;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case HtmlPackage.OL_TAG__LIST_ITEMS:

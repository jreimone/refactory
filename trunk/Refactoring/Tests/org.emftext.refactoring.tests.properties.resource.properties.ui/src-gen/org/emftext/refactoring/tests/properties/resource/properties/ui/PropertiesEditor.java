...
/**
 * A text editor for 'properties' models.
 */
public class PropertiesEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider, org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.emf.common.ui.viewer.IViewerProvider, org.emftext.refactoring.tests.properties.resource.properties.IPropertiesResourceProvider, org.emftext.refactoring.tests.properties.resource.properties.ui.IPropertiesBracketHandlerProvider, org.emftext.refactoring.tests.properties.resource.properties.ui.IPropertiesAnnotationModelProvider {
	
	private org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesCodeFoldingManager codeFoldingManager;
	private org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesBackgroundParsingStrategy bgParsingStrategy = new org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesBackgroundParsingStrategy();
	private java.util.Collection<org.emftext.refactoring.tests.properties.resource.properties.IPropertiesBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.emftext.refactoring.tests.properties.resource.properties.IPropertiesBackgroundParsingListener>();
	private org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesColorManager colorManager = new org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesColorManager();
	private org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesOutlinePage outlinePage;
	...
	private org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPropertySheetPage propertySheetPage;
	...
	private org.emftext.refactoring.tests.properties.resource.properties.ui.IPropertiesBracketHandler bracketHandler;
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), PropertiesEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextResource currentResource = getResource();
				...
				org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesUIPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.emftext.refactoring.tests.properties.resource.properties.EditorContext");
		setRulerContextMenuId("org.emftext.refactoring.tests.properties.resource.properties.EditorRuler");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesNature.activate(inputFile.getProject());
		...
		org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextResource loadedResource = (org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextResource) {
					setResource((org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but some other EMF resource
					org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesUIPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the PropertiesEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (Exception e) {
				org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesUIPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextResource resource) {
	...
	private Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextToken token = lexer.getNextToken();
			...
			org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesUIPlugin.logError("Exception in setCaret()", e);
		}
	}
	...
	protected org.eclipse.jface.text.source.ISourceViewer createSourceViewer(org.eclipse.swt.widgets.Composite parent, org.eclipse.jface.text.source.IVerticalRuler ruler, int styles) {
		org.eclipse.jface.text.source.ISourceViewer viewer = new org.eclipse.jface.text.source.projection.ProjectionViewer(parent, ruler, getOverviewRuler(), isOverviewRulerVisible(), styles) {
			...
			public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
				if (!PropertiesEditor.this.setSelection(selection, reveal)) {
	...
	public void addBackgroundParsingListener(org.emftext.refactoring.tests.properties.resource.properties.IPropertiesBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.emftext.refactoring.tests.properties.resource.properties.IPropertiesBackgroundParsingListener listener : bgParsingListeners) {
			listener.parsingCompleted(getResource());
		}
	}
	
	public org.emftext.refactoring.tests.properties.resource.properties.ui.IPropertiesBracketHandler getBracketHandler() {
		return bracketHandler;
	}
	
	public void setBracketHandler(org.emftext.refactoring.tests.properties.resource.properties.ui.IPropertiesBracketHandler bracketHandler) {

 ...
 * @since 3.2
 */
public class PropertiesBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesDocBrowserInformationControlInput fInput;
	 ...
	 */
	public PropertiesBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public PropertiesBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public PropertiesBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesDocBrowserInformationControlInput) input;
		...
		org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesDocBrowserInformationControlInput getInput() {
		return fInput;
	}

...
public class PropertiesTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	...
	private org.emftext.refactoring.tests.properties.resource.properties.IPropertiesHoverTextProvider hoverTextProvider;
	/**
	 * The style sheet (css).
	 */
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesBrowserInformationControl infoControl;
		 ...
		 * element
		 */
		public OpenDeclarationAction(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesBrowserInformationControl infoControl) {
		 ...
		 */
		public void run() {
			org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesDocBrowserInformationControlInput infoInput = (org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesHyperlink hyperlink = new org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesBrowserInformationControl iControl = new org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(java.lang.Object newInput) {
						...
						} else if (newInput instanceof org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesDocBrowserInformationControlInput) {
							org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesDocBrowserInformationControlInput input = (org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesBrowserInformationControl.isAvailable(parent)) {
				org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesBrowserInformationControl iControl = new org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	 ...
	 */
	public PropertiesTextHover(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEditor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesMetaInformation().getHoverTextProvider();
	}
	...
	private org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextResource textResource = editor.getResource();
	 ...
	 */
	private org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
			org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesTextHover.getStyleSheet());
			org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesDocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesPlugin.PLUGIN_ID);

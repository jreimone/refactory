 ...
 */
public class PropertiesEObjectUtil {
	...
	public static Object invokeOperation(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EOperation o) {
		...
		try {
			...
			new org.emftext.refactoring.tests.properties.resource.properties.util.PropertiesRuntimeUtil().logError("Exception while matching proxy URI.", e);

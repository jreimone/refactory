 ...
 */
public class PropertiesHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public PropertiesHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEditor) {
					org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEditor emftEditor = (org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEditor) editorPart;

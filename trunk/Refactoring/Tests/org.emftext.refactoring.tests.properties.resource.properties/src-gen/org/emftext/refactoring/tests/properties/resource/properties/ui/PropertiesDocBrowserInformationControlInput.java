 ...
 * olInput</code>.
 */
public class PropertiesDocBrowserInformationControlInput {
	
	private final PropertiesDocBrowserInformationControlInput fPrevious;
	private PropertiesDocBrowserInformationControlInput fNext;
	 ...
	 */
	public PropertiesDocBrowserInformationControlInput(PropertiesDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public PropertiesDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public PropertiesDocBrowserInformationControlInput getNext() {
		return fNext;
	}

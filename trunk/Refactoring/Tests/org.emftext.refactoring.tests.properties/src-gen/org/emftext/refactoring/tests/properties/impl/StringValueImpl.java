 ...
 * <ul>
 *   <li>{@link org.emftext.refactoring.tests.properties.impl.StringValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringValueImpl extends ValueImpl implements StringValue {
   ...
   */
    ...
    return PropertiesPackage.Literals.STRING_VALUE;
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PropertiesPackage.STRING_VALUE__VALUE, oldValue, value));
  }
   ...
   */
    ...
    switch (featureID)
    {
      case PropertiesPackage.STRING_VALUE__VALUE:
        return getValue();
    }

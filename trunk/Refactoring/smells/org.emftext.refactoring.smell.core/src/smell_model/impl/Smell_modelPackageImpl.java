...
import smell_model.RoleMapping;
...
public class Smell_modelPackageImpl extends EPackageImpl implements Smell_modelPackage {
	 ...
	 * @see smell_model.Smell_modelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EAttribute getModelSmellModel_ConfigStrings() {
	...
	public void createPackageContents() {
		...
		createEAttribute(modelSmellModelEClass, MODEL_SMELL_MODEL__CONFIG_STRINGS);
	...
	public void initializePackageContents() {
		...
		initEReference(getModelSmell_Rolemapping_Mapping_RoleMapping(), theRolemappingPackage.getRoleMapping(), null, "roleMapping", null, 1, -1, ModelSmell_Rolemapping_Mapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEParameter(op, theEcorePackage.getEResource(), "loadedModel", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		g1.getETypeArguments().add(g2);
		initEAttribute(getModelSmellModel_ConfigStrings(), g1, "configStrings", "", 0, 1, ModelSmellModel.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getMappingConcretisation_NewFactor(), theEcorePackage.getEFloat(), "newFactor", null, 0, 1, MappingConcretisation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation
		  (getModelSmellModel_QualityScale(), 
		   source, 
		   new String[] {
			 "wildcards", "",
			 "name", ""

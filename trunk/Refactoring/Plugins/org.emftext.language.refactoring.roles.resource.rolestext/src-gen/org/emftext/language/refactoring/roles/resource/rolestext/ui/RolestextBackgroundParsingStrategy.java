...
public class RolestextBackgroundParsingStrategy {
	...
	// a delay.
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.emftext.language.refactoring.roles.resource.rolestext.IRolestextTextResource resource, final org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextEditor editor) {
		if (resource == null) {
			return;
		}

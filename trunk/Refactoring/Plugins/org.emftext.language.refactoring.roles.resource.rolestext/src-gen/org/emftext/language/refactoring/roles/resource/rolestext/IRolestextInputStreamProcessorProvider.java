...
// encoding conversion.
//
public interface IRolestextInputStreamProcessorProvider {
	
	// Return a processor for the given input stream.
	//
	// @param inputStream the actual stream that provides the content of a resource
	// @return a processor that pre-processes the input stream
	public org.emftext.language.refactoring.roles.resource.rolestext.mopp.RolestextInputStreamProcessor getInputStreamProcessor(java.io.InputStream inputStream);
}

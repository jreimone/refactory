...
public class RolestextEditorConfiguration extends org.eclipse.jface.text.source.SourceViewerConfiguration {
	
	private org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextColorManager colorManager;
	private org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextEditor theEditor;
	...
	// @param colorManager
	///
	public RolestextEditorConfiguration(org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextEditor editor, org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextColorManager colorManager) {
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextCompletionProcessor(theEditor), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextTextHover(theEditor);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextHyperlinkDetector(theEditor.getResource()) };
	}

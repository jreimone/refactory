...
// @since 3.2
///
public class RolestextBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextDocBrowserInformationControlInput fInput;
	...
	public RolestextBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	...
	public RolestextBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	...
	// @since 3.4
	///
	public RolestextBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextDocBrowserInformationControlInput) input;
		...
		org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	...
	///
	public org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextDocBrowserInformationControlInput getInput() {
		return fInput;
	}

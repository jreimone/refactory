...
public class RolestextResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	...
	public RolestextResourceFactoryDelegator() {
		init();
	}
	...
	protected void init() {
		...
		if (org.eclipse.core.runtime.Platform.isRunning()) {
			...
			org.eclipse.core.runtime.IConfigurationElement configurationElements[] = extensionRegistry.getConfigurationElementsFor(org.emftext.language.refactoring.roles.resource.rolestext.mopp.RolestextPlugin.EP_ADDITIONAL_EXTENSION_PARSER_ID);
		...
		if (factories.get("") == null) {
			factories.put("", new org.emftext.language.refactoring.roles.resource.rolestext.mopp.RolestextResourceFactory());
		}
	}

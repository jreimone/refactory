...
public class RolestextCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.emftext.language.refactoring.roles.resource.rolestext.IRolestextBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextEditor) {
				org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextEditor editor = (org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextEditor) workbenchPart;
	...
	protected org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextEditor editor;
	...
	public RolestextCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextEditor textEditor) {
	...
	private void addCloseListener(final org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.language.refactoring.roles.resource.rolestext.mopp.RolestextPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.language.refactoring.roles.resource.rolestext.IRolestextTextResource textResource = (org.emftext.language.refactoring.roles.resource.rolestext.IRolestextTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();

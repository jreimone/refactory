...
public class RolestextEObjectUtil {
	...
	public static java.lang.Object invokeOperation(org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.EOperation o) {
		...
		try {
			...
			org.emftext.language.refactoring.roles.resource.rolestext.mopp.RolestextPlugin.logError("java.lang.Exception while matching proxy URI.", e);

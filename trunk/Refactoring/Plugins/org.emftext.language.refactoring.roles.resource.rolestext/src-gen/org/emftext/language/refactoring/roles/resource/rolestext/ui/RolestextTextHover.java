...
//
public class RolestextTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	...
	private org.emftext.language.refactoring.roles.resource.rolestext.IRolestextHoverTextProvider hoverTextProvider;
	// The style sheet (css).
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextBrowserInformationControl infoControl;
		...
		//            target element
		public OpenDeclarationAction(org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextBrowserInformationControl infoControl) {
		...
		public void run() {
			org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextDocBrowserInformationControlInput infoInput = (org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextHyperlink hyperlink = new org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextBrowserInformationControl iControl = new org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(java.lang.Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextDocBrowserInformationControlInput) {
							org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextDocBrowserInformationControlInput input = (org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextBrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextBrowserInformationControl iControl = new org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	...
	// element.
	public RolestextTextHover(org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextEditor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new org.emftext.language.refactoring.roles.resource.rolestext.mopp.RolestextMetaInformation().getHoverTextProvider();
	}
	
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		org.emftext.language.refactoring.roles.resource.rolestext.IRolestextTextResource textResource = editor.getResource();
	...
	private org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
			org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextTextHover.getStyleSheet());
			org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextDocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.language.refactoring.roles.resource.rolestext.mopp.RolestextPlugin.PLUGIN_ID);

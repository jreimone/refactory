...
//
public class RolestextDelegatingResolveResult<ReferenceType> implements org.emftext.language.refactoring.roles.resource.rolestext.IRolestextReferenceResolveResult<ReferenceType> {
	
	private org.emftext.language.refactoring.roles.resource.rolestext.IRolestextReferenceResolveResult<ReferenceType> delegate;
	
	public RolestextDelegatingResolveResult(org.emftext.language.refactoring.roles.resource.rolestext.IRolestextReferenceResolveResult<ReferenceType> delegate) {

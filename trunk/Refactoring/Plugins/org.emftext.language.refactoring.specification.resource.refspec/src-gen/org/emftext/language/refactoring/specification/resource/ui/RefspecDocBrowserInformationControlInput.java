...
public class RefspecDocBrowserInformationControlInput {
	
	private final RefspecDocBrowserInformationControlInput fPrevious;
	private RefspecDocBrowserInformationControlInput fNext;
	...
	///
	public RefspecDocBrowserInformationControlInput(RefspecDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	...
	public RefspecDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	...
	public RefspecDocBrowserInformationControlInput getNext() {
		return fNext;
	}

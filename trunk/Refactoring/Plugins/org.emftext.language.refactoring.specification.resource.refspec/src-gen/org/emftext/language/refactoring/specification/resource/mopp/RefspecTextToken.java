...
public class RefspecTextToken implements org.emftext.language.refactoring.specification.resource.IRefspecTextToken {
	
	private final org.emftext.language.refactoring.specification.resource.IRefspecMetaInformation metaInformation = new org.emftext.language.refactoring.specification.resource.mopp.RefspecMetaInformation();

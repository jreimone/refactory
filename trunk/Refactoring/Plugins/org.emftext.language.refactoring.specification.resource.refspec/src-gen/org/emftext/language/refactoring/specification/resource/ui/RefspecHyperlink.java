	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof org.emftext.language.refactoring.specification.resource.ui.RefspecEditor) {
					org.emftext.language.refactoring.specification.resource.ui.RefspecEditor emftEditor = (org.emftext.language.refactoring.specification.resource.ui.RefspecEditor) editorPart;

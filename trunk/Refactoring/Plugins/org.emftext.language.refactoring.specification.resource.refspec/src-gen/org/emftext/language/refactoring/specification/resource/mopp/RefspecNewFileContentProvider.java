...
public class RefspecNewFileContentProvider {
	...
	public org.emftext.language.refactoring.specification.resource.IRefspecTextPrinter getPrinter(java.io.OutputStream outputStream) {
		return new org.emftext.language.refactoring.specification.resource.mopp.RefspecPrinter(outputStream, new org.emftext.language.refactoring.specification.resource.mopp.RefspecResource());
	}

...
public class RefspecEditorConfiguration extends org.eclipse.jface.text.source.SourceViewerConfiguration {
	...
	private org.emftext.language.refactoring.specification.resource.ui.RefspecEditor theEditor;
	...
	// @param colorManager
	///
	public RefspecEditorConfiguration(org.emftext.language.refactoring.specification.resource.ui.RefspecEditor editor, org.emftext.language.refactoring.specification.resource.ui.RefspecColorManager colorManager) {
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new org.emftext.language.refactoring.specification.resource.ui.RefspecCompletionProcessor(theEditor), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new org.emftext.language.refactoring.specification.resource.ui.RefspecTextHover(theEditor);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new org.emftext.language.refactoring.specification.resource.ui.RefspecHyperlinkDetector(theEditor.getResource()) };
	}

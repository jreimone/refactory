...
public class RefspecEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	...
	private org.emftext.language.refactoring.specification.resource.ui.RefspecHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.emftext.language.refactoring.specification.resource.ui.RefspecCodeFoldingManager codeFoldingManager;
	private org.emftext.language.refactoring.specification.resource.ui.RefspecBackgroundParsingStrategy bgParsingStrategy = new org.emftext.language.refactoring.specification.resource.ui.RefspecBackgroundParsingStrategy();
	private java.util.Collection<org.emftext.language.refactoring.specification.resource.IRefspecBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.emftext.language.refactoring.specification.resource.IRefspecBackgroundParsingListener>();
	private org.emftext.language.refactoring.specification.resource.ui.RefspecColorManager colorManager = new org.emftext.language.refactoring.specification.resource.ui.RefspecColorManager();
	private org.emftext.language.refactoring.specification.resource.ui.RefspecOutlinePage outlinePage;
	...
	private org.emftext.language.refactoring.specification.resource.ui.RefspecPropertySheetPage propertySheetPage;
	...
	public RefspecEditor() {
		...
		setSourceViewerConfiguration(new org.emftext.language.refactoring.specification.resource.ui.RefspecEditorConfiguration(this, colorManager));
	...
	private final class MarkerUpdateListener implements org.emftext.language.refactoring.specification.resource.IRefspecBackgroundParsingListener {
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.emftext.language.refactoring.specification.resource.IRefspecTextResource currentResource = getResource();
				...
				org.emftext.language.refactoring.specification.resource.mopp.RefspecPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void initializeEditor() {
		...
		setEditorContextMenuId("org.emftext.language.refactoring.specification.resource.refspec.EditorContext");
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.emftext.language.refactoring.specification.resource.ui.RefspecHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.emftext.language.refactoring.specification.resource.ui.RefspecCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.emftext.language.refactoring.specification.resource.mopp.RefspecNature.activate(inputFile.getProject());
		...
		org.emftext.language.refactoring.specification.resource.IRefspecTextResource loadedResource = (org.emftext.language.refactoring.specification.resource.IRefspecTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.emftext.language.refactoring.specification.resource.IRefspecTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.emftext.language.refactoring.specification.resource.IRefspecTextResource) {
					setResource((org.emftext.language.refactoring.specification.resource.IRefspecTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but
					// some other EMF resource
					org.emftext.language.refactoring.specification.resource.mopp.RefspecPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the RefspecEditor.");
					//close this editor because it can not present the resource
					close(false);
				}
			} catch (java.lang.Exception e) {
				org.emftext.language.refactoring.specification.resource.mopp.RefspecPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.emftext.language.refactoring.specification.resource.IRefspecTextResource resource) {
		assert resource != null;
	...
	private java.lang.Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.emftext.language.refactoring.specification.resource.ui.RefspecOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.emftext.language.refactoring.specification.resource.ui.RefspecPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.emftext.language.refactoring.specification.resource.IRefspecTextResource textResource = (org.emftext.language.refactoring.specification.resource.IRefspecTextResource) element.eResource();
			org.emftext.language.refactoring.specification.resource.IRefspecLocationMap locationMap = textResource.getLocationMap();
			int destination = locationMap.getCharStart(element);
			int length = locationMap.getCharEnd(element) + 1 - destination;
			
			org.emftext.language.refactoring.specification.resource.IRefspecTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.emftext.language.refactoring.specification.resource.IRefspecTextToken token = lexer.getNextToken();
			...
			org.emftext.language.refactoring.specification.resource.mopp.RefspecPlugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(org.emftext.language.refactoring.specification.resource.IRefspecBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.emftext.language.refactoring.specification.resource.IRefspecBackgroundParsingListener listener : bgParsingListeners) {
	...
	private void refreshMarkers(final org.eclipse.emf.ecore.resource.Resource resourceToRefresh) {
		...
		if (display != null) {
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						org.emftext.language.refactoring.specification.resource.ui.RefspecMarkerHelper.unmark(resourceToRefresh);
						org.emftext.language.refactoring.specification.resource.ui.RefspecMarkerHelper.mark(resourceToRefresh);
					} catch (org.eclipse.core.runtime.CoreException e) {
						org.emftext.language.refactoring.specification.resource.mopp.RefspecPlugin.logError("Exception while updating markers on resource", e);
					}
				}
			});
		}

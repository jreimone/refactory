...
public interface IRefspecInputStreamProcessorProvider {
	...
	public org.emftext.language.refactoring.specification.resource.mopp.RefspecInputStreamProcessor getInputStreamProcessor(java.io.InputStream inputStream);
}

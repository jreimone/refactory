...
public class RefspecBracketSet {
	...
	private java.util.ArrayList<org.emftext.language.refactoring.specification.resource.IRefspecBracketPair> bracketPairs;
	...
	private class BracketPair implements org.emftext.language.refactoring.specification.resource.IRefspecBracketPair {
	...
	private class ClosingListener implements org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.emftext.language.refactoring.specification.resource.IRefspecBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	...
	public RefspecBracketSet(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String extension) {
		...
		this.bracketPairs = new java.util.ArrayList<org.emftext.language.refactoring.specification.resource.IRefspecBracketPair>();
	...
	public org.emftext.language.refactoring.specification.resource.IRefspecBracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.language.refactoring.specification.resource.IRefspecBracketPair bracketPair : bracketPairs) {
	...
	public org.emftext.language.refactoring.specification.resource.IRefspecBracketPair getBracketPair(int index) {
		try {
	...
	public boolean setClosingEnabledInside(org.emftext.language.refactoring.specification.resource.IRefspecBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.language.refactoring.specification.resource.ui.RefspecPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	...
	public org.emftext.language.refactoring.specification.resource.IRefspecBracketPair remove(String opening, String closing) {
		for (org.emftext.language.refactoring.specification.resource.IRefspecBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.emftext.language.refactoring.specification.resource.IRefspecBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.language.refactoring.specification.resource.ui.RefspecPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.language.refactoring.specification.resource.ui.RefspecPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}

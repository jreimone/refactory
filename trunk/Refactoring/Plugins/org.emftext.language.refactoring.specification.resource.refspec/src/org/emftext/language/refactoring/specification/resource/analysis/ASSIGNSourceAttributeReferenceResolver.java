...
public class ASSIGNSourceAttributeReferenceResolver extends AbstractRoleAttributeResolver implements org.emftext.language.refactoring.specification.resource.IRefspecReferenceResolver<org.emftext.language.refactoring.refactoring_specification.ASSIGN, org.emftext.language.refactoring.roles.RoleAttribute> {
	...
	/* (non-Javadoc)
	 * @see org.emftext.language.refactoring.specification.resource.analysis.AbstractRoleAttributeResolver#getSpecificRole()
	 */
	@Override
	protected RoleAttribute getSpecificRole(ASSIGN container) {
		return container.getSourceAttribute();
	}

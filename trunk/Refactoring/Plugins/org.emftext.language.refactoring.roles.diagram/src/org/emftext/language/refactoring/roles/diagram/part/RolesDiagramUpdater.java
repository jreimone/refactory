...
public class RolesDiagramUpdater {
	 ...
	 * @generated
	 */
	private static Collection getContainedTypeModelFacetLinks_RoleImplication_4001(RoleModel container) {
	 ...
	 * @generated
	 */
	private static Collection getContainedTypeModelFacetLinks_RoleProhibition_4002(RoleModel container) {
		Collection result = new LinkedList();
		for (Iterator links = container.getCollaborations().iterator(); links.hasNext();) {
			EObject linkObject = (EObject) links.next();
	 ...
	 * @generated
	 */
	private static Collection getContainedTypeModelFacetLinks_RoleAssociation_4003(RoleModel container) {
		Collection result = new LinkedList();
		for (Iterator links = container.getCollaborations().iterator(); links.hasNext();) {
			EObject linkObject = (EObject) links.next();
	 ...
	 * @generated
	 */
	private static Collection getContainedTypeModelFacetLinks_RoleComposition_4004(RoleModel container) {
		Collection result = new LinkedList();
		for (Iterator links = container.getCollaborations().iterator(); links.hasNext();) {
			EObject linkObject = (EObject) links.next();
	 ...
	 * @generated
	 */
	private static Collection getIncomingTypeModelFacetLinks_RoleImplication_4001(Role target, Map crossReferences) {
		Collection result = new LinkedList();
	 ...
	 * @generated
	 */
	private static Collection getIncomingTypeModelFacetLinks_RoleProhibition_4002(Role target, Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
	 ...
	 * @generated
	 */
	private static Collection getIncomingTypeModelFacetLinks_RoleAssociation_4003(Role target, Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
	 ...
	 * @generated
	 */
	private static Collection getIncomingTypeModelFacetLinks_RoleComposition_4004(Role target, Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
	 ...
	 * @generated
	 */
	private static Collection getOutgoingTypeModelFacetLinks_RoleImplication_4001(Role source) {
	 ...
	 * @generated
	 */
	private static Collection getOutgoingTypeModelFacetLinks_RoleProhibition_4002(Role source) {
		RoleModel container = null;
		// Find container element for the link.
		// Climb up by containment hierarchy starting from the source
		// and return the first element that is instance of the container class.
	 ...
	 * @generated
	 */
	private static Collection getOutgoingTypeModelFacetLinks_RoleAssociation_4003(Role source) {
		RoleModel container = null;
		// Find container element for the link.
		// Climb up by containment hierarchy starting from the source
		// and return the first element that is instance of the container class.
	 ...
	 * @generated
	 */
	private static Collection getOutgoingTypeModelFacetLinks_RoleComposition_4004(Role source) {
		RoleModel container = null;
		// Find container element for the link.
		// Climb up by containment hierarchy starting from the source
		// and return the first element that is instance of the container class.

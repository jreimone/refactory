...
public class RoleAssociationTargetNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				RolesVisualIDRegistry.getType(org.emftext.language.refactoring.roles.diagram.edit.parts.RoleAssociationTargetNameEditPart.VISUAL_ID),
				new Point(10, 0));
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new RoleModelEditPart.LinkLabelDragPolicy());
	}

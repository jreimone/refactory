 ...
 * @generated
 */
public class RolesNavigatorLinkHelper implements ILinkHelper {
	...
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocument document = RolesDiagramEditorPlugin.getInstance().getDocumentProvider().getDiagramDocument(
				anInput);
		if (document == null) {
	...
	public void activateEditor(IWorkbenchPage aPage,
		...
		if (false == aSelection.getFirstElement() instanceof RolesAbstractNavigatorItem) {
			return;
		}

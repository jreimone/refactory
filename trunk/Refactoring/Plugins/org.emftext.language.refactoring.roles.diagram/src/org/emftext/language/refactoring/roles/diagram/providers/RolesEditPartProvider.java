 ...
 * @generated
 */
public class RolesEditPartProvider extends AbstractEditPartProvider {
	...
	public RolesEditPartProvider() {
		setFactory(new RolesEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!RoleModelEditPart.MODEL_ID.equals(
					RolesVisualIDRegistry.getModelID(view))) {
				return false;
			}

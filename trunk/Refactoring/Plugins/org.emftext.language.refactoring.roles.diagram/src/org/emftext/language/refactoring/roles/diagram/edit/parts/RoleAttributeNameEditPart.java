...
public class RoleAttributeNameEditPart extends CompartmentEditPart implements
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new RolesTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE,
				new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new RoleModelEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = RolesParserProvider.getParser(
					RolesElementTypes.RoleAttribute_3001,
					getParserElement(),
					RolesVisualIDRegistry.getType(org.emftext.language.refactoring.roles.diagram.edit.parts.RoleAttributeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected void handleNotificationEvent(Notification event) {
		...
		if (NotationPackage.eINSTANCE.getFontStyle_FontColor().equals(feature)) {
			...
			if (getParser() != null && getParser().isAffectingEvent(event,
					getParserOptions().intValue())) {
				refreshLabel();
			}
			if (getParser() instanceof ISemanticParser) {

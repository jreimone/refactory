...
import org.emftext.language.refactoring.roles.diagram.part.RolesDiagramEditorUtil;

/**
 * @generated
 */
public class RolesMarkerNavigationProvider
	...
	*/
	public static final String MARKER_TYPE =
			RolesDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			RolesDiagramEditorUtil.selectElementsInDiagram(

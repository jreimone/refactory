...
public class RefactoringSpecificationSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case RefactoringSpecificationPackage.PRIMITIVE_COMMAND: {
				PrimitiveCommand primitiveCommand = (PrimitiveCommand)theEObject;
				T result = casePrimitiveCommand(primitiveCommand);
				if (result == null) result = caseInstruction(primitiveCommand);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RefactoringSpecificationPackage.CREATE: {
				...
				if (result == null) result = casePrimitiveCommand(create);
			...
			case RefactoringSpecificationPackage.MOVE: {
				...
				if (result == null) result = casePrimitiveCommand(move);

...
public class RefspecTextToken implements org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecTextToken {
	
	private final org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecMetaInformation metaInformation = new org.emftext.language.refactoring.refactoring_specification.resource.refspec.mopp.RefspecMetaInformation();
	private final org.antlr.runtime3_2_0.Token antlrToken;
	
	public RefspecTextToken(org.antlr.runtime3_2_0.Token antlrToken) {
		super();

...
public class RefspecBackgroundParsingStrategy {
	...
	// a delay.
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecTextResource resource, final org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecEditor editor) {
		if (resource == null) {
			return;
		}

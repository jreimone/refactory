...
public class RefspecResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	...
	protected void init() {
		...
		if (org.eclipse.core.runtime.Platform.isRunning()) {
			...
			org.eclipse.core.runtime.IConfigurationElement configurationElements[] = extensionRegistry.getConfigurationElementsFor(org.emftext.language.refactoring.refactoring_specification.resource.refspec.mopp.RefspecPlugin.EP_ADDITIONAL_EXTENSION_PARSER_ID);
		...
		if (factories.get("") == null) {
			factories.put("", new org.emftext.language.refactoring.refactoring_specification.resource.refspec.mopp.RefspecResourceFactory());
		}
	}

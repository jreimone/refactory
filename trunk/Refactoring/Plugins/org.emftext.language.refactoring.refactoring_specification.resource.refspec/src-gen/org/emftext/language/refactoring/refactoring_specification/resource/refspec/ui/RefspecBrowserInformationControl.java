...
// @since 3.2
///
public class RefspecBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecDocBrowserInformationControlInput fInput;
	...
	public RefspecBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	...
	public RefspecBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	...
	// @since 3.4
	///
	public RefspecBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecDocBrowserInformationControlInput) input;
		...
		org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	...
	///
	public org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecDocBrowserInformationControlInput getInput() {
		return fInput;
	}

...
//
public class RefspecTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	
	private static final String FONT = org.eclipse.jface.resource.JFaceResources.DIALOG_FONT;
	private org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecEditor editor;
	private org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecHoverTextProvider hoverTextProvider;
	// The style sheet (css).
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecBrowserInformationControl infoControl;
		...
		//            target element
		public OpenDeclarationAction(org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecBrowserInformationControl infoControl) {
		...
		public void run() {
			org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecDocBrowserInformationControlInput infoInput = (org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecHyperlink hyperlink = new org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecBrowserInformationControl iControl = new org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(java.lang.Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecDocBrowserInformationControlInput) {
							org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecDocBrowserInformationControlInput input = (org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecBrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecBrowserInformationControl iControl = new org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	...
	// element.
	public RefspecTextHover(org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecEditor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new org.emftext.language.refactoring.refactoring_specification.resource.refspec.mopp.RefspecMetaInformation().getHoverTextProvider();
	}
	
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecTextResource textResource = editor.getResource();
	...
	private org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
			org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecTextHover.getStyleSheet());
			org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecDocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.language.refactoring.refactoring_specification.resource.refspec.mopp.RefspecPlugin.PLUGIN_ID);

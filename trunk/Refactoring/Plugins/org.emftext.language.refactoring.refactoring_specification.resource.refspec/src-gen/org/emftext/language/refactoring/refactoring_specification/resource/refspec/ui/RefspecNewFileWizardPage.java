...
public class RefspecNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	...
	//
	// @param pageName
	public RefspecNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new refspec file");

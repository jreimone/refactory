...
public class RefspecHyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	...
	public RefspecHyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				if (editorPart instanceof org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecEditor) {
					org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecEditor emftEditor = (org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecEditor) editorPart;

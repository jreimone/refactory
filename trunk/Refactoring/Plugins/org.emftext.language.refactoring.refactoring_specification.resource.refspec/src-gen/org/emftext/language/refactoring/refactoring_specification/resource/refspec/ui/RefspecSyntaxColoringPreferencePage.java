...
///
public class RefspecSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecPixelConverter pixelConverter = new org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecPixelConverter(composite);
	...
	public RefspecSyntaxColoringPreferencePage() {
		super();
		
		org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecMetaInformation syntaxPlugin = new org.emftext.language.refactoring.refactoring_specification.resource.refspec.mopp.RefspecMetaInformation();
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecEditor) {
			org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecEditor emfTextEditor = (org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecEditor) editor;

...
public interface IRefspecMetaInformation {
	...
	// @param encoding
	// @return
	public org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecTextParser createParser(java.io.InputStream inputStream, String encoding);
	...
	public org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecTokenStyle getDefaultTokenStyle(String tokenName);

...
public class RefspecNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecNewFileWizardPage page;
	private org.eclipse.jface.viewers.ISelection selection;
	private String newName = null;
	
	public RefspecNewFileWizard() {
		super();
	...
	public void addPages() {
		page = new org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.emftext.language.refactoring.refactoring_specification.resource.refspec.mopp.RefspecPlugin.logError("java.lang.Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.emftext.language.refactoring.refactoring_specification.resource.refspec.mopp.RefspecPlugin.logError("java.lang.Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.emftext.language.refactoring.refactoring_specification.resource.refspec.mopp.RefspecMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public java.lang.String getFileExtension() {
		return new org.emftext.language.refactoring.refactoring_specification.resource.refspec.mopp.RefspecMetaInformation().getSyntaxName();
	}

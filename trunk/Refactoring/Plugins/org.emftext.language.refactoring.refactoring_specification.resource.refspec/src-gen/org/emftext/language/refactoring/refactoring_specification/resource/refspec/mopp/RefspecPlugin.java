...
public class RefspecPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.refactoring.refactoring_specification.resource.refspec";
	...
	private static RefspecPlugin plugin;
	
	public RefspecPlugin() {
		super();
	}
	...
	public static RefspecPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, RefspecPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, RefspecPlugin.PLUGIN_ID, message);
		}
		final RefspecPlugin pluginInstance = RefspecPlugin.getDefault();

...
public class RolemappingPackageImpl extends EPackageImpl implements RolemappingPackage {
   ...
   * @generated
   */
	public EReference getConcreteMapping_OutgoingRelationMappings() {
   ...
   * @generated
   */
	public EReference getRelationMapping_References() {
   ...
   */
    ...
    createEReference(concreteMappingEClass, CONCRETE_MAPPING__OUTGOING_RELATION_MAPPINGS);
    ...
    createEReference(relationMappingEClass, RELATION_MAPPING__REFERENCES);
   ...
   */
    ...
    addEOperation(mappingEClass, theRolesPackage.getRole(), "getAllMappedRoles", 0, -1, IS_UNIQUE, IS_ORDERED);

    EOperation op = addEOperation(mappingEClass, theRolesPackage.getRole(), "getMappedRolesForEObject", 0, -1, IS_UNIQUE, IS_ORDERED);
    ...
    initEReference(getConcreteMapping_OutgoingRelationMappings(), this.getRelationMapping(), null, "outgoingRelationMappings", null, 0, -1, ConcreteMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getRelationMapping_Relation(), theRolesPackage.getMultiplicityRelation(), null, "relation", null, 1, 1, RelationMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getRelationMapping_References(), theEcorePackage.getEReference(), null, "references", null, 1, -1, RelationMapping.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

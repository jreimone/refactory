 ...
 * <ul>
 *   <li>{@link SimpleTrace.impl.TraceImpl#getLinks <em>Links</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TraceImpl extends EObjectImpl implements Trace {
	...
	protected EClass eStaticClass() {
		return SimpleTracePackage.Literals.TRACE;
	}
	...
	public EList<TraceLink> getLinks() {
		if (links == null) {
			links = new EObjectContainmentEList<TraceLink>(TraceLink.class, this, SimpleTracePackage.TRACE__LINKS);
		}
		return links;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SimpleTracePackage.TRACE__LINKS:

...
public interface IGueryOptions {
	 ...
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new org.qualitune.guery.resource.guery.mopp.GueryMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new org.qualitune.guery.resource.guery.mopp.GueryMetaInformation().getResourcePostProcessorProviderOptionKey();

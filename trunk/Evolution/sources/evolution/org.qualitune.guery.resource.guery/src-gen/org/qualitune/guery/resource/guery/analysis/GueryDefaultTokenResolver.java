 ...
 */
public class GueryDefaultTokenResolver implements org.qualitune.guery.resource.guery.IGueryTokenResolver {
	...
	public void resolve(String lexem, org.eclipse.emf.ecore.EStructuralFeature feature, org.qualitune.guery.resource.guery.IGueryTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.qualitune.guery.resource.guery.grammar.GueryGrammarInformationProvider.INSTANCE.getKeywords()) {

...
public class GueryResourceFactoryDelegator implements org.eclipse.emf.ecore.resource.Resource.Factory {
	...
	protected void init() {
		...
		if (new org.qualitune.guery.resource.guery.util.GueryRuntimeUtil().isEclipsePlatformAvailable()) {
			new org.qualitune.guery.resource.guery.util.GueryEclipseProxy().getResourceFactoryExtensions(factories);
		}
		if (factories.get("") == null) {
			factories.put("", new org.qualitune.guery.resource.guery.mopp.GueryResourceFactory());
		}
	}

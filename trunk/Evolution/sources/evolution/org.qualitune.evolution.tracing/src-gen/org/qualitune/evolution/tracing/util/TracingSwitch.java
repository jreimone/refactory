 ...
 * @generated
 */
public class TracingSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TracingPackage.TRACING_MODEL: {
				TracingModel tracingModel = (TracingModel)theEObject;
				T result = caseTracingModel(tracingModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TracingPackage.TRACE_LINK: {
	 ...
	 * @generated
	 */
	public T caseTracingModel(TracingModel object) {
		return null;
	}

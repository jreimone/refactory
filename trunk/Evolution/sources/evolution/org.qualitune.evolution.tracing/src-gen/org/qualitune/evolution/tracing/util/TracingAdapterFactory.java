 ...
 * $Id$
 */
package org.qualitune.evolution.tracing.util;
...
public class TracingAdapterFactory extends AdapterFactoryImpl {
	...
	protected TracingSwitch<Adapter> modelSwitch =
		new TracingSwitch<Adapter>() {
			@Override
			public Adapter caseTracingModel(TracingModel object) {
				return createTracingModelAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.qualitune.evolution.tracing.TracingModel <em>Model</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTracingModelAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.qualitune.evolution.tracing.TraceLink <em>Trace Link</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->

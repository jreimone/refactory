 ...
 * <ul>
 *   <li>{@link org.qualitune.guery.impl.GroupingImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class GroupingImpl extends EObjectImpl implements Grouping {
	/**
	...
	protected EClass eStaticClass() {
		return GueryPackage.Literals.GROUPING;
	}
	...
	public EList<String> getExpressions() {
		if (expressions == null) {
			expressions = new EDataTypeUniqueEList<String>(String.class, this, GueryPackage.GROUPING__EXPRESSIONS);
		}
		return expressions;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GueryPackage.GROUPING__EXPRESSIONS:

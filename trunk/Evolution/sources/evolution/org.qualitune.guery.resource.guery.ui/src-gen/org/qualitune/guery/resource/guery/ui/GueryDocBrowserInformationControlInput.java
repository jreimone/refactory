 ...
 * olInput</code>.
 */
public class GueryDocBrowserInformationControlInput {
	
	private final GueryDocBrowserInformationControlInput fPrevious;
	private GueryDocBrowserInformationControlInput fNext;
	 ...
	 */
	public GueryDocBrowserInformationControlInput(GueryDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public GueryDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public GueryDocBrowserInformationControlInput getNext() {
		return fNext;
	}

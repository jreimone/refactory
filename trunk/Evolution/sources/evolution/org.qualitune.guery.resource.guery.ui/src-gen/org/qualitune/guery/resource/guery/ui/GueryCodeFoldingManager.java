 ...
 */
public class GueryCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.qualitune.guery.resource.guery.IGueryBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.qualitune.guery.resource.guery.ui.GueryEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.qualitune.guery.resource.guery.ui.GueryEditor) {
				org.qualitune.guery.resource.guery.ui.GueryEditor editor = (org.qualitune.guery.resource.guery.ui.GueryEditor) workbenchPart;
	...
	protected org.qualitune.guery.resource.guery.ui.GueryEditor editor;
	 ...
	 */
	public GueryCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.qualitune.guery.resource.guery.ui.GueryEditor textEditor) {
	...
	private void addCloseListener(final org.qualitune.guery.resource.guery.ui.GueryEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.qualitune.guery.resource.guery.ui.GueryUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.qualitune.guery.resource.guery.IGueryTextResource textResource = (org.qualitune.guery.resource.guery.IGueryTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();

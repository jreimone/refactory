...
public class GueryBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.qualitune.guery.resource.guery.ui.GueryDocBrowserInformationControlInput fInput;
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.qualitune.guery.resource.guery.ui.GueryDocBrowserInformationControlInput);
		...
		fInput= (org.qualitune.guery.resource.guery.ui.GueryDocBrowserInformationControlInput) input;
		...
		org.qualitune.guery.resource.guery.ui.GueryHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.qualitune.guery.resource.guery.ui.GueryHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.qualitune.guery.resource.guery.ui.GueryDocBrowserInformationControlInput getInput() {
		return fInput;
	}

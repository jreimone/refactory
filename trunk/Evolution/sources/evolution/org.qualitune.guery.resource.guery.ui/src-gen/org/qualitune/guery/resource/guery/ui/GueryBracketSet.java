...
public class GueryBracketSet {
	...
	private java.util.ArrayList<org.qualitune.guery.resource.guery.IGueryBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.qualitune.guery.resource.guery.IGueryBracketPair {
	 ...
	 */
	private class ClosingListener implements org.qualitune.guery.resource.guery.ui.IGueryBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.qualitune.guery.resource.guery.IGueryBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public GueryBracketSet(org.qualitune.guery.resource.guery.ui.GueryEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.qualitune.guery.resource.guery.mopp.GueryMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.qualitune.guery.resource.guery.IGueryBracketPair>();
	 ...
	 */
	public org.qualitune.guery.resource.guery.IGueryBracketPair getBracketPair(String opening, String closing) {
		for (org.qualitune.guery.resource.guery.IGueryBracketPair bracketPair : bracketPairs) {
	...
	public org.qualitune.guery.resource.guery.IGueryBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.qualitune.guery.resource.guery.IGueryBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.qualitune.guery.resource.guery.ui.GueryPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.qualitune.guery.resource.guery.IGueryBracketPair remove(String opening, String closing) {
		for (org.qualitune.guery.resource.guery.IGueryBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.qualitune.guery.resource.guery.IGueryBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.qualitune.guery.resource.guery.ui.GueryPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.qualitune.guery.resource.guery.ui.GueryPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}

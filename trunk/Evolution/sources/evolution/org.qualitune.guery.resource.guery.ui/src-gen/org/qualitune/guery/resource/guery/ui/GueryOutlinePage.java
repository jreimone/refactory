...
public class GueryOutlinePage extends org.eclipse.ui.part.Page implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.ui.views.contentoutline.IContentOutlinePage {
	...
	public final static String CONTEXT_MENU_ID = "org.qualitune.guery.resource.guery.ui.outlinecontext";
	...
	public GueryOutlinePage(org.qualitune.guery.resource.guery.IGueryResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(org.eclipse.swt.widgets.Composite parent) {
		treeViewer = new org.qualitune.guery.resource.guery.ui.GueryOutlinePageTreeViewer(parent, org.eclipse.swt.SWT.MULTI | org.eclipse.swt.SWT.H_SCROLL | org.eclipse.swt.SWT.V_SCROLL);
		...
		treeViewer.setComparator(new org.qualitune.guery.resource.guery.ui.GueryOutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("org.qualitune.guery.resource.guery.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		java.util.List<org.eclipse.jface.action.IAction> actions = new org.qualitune.guery.resource.guery.ui.GueryOutlinePageActionProvider().getActions(treeViewer);

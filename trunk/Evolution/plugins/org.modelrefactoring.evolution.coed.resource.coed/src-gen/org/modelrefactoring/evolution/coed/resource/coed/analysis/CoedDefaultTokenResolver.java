 ...
 */
public class CoedDefaultTokenResolver implements org.modelrefactoring.evolution.coed.resource.coed.ICoedTokenResolver {
	 ...
	 */
	public CoedDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public CoedDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, EStructuralFeature feature, org.modelrefactoring.evolution.coed.resource.coed.ICoedTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.modelrefactoring.evolution.coed.resource.coed.grammar.CoedGrammarInformationProvider.INSTANCE.getKeywords()) {

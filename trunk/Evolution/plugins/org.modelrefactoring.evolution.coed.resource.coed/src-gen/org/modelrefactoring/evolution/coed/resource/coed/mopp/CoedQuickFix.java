...
public abstract class CoedQuickFix implements org.modelrefactoring.evolution.coed.resource.coed.ICoedQuickFix {
	...
	public CoedQuickFix(String displayString, String imageKey, EObject contextObject) {
		this(displayString, imageKey, Collections.singleton(contextObject), contextObject.eResource());
	}
	
	public CoedQuickFix(String displayString, String imageKey, Collection<EObject> contextObjects) {
		this(displayString, imageKey, contextObjects, contextObjects.iterator().next().eResource());
	}
	
	public CoedQuickFix(String displayString, String imageKey, Collection<EObject> contextObjects, Resource resource) {
		super();
	...
	public String apply(String currentText) {
		...
		try {
			...
			new org.modelrefactoring.evolution.coed.resource.coed.util.CoedRuntimeUtil().logError("Exception while applying quick fix", e);
		}
		return null;
	}

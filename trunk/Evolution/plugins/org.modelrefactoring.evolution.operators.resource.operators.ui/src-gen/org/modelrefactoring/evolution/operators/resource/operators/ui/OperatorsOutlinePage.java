 ...
 */
public class OperatorsOutlinePage extends Page implements ISelectionProvider, ISelectionChangedListener, IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "org.modelrefactoring.evolution.operators.resource.operators.ui.outlinecontext";
	...
	public OperatorsOutlinePage(org.modelrefactoring.evolution.operators.resource.operators.IOperatorsResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(Composite parent) {
		treeViewer = new org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsOutlinePageTreeViewer(parent, SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL);
				...
				if (viewer != null && viewer.getControl() != null && !viewer.getControl().isDisposed()) {
					viewerRefresh = new ViewerRefresh(viewer) {
						...
						protected void refresh(IViewerNotification notification) {
							if (viewer instanceof org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsOutlinePageTreeViewer) {
								org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsOutlinePageTreeViewer pageTreeViewer = (org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsOutlinePageTreeViewer) viewer;
		...
		treeViewer.setComparator(new org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsOutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("org.modelrefactoring.evolution.operators.resource.operators.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		List<IAction> actions = new org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsOutlinePageActionProvider().getActions(treeViewer);

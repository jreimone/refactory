 ...
 */
public class OperatorsIgnoredWordsFilter {
	...
	public boolean ignoreWord(String word) {
		...
		return org.modelrefactoring.evolution.operators.resource.operators.grammar.OperatorsGrammarInformationProvider.INSTANCE.getKeywords().contains(word);
	}

 ...
 * a specified depth.
 */
public class OperatorsOutlinePageTreeViewer extends TreeViewer {
	...
	public OperatorsOutlinePageTreeViewer(Composite parent, int style) {
		super(parent, style);
	...
	public void setSelection(ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsPlugin.logError("Exception while refreshing outline view", e);
		}
	}

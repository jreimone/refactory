 ...
 * plug-in.
 */
public class OperatorsUIResourceBundle {
	
	/**
	 * The title of the NewProjectWizard window.
	 */
	public static String NEW_PROJECT_WIZARD_WINDOW_TITLE = "New operators Project";
	
	/**
	 * The name of the main page for the NewProjectWizard.
	 */
	public static String NEW_PROJECT_WIZARD_PAGE_NAME = "Create new operators Project";
	 ...
	 */
	public static String NEW_FILE_WIZARD_FILE_NAME = "new_file.operators";
	
	/**
	 * The title for the NewFileWizard window.
	 */
	public static String NEW_FILE_WIZARD_WINDOW_TITLE = "New operators File";
	
	/**
	 * The title for the NewFileWizard page.
	 */
	public static String NEW_FILE_WIZARD_PAGE_TITLE = "Create new operators file";
	
	/**
	 * The description for the NewFileWizard.
	 */
	public static String NEW_FILE_WIZARD_DESCRIPTION = "This wizard creates a new file with *.operators extension.";
	
	/**
	 * The description for the root preference page.
	 */
	public static String ROOT_PREFERENCE_PAGE_DESCRIPTION = "Operators Text Editor Preferences";
	...
	static {
		try {
			ResourceBundle bundle = ResourceBundle.getBundle(OperatorsUIResourceBundle.class.getName(), Locale.getDefault());
			if (bundle != null) {
				Set<String> keys = bundle.keySet();
				for (String key : keys) {
					String value = bundle.getString(key);
					try {
						Field field = OperatorsUIResourceBundle.class.getDeclaredField(key.toUpperCase());

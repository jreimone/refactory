 ...
 */
public class OperatorsUIPlugin extends AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.modelrefactoring.evolution.operators.resource.operators.ui";
	public static final String EDITOR_ID = "org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEditor";
	...
	private static OperatorsUIPlugin plugin;
	
	public OperatorsUIPlugin() {
		super();
	}
	...
	public static OperatorsUIPlugin getDefault() {
		return plugin;
	}
	...
	protected static IStatus log(int type, String message, Throwable throwable) {
		IStatus status;
		if (throwable != null) {
			status = new Status(type, OperatorsUIPlugin.PLUGIN_ID, 0, message, throwable);
		} else {
			status = new Status(type, OperatorsUIPlugin.PLUGIN_ID, message);
		}
		final OperatorsUIPlugin pluginInstance = OperatorsUIPlugin.getDefault();

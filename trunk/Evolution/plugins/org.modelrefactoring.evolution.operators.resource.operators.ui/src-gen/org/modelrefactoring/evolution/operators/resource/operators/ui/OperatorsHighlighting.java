 ...
 */
public class OperatorsHighlighting implements ISelectionProvider, ISelectionChangedListener {
	
	private final static org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPositionHelper positionHelper = new org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPositionHelper();
	...
	private org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEditor editor;
	private ProjectionViewer projectionViewer;
	private org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsOccurrence occurrence;
	private org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements KeyListener, VerifyListener, MouseListener, org.modelrefactoring.evolution.operators.resource.operators.IOperatorsBackgroundParsingListener {
	 ...
	 */
	public OperatorsHighlighting(org.modelrefactoring.evolution.operators.resource.operators.IOperatorsTextResource textResource, ProjectionViewer projectionViewer, org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsColorManager colorManager, org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEditor editor) {
		this.display = Display.getCurrent();
		projectionViewer.getSelectionProvider();
		this.preferenceStore = org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		this.textWidget = projectionViewer.getTextWidget();
		this.projectionViewer = projectionViewer;
		this.occurrence = new org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsOccurrence(textResource, projectionViewer);
		this.bracketSet = new org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsBracketSet();
		this.colorManager = colorManager;
		this.isHighlightBrackets = preferenceStore.getBoolean(org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		this.bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		this.black = colorManager.getColor(new RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEditor editor) {
	...
	private void setBracketHighlighting(IDocument document) {
		...
		Position[] positions = positionHelper.getPositions(document, org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPositionCategory.BRACKET.toString());
	...
	private void removeHighlighting() {
		...
		removeHighlightingCategory(document, org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPositionCategory.BRACKET.toString());
	}
	...
	private void removeHighlightingCategory(IDocument document, String category) {
		...
		if (category.equals(org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPositionCategory.BRACKET.toString())) {
		...
		display.asyncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEObjectSelection(selectedEObject));
				}
			}
		});
	}
	...
	public void resetValues() {
		isHighlightBrackets = preferenceStore.getBoolean(org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		bracketColor = colorManager.getColor(PreferenceConverter.getColor(preferenceStore, org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));

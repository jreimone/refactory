 ...
 */
public class OperatorsSyntaxColoringPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public OperatorsSyntaxColoringPreferencePage() {
		super();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(Composite composite, int horizontalSpan) {
		org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPixelConverter pixelConverter = new org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEditor) {
			org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEditor emfTextEditor = (org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEditor) editor;

 ...
 */
public class OperatorsHyperlink implements IHyperlink {
	 ...
	 */
	public OperatorsHyperlink(IRegion region, EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}

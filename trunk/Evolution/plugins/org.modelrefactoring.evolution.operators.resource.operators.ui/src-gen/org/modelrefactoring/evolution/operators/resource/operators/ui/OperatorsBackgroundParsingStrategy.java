 ...
 */
public class OperatorsBackgroundParsingStrategy {
	 ...
	 */
	public void parse(DocumentEvent event, final org.modelrefactoring.evolution.operators.resource.operators.IOperatorsTextResource resource, final org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(IDocument document, final org.modelrefactoring.evolution.operators.resource.operators.IOperatorsTextResource resource, final org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.modelrefactoring.evolution.operators.resource.operators.IOperatorsTextResource resource, final org.modelrefactoring.evolution.operators.resource.operators.ui.OperatorsEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {
			...
			while (newContents != null ) {
				while (newContents != null) {
					try {
						...
						if (resource instanceof org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsResource) {
							org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsResource concreteResource = (org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsResource) resource;

 ...
 */
public class CoedCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.modelrefactoring.evolution.coed.resource.coed.ICoedBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements IPartListener2 {
		...
		public EditorOnCloseListener(org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor) {
				org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor editor = (org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor) workbenchPart;
	...
	protected org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor editor;
	 ...
	 */
	public CoedCodeFoldingManager(ProjectionViewer sourceViewer,org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor textEditor) {
	...
	private void addCloseListener(final org.modelrefactoring.evolution.coed.resource.coed.ui.CoedEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.modelrefactoring.evolution.coed.resource.coed.ui.CoedUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.modelrefactoring.evolution.coed.resource.coed.mopp.CoedResource textResource = (org.modelrefactoring.evolution.coed.resource.coed.mopp.CoedResource) editor.getResource();
		IDocument document = sourceViewer.getDocument();

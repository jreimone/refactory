 ...
 */
public class CoedHyperlink implements IHyperlink {
	 ...
	 */
	public CoedHyperlink(IRegion region, EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.modelrefactoring.evolution.coed.resource.coed.mopp.CoedPlugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}

...
public class OperatorsCopiedEObjectInternalEList extends org.modelrefactoring.evolution.operators.resource.operators.util.OperatorsCopiedEList<EObject> implements InternalEList<EObject> {
	
	private InternalEList<EObject> original;
	private InternalEList<EObject> copy;
	
	public OperatorsCopiedEObjectInternalEList(InternalEList<EObject> original) {
		super(original);

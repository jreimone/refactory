 ...
 */
public class OperatorsEObjectUtil {
	...
	public static Object invokeOperation(EObject element, EOperation o) {
		...
		try {
			...
			new org.modelrefactoring.evolution.operators.resource.operators.util.OperatorsRuntimeUtil().logError("Exception while matching proxy URI.", e);

 ...
 * to 4 bytes).
 */
public class OperatorsUnicodeConverter extends org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsInputStreamProcessor {
	 ...
	 */
	public OperatorsUnicodeConverter(InputStream inputStream) {

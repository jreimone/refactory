 ...
 */
public class OperatorsLayoutUtil {
	...
	public void transferLayoutInformationToModel(EObject element) {
		...
		for (Iterator<org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsLayoutInformation> i = layoutInformationAdapter.getLayoutInformations().iterator(); i.hasNext(); ) {
			org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsLayoutInformation layoutInformation = i.next();
	...
	public void transferLayoutInformationFromModel(EObject element) {
		...
		if (layoutReference != null) {
			...
			for (Iterator<EObject> i = list.iterator(); i.hasNext(); ) {
				...
				org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsLayoutInformation layoutInformation = createLayoutInformation(layoutModelElement);
	...
	public EObject createLayoutInformationModelElement(org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsLayoutInformation layoutInformation, EPackage layoutPackage) {
		EFactory factory = layoutPackage.getEFactoryInstance();
		Object object = layoutInformation.getObject(null, false);
		org.modelrefactoring.evolution.operators.resource.operators.grammar.OperatorsSyntaxElement syntaxElement = layoutInformation.getSyntaxElement();
		...
		layoutInformationModelElement.eSet(layoutInformationEClass.getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME), org.modelrefactoring.evolution.operators.resource.operators.grammar.OperatorsGrammarInformationProvider.getSyntaxElementID(syntaxElement));
		return layoutInformationModelElement;
	}
	
	public org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsLayoutInformation createLayoutInformation(EObject layoutInformationModelElement) {
		Object object = null;
		...
		org.modelrefactoring.evolution.operators.resource.operators.grammar.OperatorsSyntaxElement syntaxElement = org.modelrefactoring.evolution.operators.resource.operators.grammar.OperatorsGrammarInformationProvider.getSyntaxElementByID((String) layoutInformationModelElement.eGet(layoutInformationModelElement.eClass().getEStructuralFeature(SYNTAX_ELEMENT_ID_EATTRIBUTE_NAME)));
		if (objectFeature != null) {
			object = layoutInformationModelElement.eGet(objectFeature);
		} else if (syntaxElement instanceof org.modelrefactoring.evolution.operators.resource.operators.grammar.OperatorsPlaceholder) {
			org.modelrefactoring.evolution.operators.resource.operators.grammar.OperatorsPlaceholder placeholder = (org.modelrefactoring.evolution.operators.resource.operators.grammar.OperatorsPlaceholder) syntaxElement;
			org.modelrefactoring.evolution.operators.resource.operators.IOperatorsTokenResolver tokenResolver = new org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsTokenResolverFactory().createTokenResolver(placeholder.getTokenName());
			org.modelrefactoring.evolution.operators.resource.operators.IOperatorsTokenResolveResult result = new org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsTokenResolveResult();
			tokenResolver.resolve(visibleTokenText, placeholder.getFeature(), result);
			object = result.getResolvedToken();
		}
		return new org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsLayoutInformation(syntaxElement, object, startOffset, hiddenTokenText, visibleTokenText);
	}
	
	public org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsLayoutInformationAdapter getLayoutInformationAdapter(EObject element) {
	...
	public void removeLayoutInformationAdapter(EObject element) {
		org.modelrefactoring.evolution.operators.resource.operators.mopp.OperatorsLayoutInformationAdapter existingAdapter = getLayoutInformationAdapter(element);

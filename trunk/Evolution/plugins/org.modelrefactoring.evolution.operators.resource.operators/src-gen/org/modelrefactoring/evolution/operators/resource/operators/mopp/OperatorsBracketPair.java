 ...
 */
public class OperatorsBracketPair implements org.modelrefactoring.evolution.operators.resource.operators.IOperatorsBracketPair {
	...
	public OperatorsBracketPair(String openingBracket, String closingBracket, boolean closingEnabledInside, boolean closeAfterEnter) {
		super();
		this.openingBracket = openingBracket;
		this.closingBracket = closingBracket;
		this.closingEnabledInside = closingEnabledInside;

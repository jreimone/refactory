 ...
 */
public class XwpfOutlinePage extends org.eclipse.ui.part.Page implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener, org.eclipse.ui.views.contentoutline.IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "dk.itu.sdg.language.xwpf.resource.xwpf.ui.outlinecontext";
	...
	public XwpfOutlinePage(dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(org.eclipse.swt.widgets.Composite parent) {
		treeViewer = new dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfOutlinePageTreeViewer(parent, org.eclipse.swt.SWT.MULTI | org.eclipse.swt.SWT.H_SCROLL | org.eclipse.swt.SWT.V_SCROLL);
		...
		treeViewer.setComparator(new dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfOutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("dk.itu.sdg.language.xwpf.resource.xwpf.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		java.util.List<org.eclipse.jface.action.IAction> actions = new dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfOutlinePageActionProvider().getActions(treeViewer);

...
public class XwpfPropertyTester extends org.eclipse.core.expressions.PropertyTester {
	...
	private boolean hasMatchingURI(org.eclipse.core.resources.IResource resource) {
		...
		return path.endsWith("." + new dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfMetaInformation().getSyntaxName());
	}

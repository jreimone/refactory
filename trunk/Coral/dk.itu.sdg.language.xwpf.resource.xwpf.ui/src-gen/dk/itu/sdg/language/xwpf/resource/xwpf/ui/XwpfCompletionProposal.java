 ...
 */
public class XwpfCompletionProposal implements java.lang.Comparable<XwpfCompletionProposal> {
	 ...
	 */
	private dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfExpectedTerminal expectedTerminal;
	...
	public XwpfCompletionProposal(dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container) {
		super();
	...
	public XwpfCompletionProposal(dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, org.eclipse.emf.ecore.EStructuralFeature structuralFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.swt.graphics.Image image) {
	...
	public dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof XwpfCompletionProposal) {
			XwpfCompletionProposal other = (XwpfCompletionProposal) object;
	...
	public int compareTo(XwpfCompletionProposal object) {
		if (object instanceof XwpfCompletionProposal) {
			XwpfCompletionProposal other = (XwpfCompletionProposal) object;

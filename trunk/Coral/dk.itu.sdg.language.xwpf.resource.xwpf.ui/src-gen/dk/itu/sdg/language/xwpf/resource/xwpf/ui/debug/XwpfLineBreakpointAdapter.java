...
public class XwpfLineBreakpointAdapter implements org.eclipse.debug.ui.actions.IToggleBreakpointsTarget {
	...
	public void toggleLineBreakpoints(org.eclipse.ui.IWorkbenchPart part, org.eclipse.jface.viewers.ISelection selection) throws org.eclipse.core.runtime.CoreException {
		...
		if (textEditor != null) {
			...
			org.eclipse.debug.core.model.IBreakpoint[] breakpoints = org.eclipse.debug.core.DebugPlugin.getDefault().getBreakpointManager().getBreakpoints(dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfPlugin.DEBUG_MODEL_ID);
			...
			dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfLineBreakpoint lineBreakpoint = new dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfLineBreakpoint(resource, lineNumber + 1);

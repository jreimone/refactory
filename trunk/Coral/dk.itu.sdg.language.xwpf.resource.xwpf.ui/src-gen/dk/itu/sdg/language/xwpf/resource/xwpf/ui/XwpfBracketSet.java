...
public class XwpfBracketSet {
	...
	private java.util.ArrayList<dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfBracketPair {
	 ...
	 */
	private class ClosingListener implements dk.itu.sdg.language.xwpf.resource.xwpf.ui.IXwpfBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public XwpfBracketSet(dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfBracketPair>();
	 ...
	 */
	public dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfBracketPair getBracketPair(String opening, String closing) {
		for (dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfBracketPair bracketPair : bracketPairs) {
	...
	public dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfBracketPair remove(String opening, String closing) {
		for (dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}

 ...
 */
public class XwpfCodeFoldingManager {
	
	private class FoldingUpdateListener implements dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfEditor) {
				dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfEditor editor = (dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfEditor) workbenchPart;
	...
	protected dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfEditor editor;
	 ...
	 */
	public XwpfCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfEditor textEditor) {
	...
	private void addCloseListener(final dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfTextResource textResource = (dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();

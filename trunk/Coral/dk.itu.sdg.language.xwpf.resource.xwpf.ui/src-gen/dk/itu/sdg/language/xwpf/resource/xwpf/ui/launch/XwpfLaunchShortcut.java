 ...
 */
public class XwpfLaunchShortcut implements org.eclipse.debug.ui.ILaunchShortcut2 {
	...
	private void launch(org.eclipse.core.resources.IFile file, String mode) {
		try {
			...
			org.eclipse.debug.core.ILaunchConfigurationType type = lm.getLaunchConfigurationType(new dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfMetaInformation().getLaunchConfigurationType());
			...
			workingCopy.setAttribute(dk.itu.sdg.language.xwpf.resource.xwpf.launch.XwpfLaunchConfigurationDelegate.ATTR_RESOURCE_URI, uri.toString());
			...
			dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfPlugin.logError("Exception while launching selection", e);
		}
	}

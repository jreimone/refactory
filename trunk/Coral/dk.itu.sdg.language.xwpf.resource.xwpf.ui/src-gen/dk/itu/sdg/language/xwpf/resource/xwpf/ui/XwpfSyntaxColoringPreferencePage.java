 ...
 */
public class XwpfSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public XwpfSyntaxColoringPreferencePage() {
		super();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfPixelConverter pixelConverter = new dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfPixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfEditor) {
			dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfEditor emfTextEditor = (dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfEditor) editor;

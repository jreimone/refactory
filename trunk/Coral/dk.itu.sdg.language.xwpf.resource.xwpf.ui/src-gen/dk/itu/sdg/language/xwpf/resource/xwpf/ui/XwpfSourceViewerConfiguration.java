 ...
 */
public class XwpfSourceViewerConfiguration extends org.eclipse.ui.editors.text.TextSourceViewerConfiguration {
	...
	private dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfQuickAssistAssistant quickAssistAssistant;
	 ...
	 */
	public XwpfSourceViewerConfiguration(dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfResourceProvider resourceProvider, dk.itu.sdg.language.xwpf.resource.xwpf.ui.IXwpfAnnotationModelProvider annotationModelProvider, dk.itu.sdg.language.xwpf.resource.xwpf.ui.IXwpfBracketHandlerProvider bracketHandlerProvider, dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfColorManager colorManager) {
		super(dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfUIPlugin.getDefault().getPreferenceStore());
	...
	public org.eclipse.jface.text.contentassist.IContentAssistant getContentAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		assistant.setContentAssistProcessor(new dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfCompletionProcessor(resourceProvider, bracketHandlerProvider), org.eclipse.jface.text.IDocument.DEFAULT_CONTENT_TYPE);
	...
	protected org.eclipse.jface.text.rules.ITokenScanner getScanner() {
		return new dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfTokenScanner(resourceProvider.getResource(), colorManager);
	}
	...
	public org.eclipse.jface.text.ITextHover getTextHover(org.eclipse.jface.text.source.ISourceViewer sourceViewer, String contentType) {
		return new dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfTextHover(resourceProvider);
	}
	...
	public org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] getHyperlinkDetectors(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		...
		return new org.eclipse.jface.text.hyperlink.IHyperlinkDetector[] { new dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfHyperlinkDetector(resourceProvider.getResource()) };
	}
	...
	public org.eclipse.jface.text.quickassist.IQuickAssistAssistant getQuickAssistAssistant(org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		if (quickAssistAssistant == null) {
			quickAssistAssistant = new dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfQuickAssistAssistant(resourceProvider, annotationModelProvider);
		}
			...
			protected org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector createSpellingProblemCollector() {
				...
				return new org.eclipse.ui.texteditor.spelling.ISpellingProblemCollector() {
					...
					public void accept(org.eclipse.ui.texteditor.spelling.SpellingProblem problem) {
						...
						if (new dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfIgnoredWordsFilter().ignoreWord(text)) {
							return;
						}

					...
					if(fstCommon.fst.equals(sndCommon.fst)) {
						...
						def sndAttr = sndCandidateElement.eClass().getEAllAttributes().find {attr ->
							...
							if (!(sndCandidate instanceof Collection) && (sndCandidate != null)) {
								...
								//TODO:!!!	DIE BOOLEAN ATTRIBUTE MüSSEN ALLE WEG!!!
						...
						//TODO: Check was hier verloren geht und warum einige Attribute keine Namen haben. Sind das Referenzen die man auflösen muß?

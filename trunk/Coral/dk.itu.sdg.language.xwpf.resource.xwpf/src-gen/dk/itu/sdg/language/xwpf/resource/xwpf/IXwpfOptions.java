 ...
 */
public interface IXwpfOptions {
	
	/**
	 * The key for the option to provide a stream pre-processor.
	 */
	public String INPUT_STREAM_PREPROCESSOR_PROVIDER = new dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfMetaInformation().getInputStreamPreprocessorProviderOptionKey();
	
	/**
	 * The key for the option to provide a resource post-processor.
	 */
	public String RESOURCE_POSTPROCESSOR_PROVIDER = new dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfMetaInformation().getResourcePostProcessorProviderOptionKey();

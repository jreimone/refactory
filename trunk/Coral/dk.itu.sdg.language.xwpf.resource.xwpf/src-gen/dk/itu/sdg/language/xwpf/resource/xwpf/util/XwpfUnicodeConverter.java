 ...
 * to 4 bytes).
 */
public class XwpfUnicodeConverter extends dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfInputStreamProcessor {
	 ...
	 */
	public XwpfUnicodeConverter(java.io.InputStream inputStream) {

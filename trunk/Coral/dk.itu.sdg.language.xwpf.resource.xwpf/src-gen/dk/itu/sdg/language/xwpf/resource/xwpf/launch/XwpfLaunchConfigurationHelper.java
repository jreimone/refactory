 ...
 * delegates.
 */
public class XwpfLaunchConfigurationHelper {
	
	public static class SystemOutInterpreter extends dk.itu.sdg.language.xwpf.resource.xwpf.util.AbstractXwpfInterpreter<Void,Void> {
	...
	public <ResultType, ContextType> void launchInterpreter(org.eclipse.debug.core.ILaunchConfiguration configuration, String mode, org.eclipse.debug.core.ILaunch launch, org.eclipse.core.runtime.IProgressMonitor monitor, dk.itu.sdg.language.xwpf.resource.xwpf.util.AbstractXwpfInterpreter<ResultType, ContextType> delegate, final ContextType context) throws org.eclipse.core.runtime.CoreException {
		...
		final dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfDebuggableInterpreter<ResultType, ContextType> interpreter = new dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfDebuggableInterpreter<ResultType, ContextType>(delegate, eventPort);
		...
		// running process
		dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfDebuggerListener<ResultType, ContextType> debugListener = new dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfDebuggerListener<ResultType, ContextType>(requestPort);
		debugListener.setDebuggable(interpreter);
		new Thread(debugListener).start();
		
		// step 4: start debugger
		dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfDebugProcess process = new dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfDebugProcess(launch);
		launch.addDebugTarget(new dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfDebugTarget(process, launch, requestPort, eventPort));
	}
	...
	public org.eclipse.emf.common.util.URI getURI(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return org.eclipse.emf.common.util.URI.createURI(configuration.getAttribute(dk.itu.sdg.language.xwpf.resource.xwpf.launch.XwpfLaunchConfigurationDelegate.ATTR_RESOURCE_URI, (String) null));
	}
	...
	public org.eclipse.emf.ecore.EObject getModelRoot(org.eclipse.debug.core.ILaunchConfiguration configuration) throws org.eclipse.core.runtime.CoreException {
		return dk.itu.sdg.language.xwpf.resource.xwpf.util.XwpfResourceUtil.getResourceContent(getURI(configuration));
	}
	...
	protected void abort(String message, Throwable e) throws org.eclipse.core.runtime.CoreException {
		throw new org.eclipse.core.runtime.CoreException(new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfPlugin.DEBUG_MODEL_ID, 0, message, e));
	}
}

 ...
 * code).
 */
public class XwpfDebuggerListener<ResultType, ContextType> implements Runnable {
	...
	private dk.itu.sdg.language.xwpf.resource.xwpf.debug.AbstractXwpfDebuggable debuggable;
	/**
	 ...
	 */
	private java.util.Map<Long, dk.itu.sdg.language.xwpf.resource.xwpf.util.XwpfPair<String, Object>> objectMap = new java.util.LinkedHashMap<Long, dk.itu.sdg.language.xwpf.resource.xwpf.util.XwpfPair<String, Object>>();
	...
	public XwpfDebuggerListener(int requestPort) {
		super();
	...
	private void runDebugger() throws java.io.IOException {
		...
		dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfDebugMessage command;
		while (!stop) {
			command = communicationHelper.receive(reader);
			if (command == null) {
				break;
			}
			if (command.hasType(dk.itu.sdg.language.xwpf.resource.xwpf.debug.EXwpfDebugMessageTypes.EXIT)) {
				debuggable.terminate();
				stop = true;
			} else if (command.hasType(dk.itu.sdg.language.xwpf.resource.xwpf.debug.EXwpfDebugMessageTypes.RESUME)) {
				debuggable.resume();
			} else if (command.hasType(dk.itu.sdg.language.xwpf.resource.xwpf.debug.EXwpfDebugMessageTypes.STEP_OVER)) {
				debuggable.stepOver();
			} else if (command.hasType(dk.itu.sdg.language.xwpf.resource.xwpf.debug.EXwpfDebugMessageTypes.STEP_INTO)) {
				debuggable.stepInto();
			} else if (command.hasType(dk.itu.sdg.language.xwpf.resource.xwpf.debug.EXwpfDebugMessageTypes.STEP_RETURN)) {
				debuggable.stepReturn();
			} else if (command.hasType(dk.itu.sdg.language.xwpf.resource.xwpf.debug.EXwpfDebugMessageTypes.ADD_LINE_BREAKPOINT)) {
			...
			} else if (command.hasType(dk.itu.sdg.language.xwpf.resource.xwpf.debug.EXwpfDebugMessageTypes.REMOVE_LINE_BREAKPOINT)) {
				String location = command.getArgument(0);
				int line = Integer.parseInt(command.getArgument(1));
				debuggable.removeLineBreakpoint(location, line);
			} else if (command.hasType(dk.itu.sdg.language.xwpf.resource.xwpf.debug.EXwpfDebugMessageTypes.GET_STACK)) {
				final String[] stack = debuggable.getStack();
				String controlStack = dk.itu.sdg.language.xwpf.resource.xwpf.util.XwpfStringUtil.encode('#', stack);
				dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfDebugMessage message = new dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfDebugMessage(dk.itu.sdg.language.xwpf.resource.xwpf.debug.EXwpfDebugMessageTypes.GET_STACK_RESPONSE, new String[] {controlStack});
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(dk.itu.sdg.language.xwpf.resource.xwpf.debug.EXwpfDebugMessageTypes.GET_FRAME_VARIABLES)) {
				...
				dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfDebugMessage message = new dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfDebugMessage(dk.itu.sdg.language.xwpf.resource.xwpf.debug.EXwpfDebugMessageTypes.GET_FRAME_VARIABLES_RESPONSE, topVariableIDs);
				communicationHelper.sendEvent(message, output);
			} else if (command.hasType(dk.itu.sdg.language.xwpf.resource.xwpf.debug.EXwpfDebugMessageTypes.GET_VARIABLES)) {
				...
				dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfDebugMessage message = new dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfDebugMessage(dk.itu.sdg.language.xwpf.resource.xwpf.debug.EXwpfDebugMessageTypes.GET_VARIABLES_RESPONSE, varStrings);
				communicationHelper.sendEvent(message, output);
			} else {
	...
	private String convertToString(long id, Object object) {
		...
		return dk.itu.sdg.language.xwpf.resource.xwpf.util.XwpfStringUtil.convertToString(properties);
	}
	...
	private long getObjectID(String name, Object value) {
		dk.itu.sdg.language.xwpf.resource.xwpf.util.XwpfPair<String, Object> pair = new dk.itu.sdg.language.xwpf.resource.xwpf.util.XwpfPair<String, Object>(name, value);
	...
	public dk.itu.sdg.language.xwpf.resource.xwpf.debug.AbstractXwpfDebuggable getDebuggable() {
		return debuggable;
	}
	
	public void setDebuggable(dk.itu.sdg.language.xwpf.resource.xwpf.debug.AbstractXwpfDebuggable debuggable) {

 ...
 * @generated
 */
public class XwpfSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case XwpfPackage.FOOTNOTE: {
				Footnote footnote = (Footnote)theEObject;
				T result = caseFootnote(footnote);
				if (result == null) result = caseContent(footnote);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XwpfPackage.FOOTER: {
				Footer footer = (Footer)theEObject;
				T result = caseFooter(footer);
				if (result == null) result = caseContent(footer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XwpfPackage.HEADER: {
			...
			case XwpfPackage.HYPERLINK: {
				Hyperlink hyperlink = (Hyperlink)theEObject;
				T result = caseHyperlink(hyperlink);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XwpfPackage.NUMBERING: {
				Numbering numbering = (Numbering)theEObject;
				T result = caseNumbering(numbering);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XwpfPackage.PICTURE_DATA: {
				PictureData pictureData = (PictureData)theEObject;
				T result = casePictureData(pictureData);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XwpfPackage.PARAGRAPH: {
			...
			case XwpfPackage.TABLE: {
				Table table = (Table)theEObject;
				T result = caseTable(table);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XwpfPackage.RUN: {
				Run run = (Run)theEObject;
				T result = caseRun(run);
				if (result == null) result = caseContent(run);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XwpfPackage.PART: {
				Part part = (Part)theEObject;
				T result = casePart(part);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XwpfPackage.BODY: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Numbering</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Numbering</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseNumbering(Numbering object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Picture Data</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Picture Data</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePictureData(PictureData object) {
		return null;
	}

...
public interface PatternLanguagePackage extends EPackage
{
  ...
  /**
   * The meta object id for the '{@link org.eclipse.incquery.patternlanguage.patternLanguage.impl.FunctionEvaluationValueImpl <em>Function Evaluation Value</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see org.eclipse.incquery.patternlanguage.patternLanguage.impl.FunctionEvaluationValueImpl
   * @see org.eclipse.incquery.patternlanguage.patternLanguage.impl.PatternLanguagePackageImpl#getFunctionEvaluationValue()
   * @generated
   */
  int FUNCTION_EVALUATION_VALUE = 32;
   ...
   * @ordered
   */
  int FUNCTION_EVALUATION_VALUE_FEATURE_COUNT = COMPUTATION_VALUE_FEATURE_COUNT + 1;
  ...
  /**
   * Returns the meta object for class '{@link org.eclipse.incquery.patternlanguage.patternLanguage.FunctionEvaluationValue <em>Function Evaluation Value</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Function Evaluation Value</em>'.
   * @see org.eclipse.incquery.patternlanguage.patternLanguage.FunctionEvaluationValue
   * @generated
   */
  EClass getFunctionEvaluationValue();

  /**
   * Returns the meta object for the containment reference '{@link org.eclipse.incquery.patternlanguage.patternLanguage.FunctionEvaluationValue#getExpression <em>Expression</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Expression</em>'.
   * @see org.eclipse.incquery.patternlanguage.patternLanguage.FunctionEvaluationValue#getExpression()
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '{@link org.eclipse.incquery.patternlanguage.patternLanguage.impl.FunctionEvaluationValueImpl <em>Function Evaluation Value</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see org.eclipse.incquery.patternlanguage.patternLanguage.impl.FunctionEvaluationValueImpl
     * @see org.eclipse.incquery.patternlanguage.patternLanguage.impl.PatternLanguagePackageImpl#getFunctionEvaluationValue()

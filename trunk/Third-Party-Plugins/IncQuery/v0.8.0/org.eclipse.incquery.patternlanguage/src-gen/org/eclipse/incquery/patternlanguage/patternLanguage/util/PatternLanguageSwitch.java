...
public class PatternLanguageSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        FunctionEvaluationValue functionEvaluationValue = (FunctionEvaluationValue)theEObject;
        T result = caseFunctionEvaluationValue(functionEvaluationValue);
        if (result == null) result = caseComputationValue(functionEvaluationValue);
        if (result == null) result = caseValueReference(functionEvaluationValue);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Function Evaluation Value</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Function Evaluation Value</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */

...
public class EMFPatternLanguageSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      case EMFPatternLanguagePackage.IMPORT_DECLARATION:
      {
      ...
      case EMFPatternLanguagePackage.PACKAGE_IMPORT:
      {
        ...
        if (result == null) result = caseImportDeclaration(packageImport);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case EMFPatternLanguagePackage.JAVA_IMPORT:
      {
        ...
        if (result == null) result = caseImportDeclaration(javaImport);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }

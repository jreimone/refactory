...
(
		{ 
	        newCompositeNode(grammarAccess.getEMFPatternModelAccess().getImportPackagesXImportSectionParserRuleCall_2_0()); 
	    }
		lv_importPackages_4_0=ruleXImportSection		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getEMFPatternModelRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getXImportSectionAccess().getPackageImportPackageImportParserRuleCall_1_0()); 
	    }
		lv_packageImport_1_0=rulePackageImport		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getXImportSectionAccess().getImportDeclarationsXImportDeclarationParserRuleCall_2_0()); 
	    }
		lv_importDeclarations_2_0=ruleXImportDeclaration		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getXImportSectionRule());
	        }
       		add(
...
(	otherlv_0='uses' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getXImportDeclarationAccess().getUsesKeyword_0());
    }
(((
(

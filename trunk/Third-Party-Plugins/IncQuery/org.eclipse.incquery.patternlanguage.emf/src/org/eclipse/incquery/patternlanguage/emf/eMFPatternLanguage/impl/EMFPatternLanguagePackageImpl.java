...
public class EMFPatternLanguagePackageImpl extends EPackageImpl implements EMFPatternLanguagePackage
{
  ...
  public void createPackageContents()
  {
    ...
    createEReference(xImportSectionEClass, XIMPORT_SECTION__PACKAGE_IMPORT);
  ...
  public void initializePackageContents()
  {
    ...
    xImportSectionEClass.getESuperTypes().add(theXtypePackage.getXImportSection());
    ...
    initEReference(getXImportSection_PackageImport(), this.getPackageImport(), null, "packageImport", null, 0, -1, XImportSection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getPatternModel_ImportPackages(), this.getXImportSection(), null, "importPackages", null, 0, 1, PatternModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

...
public class EMFPatternLanguageFactoryImpl extends EFactoryImpl implements EMFPatternLanguageFactory
{
  ...
  public static EMFPatternLanguageFactory init()
  {
    try
    {
      EMFPatternLanguageFactory theEMFPatternLanguageFactory = (EMFPatternLanguageFactory)EPackage.Registry.INSTANCE.getEFactory(EMFPatternLanguagePackage.eNS_URI);
  ...
  public EObject create(EClass eClass)
  {
    ...
    {
      case EMFPatternLanguagePackage.XIMPORT_SECTION: return createXImportSection();

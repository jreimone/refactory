...
public abstract class AbstractPatternLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected PatternLanguageGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (PatternLanguageGrammarAccess) access;
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if(match_Pattern_EqualsSignKeyword_7_q.equals(syntax))

...
public class CalculationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CalculationPackage.CALCULATION_MODEL: {
				CalculationModel calculationModel = (CalculationModel)theEObject;
				T result = caseCalculationModel(calculationModel);
			...
			case CalculationPackage.CALCULATION_RESULT: {
				CalculationResult calculationResult = (CalculationResult)theEObject;
				T result = caseCalculationResult(calculationResult);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CalculationPackage.STRUCTURE: {
				Structure structure = (Structure)theEObject;
				T result = caseStructure(structure);
				if (result == null) result = caseCalculation(structure);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CalculationPackage.METRIC: {
				Metric metric = (Metric)theEObject;
				T result = caseMetric(metric);
				if (result == null) result = caseCalculation(metric);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseCalculationModel(CalculationModel object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseCalculationResult(CalculationResult object) {
		return null;
	}

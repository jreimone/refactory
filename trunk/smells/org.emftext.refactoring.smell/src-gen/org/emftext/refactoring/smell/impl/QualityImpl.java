 ...
 * @generated
 */
public class QualityImpl extends EObjectImpl implements Quality {
	/**
	...
	/**
	 * The cached value of the '{@link #getCalculations() <em>Calculations</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getCalculations()
	 * @generated
	...
	protected EClass eStaticClass() {
		return SmellPackage.Literals.QUALITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SmellPackage.QUALITY__NAME, oldName, name));
	}
	 ...
	 * @generated
	 */
	public EList<QualityCalculation> getCalculations() {
		if (calculations == null) {
			calculations = new EObjectWithInverseResolvingEList<QualityCalculation>(QualityCalculation.class, this, SmellPackage.QUALITY__CALCULATIONS, SmellPackage.QUALITY_CALCULATION__QUALITY);
		}
		return calculations;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SmellPackage.QUALITY__CALCULATIONS:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getCalculations()).basicAdd(otherEnd, msgs);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SmellPackage.QUALITY__NAME:
				return getName();
			case SmellPackage.QUALITY__CALCULATIONS:

 ...
 * <ul>
 *   <li>{@link org.emftext.refactoring.smell.core.impl.MappingImpl#getFactor <em>Factor</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MappingImpl extends EObjectImpl implements Mapping {
	...
	protected EClass eStaticClass() {
		return Smell_modelPackage.Literals.MAPPING;
	}
	...
	public void setFactor(Float newFactor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Smell_modelPackage.MAPPING__FACTOR, oldFactor, factor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Smell_modelPackage.MAPPING__FACTOR:
				return getFactor();
		}

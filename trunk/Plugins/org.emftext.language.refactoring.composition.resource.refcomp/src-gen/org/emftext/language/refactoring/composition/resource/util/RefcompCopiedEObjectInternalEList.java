...
public class RefcompCopiedEObjectInternalEList extends org.emftext.language.refactoring.composition.resource.util.RefcompCopiedEList<EObject> implements InternalEList<EObject> {
	
	private InternalEList<EObject> original;
	private InternalEList<EObject> copy;
	
	public RefcompCopiedEObjectInternalEList(InternalEList<EObject> original) {
		super(original);

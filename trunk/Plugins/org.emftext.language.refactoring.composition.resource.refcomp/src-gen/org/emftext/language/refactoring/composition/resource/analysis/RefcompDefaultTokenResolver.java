 ...
 * </p>
 */
public class RefcompDefaultTokenResolver implements org.emftext.language.refactoring.composition.resource.IRefcompTokenResolver {
	 ...
	 */
	public RefcompDefaultTokenResolver() {
		this(false);
	}
	 ...
	 */
	public RefcompDefaultTokenResolver(boolean escapeKeywords) {
		super();
	...
	public void resolve(String lexem, EStructuralFeature feature, org.emftext.language.refactoring.composition.resource.IRefcompTokenResolveResult result, String suffix, String prefix, String escapeCharacter) {
		// Step 1: unescape keywords if required
		if (escapeKeywords && lexem.startsWith("_")) {
			for (String keyword : org.emftext.language.refactoring.composition.resource.grammar.RefcompGrammarInformationProvider.INSTANCE.getKeywords()) {

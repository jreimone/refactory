...
public class RefcompANTLRTextToken extends org.emftext.language.refactoring.composition.resource.mopp.RefcompTextToken {
	
	private final static org.emftext.language.refactoring.composition.resource.IRefcompMetaInformation metaInformation = new org.emftext.language.refactoring.composition.resource.mopp.RefcompMetaInformation();
	
	public RefcompANTLRTextToken(Token antlrToken) {

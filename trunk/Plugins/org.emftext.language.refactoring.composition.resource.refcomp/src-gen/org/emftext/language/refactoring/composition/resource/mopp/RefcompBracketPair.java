 ...
 */
public class RefcompBracketPair implements org.emftext.language.refactoring.composition.resource.IRefcompBracketPair {
	...
	public RefcompBracketPair(String openingBracket, String closingBracket, boolean closingEnabledInside, boolean closeAfterEnter) {
		super();
		this.openingBracket = openingBracket;
		this.closingBracket = closingBracket;
		this.closingEnabledInside = closingEnabledInside;

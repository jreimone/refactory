 ...
 */
public class RefcompRuntimeUtil {
	...
	public void logError(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.emftext.language.refactoring.composition.resource.mopp.RefcompPlugin.logError(message, exception);
			return;
		}
	...
	public void logWarning(String message, Throwable exception) {
		if (isEclipsePlatformAvailable()) {
			org.emftext.language.refactoring.composition.resource.mopp.RefcompPlugin.logWarning(message, exception);
			return;
		}
		System.err.println(message);
		if (exception != null) {

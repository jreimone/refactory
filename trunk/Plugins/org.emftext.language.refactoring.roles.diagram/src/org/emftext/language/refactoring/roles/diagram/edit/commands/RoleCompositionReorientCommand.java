 ...
 * @generated
 */
public class RoleCompositionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RoleCompositionReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof RoleComposition) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return RolesBaseItemSemanticEditPolicy.getLinkConstraints().canExistRoleComposition_4004(container, getLink(), getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		RoleModel container = (RoleModel) getLink().eContainer();
		return RolesBaseItemSemanticEditPolicy.getLinkConstraints().canExistRoleComposition_4004(container, getLink(), source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected RoleComposition getLink() {
		return (RoleComposition) getElementToEdit();
	}

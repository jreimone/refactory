...
/**
 * The RefcompAutoEditStrategy extends the default auto edit strategy such that an
 ...
 */
public class RefcompAutoEditStrategy extends DefaultIndentLineAutoEditStrategy {
	
	private org.emftext.language.refactoring.composition.resource.ui.RefcompBracketSet bracketSet;
	
	public RefcompAutoEditStrategy() {
		super();
		...
		if (plugin != null) {
			...
			bracketSet = new org.emftext.language.refactoring.composition.resource.ui.RefcompBracketSet();
	 ...
	 */
	@Deprecated
	public void setBracketSet(org.emftext.language.refactoring.composition.resource.ui.RefcompBracketSet bracketSet) {

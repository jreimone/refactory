 ...
 */
public class RefcompCompletionProposal implements Comparable<RefcompCompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private org.emftext.language.refactoring.composition.resource.mopp.RefcompExpectedTerminal expectedTerminal;
	...
	public RefcompCompletionProposal(org.emftext.language.refactoring.composition.resource.mopp.RefcompExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public RefcompCompletionProposal(org.emftext.language.refactoring.composition.resource.mopp.RefcompExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public RefcompCompletionProposal(org.emftext.language.refactoring.composition.resource.mopp.RefcompExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public org.emftext.language.refactoring.composition.resource.mopp.RefcompExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof RefcompCompletionProposal) {
			RefcompCompletionProposal other = (RefcompCompletionProposal) object;
	...
	public int compareTo(RefcompCompletionProposal object) {
		if (object instanceof RefcompCompletionProposal) {
			RefcompCompletionProposal other = (RefcompCompletionProposal) object;

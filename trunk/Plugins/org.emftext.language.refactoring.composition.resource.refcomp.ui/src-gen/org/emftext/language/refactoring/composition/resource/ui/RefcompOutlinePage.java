 ...
 */
public class RefcompOutlinePage extends Page implements ISelectionProvider, ISelectionChangedListener, IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "org.emftext.language.refactoring.composition.resource.refcomp.ui.outlinecontext";
	...
	public RefcompOutlinePage(org.emftext.language.refactoring.composition.resource.IRefcompResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(Composite parent) {
		treeViewer = new org.emftext.language.refactoring.composition.resource.ui.RefcompOutlinePageTreeViewer(parent, SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL);
				...
				if (viewer != null && viewer.getControl() != null && !viewer.getControl().isDisposed()) {
					viewerRefresh = new ViewerRefresh(viewer) {
						...
						protected void refresh(IViewerNotification notification) {
							if (viewer instanceof org.emftext.language.refactoring.composition.resource.ui.RefcompOutlinePageTreeViewer) {
								org.emftext.language.refactoring.composition.resource.ui.RefcompOutlinePageTreeViewer pageTreeViewer = (org.emftext.language.refactoring.composition.resource.ui.RefcompOutlinePageTreeViewer) viewer;
		...
		treeViewer.setComparator(new org.emftext.language.refactoring.composition.resource.ui.RefcompOutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("org.emftext.language.refactoring.composition.resource.refcomp.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		List<IAction> actions = new org.emftext.language.refactoring.composition.resource.ui.RefcompOutlinePageActionProvider().getActions(treeViewer);

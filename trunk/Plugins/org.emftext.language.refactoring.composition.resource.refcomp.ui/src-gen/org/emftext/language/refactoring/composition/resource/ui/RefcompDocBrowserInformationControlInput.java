 ...
 * olInput</code>.
 */
public class RefcompDocBrowserInformationControlInput {
	
	private final RefcompDocBrowserInformationControlInput fPrevious;
	private RefcompDocBrowserInformationControlInput fNext;
	 ...
	 */
	public RefcompDocBrowserInformationControlInput(RefcompDocBrowserInformationControlInput previous, EObject element, Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public RefcompDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public RefcompDocBrowserInformationControlInput getNext() {
		return fNext;
	}

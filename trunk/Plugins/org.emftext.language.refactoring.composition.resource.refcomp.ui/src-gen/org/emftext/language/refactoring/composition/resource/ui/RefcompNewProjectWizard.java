 ...
 * </p>
 */
public class RefcompNewProjectWizard extends Wizard implements INewWizard, IExecutableExtension {
	
	/**
	 * The name of the ZIP file that is used as content for the new project (relative
	 * to the root of the resource UI plug-in).
	 */
	public final static String NEW_PROJECT_ZIP_FILE_NAME = org.emftext.language.refactoring.composition.resource.ui.RefcompUIResourceBundle.NEW_PROJECT_ZIP_FILE_NAME;
	 ...
	 */
	protected String pageName = org.emftext.language.refactoring.composition.resource.ui.RefcompUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_NAME;
	 ...
	 */
	protected String pageDescription = org.emftext.language.refactoring.composition.resource.ui.RefcompUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_DESCRIPTION;
	
	/**
	 * The name of the project in the project creation page
	 */
	protected String pageProjectName = org.emftext.language.refactoring.composition.resource.ui.RefcompUIResourceBundle.NEW_PROJECT_WIZARD_PROJECT_NAME;
	 ...
	 * org.emftext.language.refactoring.composition.resource.ui.RefcompNewProjectWizard
	 * Logic.
	 */
	...
	protected void doPerformFinish(IProgressMonitor monitor) throws Exception {
		new org.emftext.language.refactoring.composition.resource.ui.RefcompNewProjectWizardLogic().createExampleProject(monitor, wizardNewProjectCreationPage.getLocationPath(), wizardNewProjectCreationPage.getProjectName(), org.emftext.language.refactoring.composition.resource.ui.RefcompUIPlugin.PLUGIN_ID, NEW_PROJECT_ZIP_FILE_NAME);
	}
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		...
		IPath path = new Path(org.emftext.language.refactoring.composition.resource.ui.RefcompUIResourceBundle.NEW_PROJECT_WIZARD_PAGE_ICON);
		Bundle bundle = org.emftext.language.refactoring.composition.resource.ui.RefcompUIPlugin.getDefault().getBundle();
		...
		setWindowTitle(org.emftext.language.refactoring.composition.resource.ui.RefcompUIResourceBundle.NEW_PROJECT_WIZARD_WINDOW_TITLE);
	}

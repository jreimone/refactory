 ...
 */
public class RefcompImageProvider {
	
	public final static RefcompImageProvider INSTANCE = new RefcompImageProvider();
	...
	public ImageDescriptor getImageDescriptor(String key) {
		...
		if (ImageDescriptor.getMissingImageDescriptor().equals(descriptor) || descriptor == null) {
			...
			try {
				...
				org.emftext.language.refactoring.composition.resource.ui.RefcompUIPlugin.logError("IconProvider can't load image (URL is malformed).", mue);
			}
		}
		return descriptor;
	}

 ...
 * @since 3.2
 */
public class RefcompBrowserInformationControl extends AbstractInformationControl implements IInformationControlExtension2, IDelayedInputChangeProvider {
	...
	private org.emftext.language.refactoring.composition.resource.ui.RefcompDocBrowserInformationControlInput fInput;
	 ...
	 */
	public RefcompBrowserInformationControl(Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public RefcompBrowserInformationControl(Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public RefcompBrowserInformationControl(Shell parent, String symbolicFontName, ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.refactoring.composition.resource.ui.RefcompDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.refactoring.composition.resource.ui.RefcompDocBrowserInformationControlInput) input;
		...
		org.emftext.language.refactoring.composition.resource.ui.RefcompHTMLPrinter.insertStyles(buffer, styles);
	...
	public Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.refactoring.composition.resource.ui.RefcompHTMLPrinter.html2text(new StringReader(fInput.getHtml()), presentation);
		} catch (IOException e) {
			text = "";
		}
	 ...
	 */
	public org.emftext.language.refactoring.composition.resource.ui.RefcompDocBrowserInformationControlInput getInput() {
		return fInput;
	}

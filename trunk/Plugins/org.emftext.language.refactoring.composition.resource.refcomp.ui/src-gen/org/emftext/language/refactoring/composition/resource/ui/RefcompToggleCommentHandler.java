...
public class RefcompToggleCommentHandler extends AbstractHandler {
	...
	public boolean isEnabled() {
		...
		if (activeEditor instanceof org.emftext.language.refactoring.composition.resource.ui.RefcompEditor) {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		org.emftext.language.refactoring.composition.resource.ui.RefcompEditor editor = null;
		
		if (editorPart instanceof org.emftext.language.refactoring.composition.resource.ui.RefcompEditor) {
			editor = (org.emftext.language.refactoring.composition.resource.ui.RefcompEditor) editorPart;

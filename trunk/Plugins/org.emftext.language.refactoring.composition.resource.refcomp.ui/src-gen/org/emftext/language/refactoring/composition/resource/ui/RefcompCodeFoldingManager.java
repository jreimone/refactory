 ...
 */
public class RefcompCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.emftext.language.refactoring.composition.resource.IRefcompBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.language.refactoring.composition.resource.ui.RefcompEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.language.refactoring.composition.resource.ui.RefcompEditor) {
				org.emftext.language.refactoring.composition.resource.ui.RefcompEditor editor = (org.emftext.language.refactoring.composition.resource.ui.RefcompEditor) workbenchPart;
	...
	protected org.emftext.language.refactoring.composition.resource.ui.RefcompEditor editor;
	 ...
	 */
	public RefcompCodeFoldingManager(ProjectionViewer sourceViewer,org.emftext.language.refactoring.composition.resource.ui.RefcompEditor textEditor) {
	...
	private void addCloseListener(final org.emftext.language.refactoring.composition.resource.ui.RefcompEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.language.refactoring.composition.resource.ui.RefcompUIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.language.refactoring.composition.resource.mopp.RefcompResource textResource = (org.emftext.language.refactoring.composition.resource.mopp.RefcompResource) editor.getResource();
		IDocument document = sourceViewer.getDocument();

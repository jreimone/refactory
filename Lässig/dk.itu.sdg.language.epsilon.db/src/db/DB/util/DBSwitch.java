...
public class DBSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DBPackage.DATABASE_ELEMENT: {
				DatabaseElement databaseElement = (DatabaseElement)theEObject;
				T result = caseDatabaseElement(databaseElement);
				if (result == null) result = caseNamedElement(databaseElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DBPackage.TABLE: {

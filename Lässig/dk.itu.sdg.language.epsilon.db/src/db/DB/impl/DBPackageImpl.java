...
public class DBPackageImpl extends EPackageImpl implements DBPackage {
	 ...
	 * @generated
	 */
	public EReference getDatabase_Contents() {
	 ...
	 * @generated
	 */
	public EReference getDatabaseElement_Database() {
		return (EReference)databaseElementEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getForeignKey_Parent() {
	 ...
	 * @generated
	 */
	public EReference getForeignKey_Child() {
	 ...
	 * @generated
	 */
	public EAttribute getForeignKey_IsMany() {
	...
	public void createPackageContents() {
		...
		createEReference(databaseEClass, DATABASE__CONTENTS);

		databaseElementEClass = createEClass(DATABASE_ELEMENT);
		createEReference(databaseElementEClass, DATABASE_ELEMENT__DATABASE);
		...
		createEReference(foreignKeyEClass, FOREIGN_KEY__PARENT);
		createEReference(foreignKeyEClass, FOREIGN_KEY__CHILD);
		createEAttribute(foreignKeyEClass, FOREIGN_KEY__IS_MANY);
	}
	...
	public void initializePackageContents() {
		...
		databaseElementEClass.getESuperTypes().add(this.getNamedElement());
		tableEClass.getESuperTypes().add(this.getDatabaseElement());
		columnEClass.getESuperTypes().add(this.getDatabaseElement());
		foreignKeyEClass.getESuperTypes().add(this.getDatabaseElement());
		...
		initEReference(getDatabase_Contents(), this.getDatabaseElement(), this.getDatabaseElement_Database(), "contents", null, 0, -1, Database.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDatabaseElement_Database(), this.getDatabase(), this.getDatabase_Contents(), "database", null, 0, 1, DatabaseElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getForeignKey_Parent(), this.getColumn(), null, "parent", null, 0, 1, ForeignKey.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getForeignKey_Child(), this.getColumn(), null, "child", null, 0, 1, ForeignKey.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getForeignKey_IsMany(), ecorePackage.getEBooleanObject(), "isMany", null, 0, 1, ForeignKey.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

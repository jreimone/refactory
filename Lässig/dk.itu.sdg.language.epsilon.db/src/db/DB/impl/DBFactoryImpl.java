...
public class DBFactoryImpl extends EFactoryImpl implements DBFactory {
	...
	public static DBFactory init() {
		try {
			DBFactory theDBFactory = (DBFactory)EPackage.Registry.INSTANCE.getEFactory("DB"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case DBPackage.DATABASE: return createDatabase();
			case DBPackage.TABLE: return createTable();
			case DBPackage.COLUMN: return createColumn();
			case DBPackage.FOREIGN_KEY: return createForeignKey();
			default:

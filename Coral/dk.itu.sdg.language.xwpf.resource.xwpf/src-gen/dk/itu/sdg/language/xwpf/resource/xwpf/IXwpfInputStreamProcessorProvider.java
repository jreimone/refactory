 ...
 * conversion.
 */
public interface IXwpfInputStreamProcessorProvider {
	 ...
	 */
	public dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfInputStreamProcessor getInputStreamProcessor(java.io.InputStream inputStream);
}

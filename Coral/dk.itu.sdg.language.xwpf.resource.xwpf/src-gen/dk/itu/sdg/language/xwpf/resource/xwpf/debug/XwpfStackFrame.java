...
public class XwpfStackFrame extends dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfDebugElement implements org.eclipse.debug.core.model.IStackFrame {
	
	private dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfDebugTarget target;
	private String name;
	private int id;
	...
	public XwpfStackFrame(dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfDebugTarget target, String data) {
		super(target);
		this.target = target;
		
		java.util.List<String> dataParts = dk.itu.sdg.language.xwpf.resource.xwpf.util.XwpfStringUtil.decode(data, ',');
	...
	private dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfDebugTarget getTarget() {
		return target;
	}
	...
	public boolean equals(Object obj) {
		...
		dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfStackFrame other = (dk.itu.sdg.language.xwpf.resource.xwpf.debug.XwpfStackFrame) obj;
		if (name == null) {

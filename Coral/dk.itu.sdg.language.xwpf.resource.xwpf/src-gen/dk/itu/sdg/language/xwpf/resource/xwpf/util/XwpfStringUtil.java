...
public class XwpfStringUtil {
	 ...
	 */
	public static <T> String explode(java.util.Collection<T> parts, String glue, dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfFunction1<String, T> toStringFunction) {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfFunction1<String, T> toStringFunction) {

...
public class XwpfNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "dk.itu.sdg.language.xwpf.resource.xwpf.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfBuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}

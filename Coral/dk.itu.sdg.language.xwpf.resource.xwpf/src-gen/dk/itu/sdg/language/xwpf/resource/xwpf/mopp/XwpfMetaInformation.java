...
public class XwpfMetaInformation implements dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfMetaInformation {
	...
	public void registerResourceFactory() {
		...
		if (org.eclipse.emf.ecore.resource.Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().get(getSyntaxName()) == null) {
			org.eclipse.emf.ecore.resource.Resource.Factory.Registry.INSTANCE.getExtensionToFactoryMap().put(getSyntaxName(), new dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfResourceFactoryDelegator());
		}
	}

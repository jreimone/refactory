...
public class XwpfOutlinePageTreeViewerComparator extends org.eclipse.jface.viewers.ViewerComparator {
	...
	public int compare(org.eclipse.jface.viewers.Viewer viewer, Object o1, Object o2) {
		...
		if (sortLexically && o1 instanceof org.eclipse.emf.ecore.EObject && o2 instanceof org.eclipse.emf.ecore.EObject) {
			...
			dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfNameProvider nameProvider = new dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfMetaInformation().createNameProvider();

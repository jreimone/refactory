 ...
 * olInput</code>.
 */
public class XwpfDocBrowserInformationControlInput {
	
	private final XwpfDocBrowserInformationControlInput fPrevious;
	private XwpfDocBrowserInformationControlInput fNext;
	 ...
	 */
	public XwpfDocBrowserInformationControlInput(XwpfDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	 ...
	 */
	public XwpfDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	 ...
	 */
	public XwpfDocBrowserInformationControlInput getNext() {
		return fNext;
	}

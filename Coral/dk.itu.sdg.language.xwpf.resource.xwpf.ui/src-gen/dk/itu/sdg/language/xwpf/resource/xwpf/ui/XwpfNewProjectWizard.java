 ...
 */
public class XwpfNewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfMetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("dk.itu.sdg.language.xwpf.resource.xwpf.ui");
							...
							String natureID = dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfNature.NATURE_ID;
							...
							for (String builderID : dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfNature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfMetaInformation info = new dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfUIPlugin.getDefault().getBundle();

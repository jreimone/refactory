 ...
 */
public class XwpfNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public XwpfNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new xwpf file");

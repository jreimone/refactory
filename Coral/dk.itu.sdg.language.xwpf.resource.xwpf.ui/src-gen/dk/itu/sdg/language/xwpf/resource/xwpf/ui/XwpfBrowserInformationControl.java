 ...
 * @since 3.2
 */
public class XwpfBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfDocBrowserInformationControlInput fInput;
	 ...
	 */
	public XwpfBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public XwpfBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public XwpfBrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfDocBrowserInformationControlInput);
		...
		fInput= (dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfDocBrowserInformationControlInput) input;
		...
		dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfDocBrowserInformationControlInput getInput() {
		return fInput;
	}

 ...
 * </ul>
 */
public class XwpfBracketPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	
	private static final String[] ALL_LEFT_BRACKETS = new String[] { "{", "(", "[", "<", "\"", "'", };
	private static final String[] ALL_RIGHT_BRACKETS = new String[] { "}", ")", "]", ">", "\"", "'", };
	
	private String BRACKETS_COLOR = dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR;
	...
	private String language = new dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfMetaInformation().getSyntaxName();
	
	private dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfBracketSet bracketsTmp;
	
	/**
	 * Creates a preference page for bracket setting.
	 */
	public XwpfBracketPreferencePage() {
		super();
		
		dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfMetaInformation metaInformation = new dk.itu.sdg.language.xwpf.resource.xwpf.mopp.XwpfMetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench) {
		...
		bracketsTmp = new dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfBracketSet(null, null);
		for (String languageID : languageIDs) {
			bracketSetTemp.put(languageID, getPreferenceStore().getString(languageID + dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		}
	}
	...
	private void handleMatchingBracketsSelection() {
		...
		enableCheckbox.setSelection(getPreferenceStore().getBoolean(		dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		enableClosingInside.setSelection(false);
		matchingBracketsColorButton.setEnabled(getPreferenceStore().getBoolean(		dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		...
		initializeLanguage();
		bracketsTmp.setBrackets(getPreferenceStore().getString(language + dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		...
		bracketsList.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int index : itemIndices) {
					dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfBracketPair bracketPair = bracketsTmp.getBracketPair(index);
		...
		enableClosingInside.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			...
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				...
				for (int idx : itemIndices) {
					dk.itu.sdg.language.xwpf.resource.xwpf.IXwpfBracketPair bracketPair = bracketsTmp.getBracketPair(idx);
	...
	protected void performDefaults() {
		enableCheckbox.setSelection(getPreferenceStore().getDefaultBoolean(dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		...
		bracketSetTemp.put(language, getPreferenceStore().getDefaultString(language + dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfPreferenceConstants.EDITOR_BRACKETS_SUFFIX));
		bracketsTmp.setBrackets(bracketSetTemp.get(language));
		bracketsList.setItems(bracketsTmp.getBracketArray());
		enableClosingInside.setSelection(false);
	}
	...
	private void updateActiveEditor() {
		...
		getPreferenceStore().setValue(dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		getPreferenceStore().setValue(language + dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfPreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
		...
		if (editor != null && editor instanceof dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfEditor) {
			((dk.itu.sdg.language.xwpf.resource.xwpf.ui.XwpfEditor) editor).invalidateTextRepresentation();
		}
	}

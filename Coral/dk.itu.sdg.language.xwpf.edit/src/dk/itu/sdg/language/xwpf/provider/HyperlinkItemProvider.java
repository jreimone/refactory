...
/**
 * This is the item provider adapter for a {@link dk.itu.sdg.language.xwpf.Hyperlink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HyperlinkItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Hyperlink_identifier_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Hyperlink_identifier_feature", "_UI_Hyperlink_type"),
				 XwpfPackage.Literals.HYPERLINK__IDENTIFIER,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 XwpfPackage.Literals.HYPERLINK__URL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Hyperlink)object).getIdentifier();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Hyperlink.class)) {
			case XwpfPackage.HYPERLINK__IDENTIFIER:
			case XwpfPackage.HYPERLINK__URL:

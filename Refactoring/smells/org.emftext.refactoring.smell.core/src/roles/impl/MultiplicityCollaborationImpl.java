...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Multiplicity Collaboration</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link roles.impl.MultiplicityCollaborationImpl#getSourceMultiplicity <em>Source Multiplicity</em>}</li>
 *   <li>{@link roles.impl.MultiplicityCollaborationImpl#getTargetMultiplicity <em>Target Multiplicity</em>}</li>
 *   <li>{@link roles.impl.MultiplicityCollaborationImpl#getSourceName <em>Source Name</em>}</li>
 *   <li>{@link roles.impl.MultiplicityCollaborationImpl#getTargetName <em>Target Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class MultiplicityCollaborationImpl extends CollaborationImpl implements MultiplicityCollaboration {
	 ...
	 * @generated
	 */
	protected MultiplicityCollaborationImpl() {
		super();
	}
	...
	public NotificationChain basicSetSourceMultiplicity(Multiplicity newSourceMultiplicity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RolesPackage.MULTIPLICITY_COLLABORATION__SOURCE_MULTIPLICITY, oldSourceMultiplicity, newSourceMultiplicity);
	...
	public void setSourceMultiplicity(Multiplicity newSourceMultiplicity) {
		if (newSourceMultiplicity != sourceMultiplicity) {
			...
			if (sourceMultiplicity != null)
				msgs = ((InternalEObject)sourceMultiplicity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RolesPackage.MULTIPLICITY_COLLABORATION__SOURCE_MULTIPLICITY, null, msgs);
			if (newSourceMultiplicity != null)
				msgs = ((InternalEObject)newSourceMultiplicity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RolesPackage.MULTIPLICITY_COLLABORATION__SOURCE_MULTIPLICITY, null, msgs);
			msgs = basicSetSourceMultiplicity(newSourceMultiplicity, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RolesPackage.MULTIPLICITY_COLLABORATION__SOURCE_MULTIPLICITY, newSourceMultiplicity, newSourceMultiplicity));
	}
	...
	public NotificationChain basicSetTargetMultiplicity(Multiplicity newTargetMultiplicity, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, RolesPackage.MULTIPLICITY_COLLABORATION__TARGET_MULTIPLICITY, oldTargetMultiplicity, newTargetMultiplicity);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTargetMultiplicity(Multiplicity newTargetMultiplicity) {
		if (newTargetMultiplicity != targetMultiplicity) {
			...
			if (targetMultiplicity != null)
				msgs = ((InternalEObject)targetMultiplicity).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - RolesPackage.MULTIPLICITY_COLLABORATION__TARGET_MULTIPLICITY, null, msgs);
			if (newTargetMultiplicity != null)
				msgs = ((InternalEObject)newTargetMultiplicity).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - RolesPackage.MULTIPLICITY_COLLABORATION__TARGET_MULTIPLICITY, null, msgs);
			msgs = basicSetTargetMultiplicity(newTargetMultiplicity, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RolesPackage.MULTIPLICITY_COLLABORATION__TARGET_MULTIPLICITY, newTargetMultiplicity, newTargetMultiplicity));
	}
	...
	public void setSourceName(String newSourceName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RolesPackage.MULTIPLICITY_COLLABORATION__SOURCE_NAME, oldSourceName, sourceName));
	}
	...
	public void setTargetName(String newTargetName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RolesPackage.MULTIPLICITY_COLLABORATION__TARGET_NAME, oldTargetName, targetName));
	}

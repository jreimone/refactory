 ...
 * <ul>
 *   <li>{@link smell_model.impl.MappingConcretisationImpl#getNewFactor <em>New Factor</em>}</li>
 *   <li>{@link smell_model.impl.MappingConcretisationImpl#getMapping <em>Mapping</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MappingConcretisationImpl extends EObjectImpl implements MappingConcretisation {
	 ...
	 * @ordered
	 */
	protected static final float NEW_FACTOR_EDEFAULT = 0.0F;
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			case Smell_modelPackage.MAPPING_CONCRETISATION__NEW_FACTOR:
				return newFactor != NEW_FACTOR_EDEFAULT;
			case Smell_modelPackage.MAPPING_CONCRETISATION__MAPPING:
				return mapping != null;
		}

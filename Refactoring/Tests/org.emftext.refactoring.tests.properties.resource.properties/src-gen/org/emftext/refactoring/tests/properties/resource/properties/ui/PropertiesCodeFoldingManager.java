 ...
 */
public class PropertiesCodeFoldingManager {
	
	private class FoldingUpdateListener implements org.emftext.refactoring.tests.properties.resource.properties.IPropertiesBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEditor) {
				org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEditor editor = (org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEditor) workbenchPart;
	...
	protected org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEditor editor;
	 ...
	 */
	public PropertiesCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEditor textEditor) {
	...
	private void addCloseListener(final org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextResource textResource = (org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();

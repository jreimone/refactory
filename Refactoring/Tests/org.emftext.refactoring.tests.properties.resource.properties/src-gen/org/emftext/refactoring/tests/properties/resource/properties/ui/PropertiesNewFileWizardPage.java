 ...
 */
public class PropertiesNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public PropertiesNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new properties file");

...
public class PropertiesNature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.emftext.refactoring.tests.properties.resource.properties.nature";
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesBuilderAdapter.BUILDER_ID)) {
				return;
			}
		}

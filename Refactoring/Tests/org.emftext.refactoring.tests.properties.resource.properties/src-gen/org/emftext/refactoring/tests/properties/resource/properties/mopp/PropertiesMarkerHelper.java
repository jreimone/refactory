 ...
 * contains
 * <code>org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTe
 * xtDiagnostic</code>s it uses the more precise information of this extended
 * diagnostic type.
 */
public class PropertiesMarkerHelper {
	
	/**
	 * The extension id of the custom marker type that is used by this text resource.
	 */
	public static final String MARKER_TYPE = org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesPlugin.PLUGIN_ID + ".problem";
	...
	private static class MarkerCommandQueue {
		...
		private java.util.List<org.emftext.refactoring.tests.properties.resource.properties.IPropertiesCommand<Object>> commands = new java.util.ArrayList<org.emftext.refactoring.tests.properties.resource.properties.IPropertiesCommand<Object>>();
		private final Object jobLock = new Object();
		
		public void addCommand(org.emftext.refactoring.tests.properties.resource.properties.IPropertiesCommand<Object> command) {
		...
		COMMAND_QUEUE.addCommand(new org.emftext.refactoring.tests.properties.resource.properties.IPropertiesCommand<Object>() {
			public boolean execute(Object context) {
				try {
					...
					if (problem.getSeverity() == org.emftext.refactoring.tests.properties.resource.properties.PropertiesEProblemSeverity.ERROR) {
					...
					org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextDiagnostic textDiagnostic = (org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextDiagnostic) diagnostic;
					...
					if (diagnostic instanceof org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesResource.ElementBasedTextDiagnostic) {
						org.eclipse.emf.ecore.EObject element = ((org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesResource.ElementBasedTextDiagnostic) diagnostic).getElement();
					...
					java.util.Collection<org.emftext.refactoring.tests.properties.resource.properties.IPropertiesQuickFix> quickFixes = textDiagnostic.getProblem().getQuickFixes();
					...
					if (!sourceIDs.isEmpty()) {
						marker.setAttribute(org.eclipse.core.resources.IMarker.SOURCE_ID, org.emftext.refactoring.tests.properties.resource.properties.util.PropertiesStringUtil.explode(sourceIDs, "|"));
					}
	...
	public void unmark(org.eclipse.emf.ecore.resource.Resource resource, final org.eclipse.emf.ecore.EObject causingObject) {
		...
		final String markerID = getMarkerID(org.emftext.refactoring.tests.properties.resource.properties.PropertiesEProblemType.UNKNOWN);

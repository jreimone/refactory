 ...
 */
public class PropertiesEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	...
	public PropertiesEditor() {
		...
		setSourceViewerConfiguration(new org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEditorConfiguration(this, colorManager));
	...
	private final class MarkerUpdateListener implements org.emftext.refactoring.tests.properties.resource.properties.IPropertiesBackgroundParsingListener {
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
				...
				org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
		...
		if (loadedResource == null) {
			try {
				...
				if (demandLoadedResource instanceof org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextResource) {
					...
					org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the PropertiesEditor.");
					// close this editor because it can not present the resource
					close(false);
				}
			} catch (java.lang.Exception e) {
				org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesPlugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
	...
	private void refreshMarkers(final org.eclipse.emf.ecore.resource.Resource resourceToRefresh) {
		...
		if (display != null) {
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesMarkerHelper.unmark(resourceToRefresh);
						org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesMarkerHelper.mark(resourceToRefresh);
					} catch (org.eclipse.core.runtime.CoreException e) {
						org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesPlugin.logError("Exception while updating markers on resource", e);
					}
				}
			});
		}

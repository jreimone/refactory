 ...
 */
public class PropertiesMinimalModelHelper {
	
	private final static org.emftext.refactoring.tests.properties.resource.properties.util.PropertiesEClassUtil eClassUtil = new org.emftext.refactoring.tests.properties.resource.properties.util.PropertiesEClassUtil();
				...
				if (type instanceof org.eclipse.emf.ecore.EClass) {
					...
					for (int i = 0; i < lowerBound; i++) {
						...
						if (reference.isContainment()) {
							...
							String initialValue = "#some" + org.emftext.refactoring.tests.properties.resource.properties.util.PropertiesStringUtil.capitalize(typeClass.getName());

 ...
 */
public class PropertiesHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	private final static org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionHelper positionHelper = new org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionHelper();
	private boolean isHighlightBrackets = true;
	private boolean isHighlightOccurrences = true;
	private org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesTokenScanner scanner;
	...
	private org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesOccurrence occurrence;
	private org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesBracketSet bracketSet;
	 ...
	 */
	private final class UpdateHighlightingListener implements org.eclipse.swt.events.KeyListener, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.MouseListener, org.emftext.refactoring.tests.properties.resource.properties.IPropertiesBackgroundParsingListener {
	 ...
	 * @param editor
	 */
	public PropertiesHighlighting(org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesColorManager colorManager, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEditor editor) {
		this.display = org.eclipse.swt.widgets.Display.getCurrent();
		sourceviewer.getSelectionProvider();
		preferenceStore = org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesPlugin.getDefault().getPreferenceStore();
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesTokenScanner(colorManager);
		occurrence = new org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesOccurrence(textResource, sourceviewer, scanner);
		bracketSet = new org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesBracketSet(sourceviewer);
		this.colorManager = colorManager;
		isHighlightBrackets = preferenceStore.getBoolean(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX);
		isHighlightOccurrences = preferenceStore.getBoolean(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPreferenceConstants.EDITOR_OCCURRENCE_CHECKBOX);
		definitionColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPreferenceConstants.EDITOR_DEFINITION_COLOR));
		proxyColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPreferenceConstants.EDITOR_PROXY_COLOR));
		bracketColor = colorManager.getColor(org.eclipse.jface.preference.PreferenceConverter.getColor(preferenceStore, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPreferenceConstants.EDITOR_MATCHING_BRACKETS_COLOR));
		black = colorManager.getColor(new org.eclipse.swt.graphics.RGB(0, 0, 0));
		
		addListeners(editor);
	}
	
	private void addListeners(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEditor editor) {
	...
	private void setHighlighting() {
		...
		if (occurrence.isPositionsChanged()) {
			...
			org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionCategory.DEFINTION.toString());
			setCategoryHighlighting(document,
			org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionCategory.PROXY.toString());
		}
		setCategoryHighlighting(document, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionCategory.BRACKET.toString());
	}
	...
	private void setCategoryHighlighting(org.eclipse.jface.text.IDocument document, String category) {
		...
		if (category.equals(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionCategory.PROXY.toString())) {
		...
		for (org.eclipse.jface.text.Position position : positions) {
			...
			if (tmpPosition != null) {
				if (category.equals(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionCategory.DEFINTION.toString())) {
				...
				if (category.equals(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionCategory.BRACKET.toString())) {
					styleRange = getStyleRangeAtPosition(tmpPosition);
	...
	private void removeHighlighting() {
		org.eclipse.jface.text.IDocument document = projectionViewer.getDocument();
		removeHighlightingCategory(document, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionCategory.BRACKET.toString());
		if (occurrence.isToRemoveHighlighting()) {
			removeHighlightingCategory(document, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionCategory.DEFINTION.toString());
			removeHighlightingCategory(document, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionCategory.PROXY.toString());
		}
	}
	
	private void removeHighlightingCategory(org.eclipse.jface.text.IDocument document, String category) {
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, category);
		boolean isOccurrence = (category.equals(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionCategory.DEFINTION.toString()) || category.equals(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionCategory.PROXY.toString()));
		if (category.equals(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionCategory.BRACKET.toString())) {
		...
		display.syncExec(new Runnable() {
			public void run() {
				...
				if (selectedEObject != null) {
					setSelection(new org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEObjectSelection(selectedEObject, false));
				}
			}
		});
	}

...
public class PropertiesTokenScanner implements org.eclipse.jface.text.rules.ITokenScanner {
	 ...
	 */
	public PropertiesTokenScanner(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesColorManager colorManager) {
		...
		this.store = org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesPlugin.getDefault().getPreferenceStore();
	...
	public org.eclipse.jface.text.rules.IToken nextToken() {
		...
		if (tokenName != null) {
			...
			if (store.getBoolean(enableKey)) {
				...
				if (store.getBoolean(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesSyntaxColoringHelper.getPreferenceKey(languageId, tokenName, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesSyntaxColoringHelper.StyleProperty.BOLD))) {
					style = style | org.eclipse.swt.SWT.BOLD;
				}
				if (store.getBoolean(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesSyntaxColoringHelper.getPreferenceKey(languageId, tokenName, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesSyntaxColoringHelper.StyleProperty.ITALIC))) {
					style = style | org.eclipse.swt.SWT.ITALIC;
				}
				if (store.getBoolean(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesSyntaxColoringHelper.getPreferenceKey(languageId, tokenName, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesSyntaxColoringHelper.StyleProperty.STRIKETHROUGH))) {
					style = style | org.eclipse.jface.text.TextAttribute.STRIKETHROUGH;
				}
				if (store.getBoolean(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesSyntaxColoringHelper.getPreferenceKey(languageId, tokenName, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesSyntaxColoringHelper.StyleProperty.UNDERLINE))) {

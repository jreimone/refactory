 ...
 * <ul>
 *   <li>{@link org.emftext.refactoring.tests.properties.impl.CategoryImpl#getPairs <em>Pairs</em>}</li>
 *   <li>{@link org.emftext.refactoring.tests.properties.impl.CategoryImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CategoryImpl extends EObjectImpl implements Category {
   ...
   */
    ...
    if (pairs == null)
    {
      pairs = new EObjectContainmentEList<KeyValuePair>(KeyValuePair.class, this, PropertiesPackage.CATEGORY__PAIRS);
    }
    return pairs;
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, PropertiesPackage.CATEGORY__NAME, oldName, name));
  }
   ...
   */
    ...
    switch (featureID)
    {
      case PropertiesPackage.CATEGORY__PAIRS:
   ...
   */
    ...
    switch (featureID)
    {
      case PropertiesPackage.CATEGORY__PAIRS:
        return getPairs();
      case PropertiesPackage.CATEGORY__NAME:
        return getName();
    }

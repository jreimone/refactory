 ...
 */
public class PropertiesBackgroundParsingStrategy {
	 ...
	 */
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextResource resource, final org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEditor editor) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(org.eclipse.jface.text.IDocument document, final org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextResource resource, final org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEditor editor, long delay) {
	 ...
	 * Schedules a task for background parsing that will be started after a delay.
	 */
	public void parse(final String contents, final org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextResource resource, final org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEditor editor, long delay) {
		if (resource == null) {
			return;
		}
		if (contents == null) {

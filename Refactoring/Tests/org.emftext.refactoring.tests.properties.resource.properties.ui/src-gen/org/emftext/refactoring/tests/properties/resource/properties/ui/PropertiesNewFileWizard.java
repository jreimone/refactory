...
public class PropertiesNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	...
	public boolean performFinish() {
		...
		try {
			...
			org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesUIPlugin.logError("Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesUIPlugin.logError("Exception while initializing new file", e);
			return false;
		}
		return true;
	}

 ...
 */
public class PropertiesBracketSet {
	...
	private java.util.ArrayList<org.emftext.refactoring.tests.properties.resource.properties.IPropertiesBracketPair> bracketPairs;
	 ...
	 */
	private class BracketPair implements org.emftext.refactoring.tests.properties.resource.properties.IPropertiesBracketPair {
	 ...
	 */
	private class ClosingListener implements org.emftext.refactoring.tests.properties.resource.properties.ui.IPropertiesBracketHandler, org.eclipse.swt.events.VerifyListener, org.eclipse.swt.events.ModifyListener, org.eclipse.swt.custom.VerifyKeyListener {
		...
		public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
			...
			if (caret > 0 && caret < textWidget.getCharCount()) {
				org.emftext.refactoring.tests.properties.resource.properties.IPropertiesBracketPair bracketPair = getBracketPair(textWidget.getTextRange(caret - 1, 1), textWidget.getTextRange(caret, 1));
	 ...
	 */
	public PropertiesBracketSet(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEditor editor, org.eclipse.jface.text.source.ISourceViewer sourceViewer) {
		languageID = new org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesMetaInformation().getSyntaxName();
		this.bracketPairs = new java.util.ArrayList<org.emftext.refactoring.tests.properties.resource.properties.IPropertiesBracketPair>();
	 ...
	 */
	public org.emftext.refactoring.tests.properties.resource.properties.IPropertiesBracketPair getBracketPair(String opening, String closing) {
		for (org.emftext.refactoring.tests.properties.resource.properties.IPropertiesBracketPair bracketPair : bracketPairs) {
	...
	public org.emftext.refactoring.tests.properties.resource.properties.IPropertiesBracketPair getBracketPair(int index) {
		try {
	 ...
	 */
	public boolean setClosingEnabledInside(org.emftext.refactoring.tests.properties.resource.properties.IPropertiesBracketPair bracketPair, boolean closingEnabledInside) {
	...
	public boolean resetBrackets() {
		String bracketPairs = preferenceStore.getString(languageID + org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	 ...
	 */
	public org.emftext.refactoring.tests.properties.resource.properties.IPropertiesBracketPair remove(String opening, String closing) {
		for (org.emftext.refactoring.tests.properties.resource.properties.IPropertiesBracketPair bracketPair : bracketPairs) {
			if (bracketPair.getOpeningBracket().equals(opening) && bracketPair.getClosingBracket().equals(closing)) {
	...
	public boolean setBrackets(String bracketSet) {
		...
		bracketPairs = new java.util.ArrayList<org.emftext.refactoring.tests.properties.resource.properties.IPropertiesBracketPair>();
	...
	public void matchingBrackets() {
		...
		if (position != -1 && position != document.getLength()) {
			positionHelper.addPosition(document, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionCategory.BRACKET.toString(), position, 1);
			positionHelper.addPosition(document, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionCategory.BRACKET.toString(), caretOffset - 1, 1);
		}
	}

 ...
 */
public class PropertiesOccurrence {
	
	public final static String OCCURRENCE_ANNOTATION_ID = "org.emftext.refactoring.tests.properties.resource.properties.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "org.emftext.refactoring.tests.properties.resource.properties.ui.occurences.declaration";
	...
	private org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesTokenScanner tokenScanner;
	...
	private org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextResource textResource;
	 ...
	 */
	public PropertiesOccurrence(org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesTokenScanner tokenScanner) {
		this.textResource = textResource;
		this.projectionViewer = sourceViewer;
		
		quotedTokenArray = new java.util.ArrayList<String>();
		String[] tokenNames = new org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesMetaInformation().getTokenNames();
	 ...
	 */
	public void handleOccurrenceHighlighting(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesBracketSet bracketSet) {
		if (textResource == null) {
			return;
		}
		org.eclipse.swt.custom.StyledText textWidget = projectionViewer.getTextWidget();
		...
		if (resource.equals(textResource)) {
			...
			while (!token.isEOF()) {
				...
				if (text.equals(tokenText)) {
					...
					addAnnotation(document, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionCategory.DEFINTION, text);
					break;
				}
				token = tokenScanner.nextToken();
			}
			...
			if (text != null && text.equals(tokenText) && tokenScanner.getTokenOffset() != defPosition) {
				...
				if (occEO != null) {
					if ((isNull && elementsAtDefinition.contains(occEO)) || !isNull && definitionElement.equals(occEO)) {
						addAnnotation(document, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionCategory.PROXY, text);
					}
				}
			}
			token = tokenScanner.nextToken();
	...
	private void addAnnotation(org.eclipse.jface.text.IDocument document, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionCategory type, String text) {
		int tokenOffset = tokenScanner.getTokenOffset();
		int tokenLength = tokenScanner.getTokenLength();
		...
		if (type == org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionCategory.DEFINTION) {
	...
	private void removeAnnotations() {
		removeAnnotations(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesOccurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesOccurrence.DECLARATION_ANNOTATION_ID);
	}

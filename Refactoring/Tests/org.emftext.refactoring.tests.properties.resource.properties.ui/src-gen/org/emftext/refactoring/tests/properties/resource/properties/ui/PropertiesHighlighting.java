...
public class PropertiesHighlighting implements org.eclipse.jface.viewers.ISelectionProvider, org.eclipse.jface.viewers.ISelectionChangedListener {
	...
	public PropertiesHighlighting(org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextResource textResource, org.eclipse.jface.text.source.projection.ProjectionViewer sourceviewer, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesColorManager colorManager, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEditor editor) {
		...
		preferenceStore = org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesUIPlugin.getDefault().getPreferenceStore();
		this.editor = editor;
		textWidget = sourceviewer.getTextWidget();
		projectionViewer = sourceviewer;
		scanner = new org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesTokenScanner(textResource, colorManager);
		...
		bracketSet = new org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesBracketSet(editor, sourceviewer);
	...
	private void setBracketHighlighting(org.eclipse.jface.text.IDocument document) {
		...
		org.eclipse.jface.text.Position[] positions = positionHelper.getPositions(document, org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesPositionCategory.BRACKET.toString());

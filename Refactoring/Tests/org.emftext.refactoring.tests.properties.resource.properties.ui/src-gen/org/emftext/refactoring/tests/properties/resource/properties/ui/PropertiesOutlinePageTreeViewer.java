 ...
 * a specified depth.
 */
public class PropertiesOutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public PropertiesOutlinePageTreeViewer(org.eclipse.swt.widgets.Composite parent, int style) {
		super(parent, style);
		...
		setComparer(new org.eclipse.jface.viewers.IElementComparer() {
			...
			private String getURI(org.eclipse.emf.ecore.EObject eObject) {
				...
				String uriFragment = org.emftext.refactoring.tests.properties.resource.properties.util.PropertiesStringUtil.explode(uriFragmentPath, "/");
				return uriFragment;
			}
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesEObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesPlugin.logError("Exception while refreshing outline view", e);
		}
	}

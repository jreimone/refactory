...
public class PropertiesMarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
	...
	public org.eclipse.ui.IMarkerResolution[] getResolutions(org.eclipse.core.resources.IMarker marker) {
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				rs.getLoadOptions().put(org.emftext.refactoring.tests.properties.resource.properties.IPropertiesOptions.DISABLE_CREATING_MARKERS_FOR_PROBLEMS, "true");
				org.eclipse.emf.ecore.resource.Resource emfResource = rs.getResource(uri, true);
				if (emfResource instanceof org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesResource) {
					org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesResource customResource = (org.emftext.refactoring.tests.properties.resource.properties.mopp.PropertiesResource) emfResource;
					org.eclipse.emf.ecore.util.EcoreUtil.resolveAll(customResource);
					java.util.Collection<org.emftext.refactoring.tests.properties.resource.properties.IPropertiesQuickFix> quickFixes = getQuickFixes(customResource, marker);
					java.util.List<org.eclipse.ui.IMarkerResolution2> resolutions = new java.util.ArrayList<org.eclipse.ui.IMarkerResolution2>();
					for (final org.emftext.refactoring.tests.properties.resource.properties.IPropertiesQuickFix quickFix : quickFixes) {
						resolutions.add(new org.eclipse.ui.IMarkerResolution2() {
							...
							public void run(org.eclipse.core.resources.IMarker marker) {
								...
								try {
									...
									org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesUIPlugin.logError("Exception while applying quick fix", e);
								}
							}
			...
			org.emftext.refactoring.tests.properties.resource.properties.ui.PropertiesUIPlugin.logError("Exception while computing quick fix resolutions", e);
		}
		return new org.eclipse.ui.IMarkerResolution[] {};
	}
	
	public java.util.Collection<org.emftext.refactoring.tests.properties.resource.properties.IPropertiesQuickFix> getQuickFixes(org.emftext.refactoring.tests.properties.resource.properties.IPropertiesTextResource resource, org.eclipse.core.resources.IMarker marker) {
		...
		try {
			...
			if (quickFixContexts != null) {
				...
				for (String quickFixContext : quickFixContextParts) {
					org.emftext.refactoring.tests.properties.resource.properties.IPropertiesQuickFix quickFix = resource.getQuickFix(quickFixContext);
					if (quickFix != null) {

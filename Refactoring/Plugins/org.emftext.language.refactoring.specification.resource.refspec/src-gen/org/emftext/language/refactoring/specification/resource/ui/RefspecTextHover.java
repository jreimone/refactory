...
public class RefspecTextHover implements org.eclipse.jface.text.ITextHover, org.eclipse.jface.text.ITextHoverExtension, org.eclipse.jface.text.ITextHoverExtension2{
	...
	private org.emftext.language.refactoring.specification.resource.IRefspecHoverTextProvider hoverTextProvider;
	// The style sheet (css).
	...
	public static class OpenDeclarationAction extends org.eclipse.jface.action.Action {
		...
		private final org.emftext.language.refactoring.specification.resource.ui.RefspecBrowserInformationControl infoControl;
		...
		//            target element
		public OpenDeclarationAction(org.emftext.language.refactoring.specification.resource.ui.RefspecBrowserInformationControl infoControl) {
		...
		public void run() {
			org.emftext.language.refactoring.specification.resource.ui.RefspecDocBrowserInformationControlInput infoInput = (org.emftext.language.refactoring.specification.resource.ui.RefspecDocBrowserInformationControlInput) infoControl.getInput();
			...
			if (infoInput.getInputElement() instanceof org.eclipse.emf.ecore.EObject) {
				...
				if (decEO != null && decEO.eResource() != null) {
					org.emftext.language.refactoring.specification.resource.ui.RefspecHyperlink hyperlink = new org.emftext.language.refactoring.specification.resource.ui.RefspecHyperlink(null, decEO, infoInput.getTokenText());
					hyperlink.open();
				}
			}
		}
	...
	public static final class PresenterControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			if (org.emftext.language.refactoring.specification.resource.ui.RefspecBrowserInformationControl.isAvailable(parent)) {
				org.eclipse.jface.action.ToolBarManager tbm = new org.eclipse.jface.action.ToolBarManager(org.eclipse.swt.SWT.FLAT);
				org.emftext.language.refactoring.specification.resource.ui.RefspecBrowserInformationControl iControl = new org.emftext.language.refactoring.specification.resource.ui.RefspecBrowserInformationControl(parent, FONT, tbm);
				...
				org.eclipse.jface.text.IInputChangedListener inputChangeListener = new org.eclipse.jface.text.IInputChangedListener() {
					public void inputChanged(java.lang.Object newInput) {
						...
						} else if (newInput instanceof org.emftext.language.refactoring.specification.resource.ui.RefspecDocBrowserInformationControlInput) {
							org.emftext.language.refactoring.specification.resource.ui.RefspecDocBrowserInformationControlInput input = (org.emftext.language.refactoring.specification.resource.ui.RefspecDocBrowserInformationControlInput) newInput;
	...
	public static final class HoverControlCreator extends org.eclipse.jface.text.AbstractReusableInformationControlCreator {
		...
		public org.eclipse.jface.text.IInformationControl doCreateInformationControl(org.eclipse.swt.widgets.Shell parent) {
			...
			if (org.emftext.language.refactoring.specification.resource.ui.RefspecBrowserInformationControl.isAvailable(parent)) {
				org.emftext.language.refactoring.specification.resource.ui.RefspecBrowserInformationControl iControl = new org.emftext.language.refactoring.specification.resource.ui.RefspecBrowserInformationControl(parent, FONT, tooltipAffordanceString) {
	...
	// element.
	public RefspecTextHover(org.emftext.language.refactoring.specification.resource.ui.RefspecEditor editor) {
		super();
		this.editor = editor;
		hoverTextProvider = new org.emftext.language.refactoring.specification.resource.mopp.RefspecMetaInformation().getHoverTextProvider();
	}
	
	public String getHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		return ((org.emftext.language.refactoring.specification.resource.ui.RefspecDocBrowserInformationControlInput) getHoverInfo2(textViewer, hoverRegion)).getHtml();
	}
	...
	private org.emftext.language.refactoring.specification.resource.ui.RefspecDocBrowserInformationControlInput internalGetHoverInfo(org.eclipse.jface.text.ITextViewer textViewer, org.eclipse.jface.text.IRegion hoverRegion) {
		org.emftext.language.refactoring.specification.resource.IRefspecTextResource textResource = editor.getResource();
	...
	private org.emftext.language.refactoring.specification.resource.ui.RefspecDocBrowserInformationControlInput getHoverInfo(java.util.List<org.eclipse.emf.ecore.EObject> elements, org.eclipse.jface.text.ITextViewer textViewer, org.emftext.language.refactoring.specification.resource.ui.RefspecDocBrowserInformationControlInput previousInput) {
		...
		if (proxyObject != null) {
			...
			if (declarationObject != null) {
				org.emftext.language.refactoring.specification.resource.ui.RefspecHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(declarationObject));
			}
		} else {
			org.emftext.language.refactoring.specification.resource.ui.RefspecHTMLPrinter.addParagraph(buffer, hoverTextProvider.getHoverText(elements.get(0)));
		}
		if (buffer.length() > 0) {
			org.emftext.language.refactoring.specification.resource.ui.RefspecHTMLPrinter.insertPageProlog(buffer, 0, org.emftext.language.refactoring.specification.resource.ui.RefspecTextHover.getStyleSheet());
			org.emftext.language.refactoring.specification.resource.ui.RefspecHTMLPrinter.addPageEpilog(buffer);
			return new org.emftext.language.refactoring.specification.resource.ui.RefspecDocBrowserInformationControlInput(previousInput, declarationObject, editor.getResource(), buffer.toString(), tokenText);
		}
		return null;
	}
	...
	private static String getStyleSheet() {
		...
		if (css != null) {
			...
			css = org.emftext.language.refactoring.specification.resource.ui.RefspecHTMLPrinter.convertTopLevelFont(css, fontData);
		}
	...
	private static String loadStyleSheet() {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.language.refactoring.specification.resource.mopp.RefspecPlugin.PLUGIN_ID);

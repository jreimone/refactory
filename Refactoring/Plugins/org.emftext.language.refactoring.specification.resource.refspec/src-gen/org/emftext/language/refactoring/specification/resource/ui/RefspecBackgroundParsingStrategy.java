...
public class RefspecBackgroundParsingStrategy {
	...
	// a delay.
	public void parse(org.eclipse.jface.text.DocumentEvent event, final org.emftext.language.refactoring.specification.resource.IRefspecTextResource resource, final org.emftext.language.refactoring.specification.resource.ui.RefspecEditor editor) {
		if (resource == null) {
			return;
		}

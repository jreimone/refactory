...
public class RefspecSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.language.refactoring.specification.resource.ui.RefspecSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.specification.resource.ui.RefspecSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.language.refactoring.specification.resource.ui.RefspecSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.specification.resource.ui.RefspecSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.language.refactoring.specification.resource.ui.RefspecSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.specification.resource.ui.RefspecSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.language.refactoring.specification.resource.ui.RefspecSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.specification.resource.ui.RefspecSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.language.refactoring.specification.resource.ui.RefspecSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.specification.resource.ui.RefspecSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.language.refactoring.specification.resource.ui.RefspecSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.specification.resource.ui.RefspecSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.emftext.language.refactoring.specification.resource.ui.RefspecPixelConverter pixelConverter = new org.emftext.language.refactoring.specification.resource.ui.RefspecPixelConverter(composite);
	...
	public RefspecSyntaxColoringPreferencePage() {
		...
		org.emftext.language.refactoring.specification.resource.IRefspecMetaInformation syntaxPlugin = new org.emftext.language.refactoring.specification.resource.mopp.RefspecMetaInformation();
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.language.refactoring.specification.resource.ui.RefspecEditor) {
			org.emftext.language.refactoring.specification.resource.ui.RefspecEditor emfTextEditor = (org.emftext.language.refactoring.specification.resource.ui.RefspecEditor) editor;

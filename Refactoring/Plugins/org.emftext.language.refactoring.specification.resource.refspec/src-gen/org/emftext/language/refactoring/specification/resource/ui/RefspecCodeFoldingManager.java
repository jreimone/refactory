...
public class RefspecCodeFoldingManager {
	...
	private class FoldingUpdateListener implements org.emftext.language.refactoring.specification.resource.IRefspecBackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.language.refactoring.specification.resource.ui.RefspecEditor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.language.refactoring.specification.resource.ui.RefspecEditor) {
				org.emftext.language.refactoring.specification.resource.ui.RefspecEditor editor = (org.emftext.language.refactoring.specification.resource.ui.RefspecEditor) workbenchPart;
	...
	protected org.emftext.language.refactoring.specification.resource.ui.RefspecEditor editor;
	...
	public RefspecCodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.language.refactoring.specification.resource.ui.RefspecEditor textEditor) {
	...
	private void addCloseListener(final org.emftext.language.refactoring.specification.resource.ui.RefspecEditor editor) {
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.language.refactoring.specification.resource.mopp.RefspecPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.language.refactoring.specification.resource.IRefspecTextResource textResource = (org.emftext.language.refactoring.specification.resource.IRefspecTextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();

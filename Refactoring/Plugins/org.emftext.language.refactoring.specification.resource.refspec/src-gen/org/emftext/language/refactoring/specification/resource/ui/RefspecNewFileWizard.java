...
public class RefspecNewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	...
	private org.emftext.language.refactoring.specification.resource.ui.RefspecNewFileWizardPage page;
	...
	public void addPages() {
		page = new org.emftext.language.refactoring.specification.resource.ui.RefspecNewFileWizardPage(selection, getFileExtension());
		addPage(page);
	}
	...
	public boolean performFinish() {
		...
		try {
			...
			org.emftext.language.refactoring.specification.resource.mopp.RefspecPlugin.logError("java.lang.Exception while initializing new file", e1);
			return false;
		}
		...
		try {
			...
			org.emftext.language.refactoring.specification.resource.mopp.RefspecPlugin.logError("java.lang.Exception while initializing new file", e);
			return false;
		}
		return true;
	}
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.emftext.language.refactoring.specification.resource.mopp.RefspecMetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
	...
	public java.lang.String getFileExtension() {
		return new org.emftext.language.refactoring.specification.resource.mopp.RefspecMetaInformation().getSyntaxName();
	}

...
public class RefspecTextResourceUtil {
	...
	public static org.emftext.language.refactoring.specification.resource.mopp.RefspecResource getResource(org.eclipse.core.resources.IFile file) {
		...
		return (org.emftext.language.refactoring.specification.resource.mopp.RefspecResource) csResource;
	}
	
	public static org.emftext.language.refactoring.specification.resource.mopp.RefspecResource getResource(java.io.File file) {
		return getResource(file, null);
	}
	
	public static org.emftext.language.refactoring.specification.resource.mopp.RefspecResource getResource(java.io.File file, java.util.Map<?,?> options) {
		org.eclipse.emf.ecore.resource.ResourceSet rs = new org.eclipse.emf.ecore.resource.impl.ResourceSetImpl();
		if (options != null) {

...
public interface IRefspecMetaInformation {
	...
	// @param encoding
	// @return
	public org.emftext.language.refactoring.specification.resource.IRefspecTextParser createParser(java.io.InputStream inputStream, String encoding);
	...
	// @param resource
	// @return
	public org.emftext.language.refactoring.specification.resource.IRefspecTextPrinter createPrinter(java.io.OutputStream ouputStream, org.emftext.language.refactoring.specification.resource.IRefspecTextResource resource);
	...
	public org.emftext.language.refactoring.specification.resource.IRefspecTokenStyle getDefaultTokenStyle(String tokenName);

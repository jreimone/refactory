...
public class RefspecBrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.language.refactoring.specification.resource.ui.RefspecDocBrowserInformationControlInput fInput;
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.refactoring.specification.resource.ui.RefspecDocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.refactoring.specification.resource.ui.RefspecDocBrowserInformationControlInput) input;
		...
		org.emftext.language.refactoring.specification.resource.ui.RefspecHTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.refactoring.specification.resource.ui.RefspecHTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	...
	///
	public org.emftext.language.refactoring.specification.resource.ui.RefspecDocBrowserInformationControlInput getInput() {
		return fInput;
	}

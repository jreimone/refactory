...
// An interface for factories to create instances of org.emftext.language.refactoring.roles.resource.rolestext.IRolestextContextDependentURIFragment.
//
// @param <ContainerType> the type of the class containing the reference to be resolved
// @param <ReferenceType> the type of the reference to be resolved
//
public interface IRolestextContextDependentURIFragmentFactory<ContainerType extends org.eclipse.emf.ecore.EObject, ReferenceType extends org.eclipse.emf.ecore.EObject> {
	
	// Create a new instance of the org.emftext.language.refactoring.roles.resource.rolestext.IRolestextContextDependentURIFragment interface.
	//

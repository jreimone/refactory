...
public class RolestextNewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	...
	//
	// @param pageName
	public RolestextNewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new rolestext file");

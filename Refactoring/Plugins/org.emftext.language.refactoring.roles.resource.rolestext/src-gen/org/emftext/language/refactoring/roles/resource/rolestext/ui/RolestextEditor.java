...
//
// A text editor for 'rolestext' models.
//
public class RolestextEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	
	private org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextCodeFoldingManager codeFoldingManager;
	private org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextBackgroundParsingStrategy bgParsingStrategy = new org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextBackgroundParsingStrategy();
	private java.util.Collection<org.emftext.language.refactoring.roles.resource.rolestext.IRolestextBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.emftext.language.refactoring.roles.resource.rolestext.IRolestextBackgroundParsingListener>();
	private org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextColorManager colorManager = new org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextColorManager();
	private org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextOutlinePage outlinePage;
	...
	private org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextPropertySheetPage propertySheetPage;
	...
	public RolestextEditor() {
		super();
		setDocumentProvider(new org.eclipse.ui.editors.text.FileDocumentProvider());
		setSourceViewerConfiguration(new org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextEditorConfiguration(this, colorManager));
	...
	private final class MarkerUpdateListener implements org.emftext.language.refactoring.roles.resource.rolestext.IRolestextBackgroundParsingListener {
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), RolestextEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.emftext.language.refactoring.roles.resource.rolestext.IRolestextTextResource currentResource = getResource();
				...
				org.emftext.language.refactoring.roles.resource.rolestext.mopp.RolestextPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.emftext.language.refactoring.roles.resource.rolestext.mopp.RolestextNature.activate(inputFile.getProject());
		...
		org.emftext.language.refactoring.roles.resource.rolestext.IRolestextTextResource loadedResource = (org.emftext.language.refactoring.roles.resource.rolestext.IRolestextTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.emftext.language.refactoring.roles.resource.rolestext.IRolestextTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.emftext.language.refactoring.roles.resource.rolestext.IRolestextTextResource) {
					setResource((org.emftext.language.refactoring.roles.resource.rolestext.IRolestextTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but
					// some other EMF resource
					org.emftext.language.refactoring.roles.resource.rolestext.mopp.RolestextPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the RolestextEditor.");
					//close this editor because it can not present the resource
					close(false);
				}
			} catch (java.lang.Exception e) {
				org.emftext.language.refactoring.roles.resource.rolestext.mopp.RolestextPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.emftext.language.refactoring.roles.resource.rolestext.IRolestextTextResource resource) {
		assert resource != null;
	...
	private java.lang.Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.emftext.language.refactoring.roles.resource.rolestext.IRolestextTextResource textResource = (org.emftext.language.refactoring.roles.resource.rolestext.IRolestextTextResource) element.eResource();
			...
			org.emftext.language.refactoring.roles.resource.rolestext.IRolestextTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.emftext.language.refactoring.roles.resource.rolestext.IRolestextTextToken token = lexer.getNextToken();
			...
			org.emftext.language.refactoring.roles.resource.rolestext.mopp.RolestextPlugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(org.emftext.language.refactoring.roles.resource.rolestext.IRolestextBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.emftext.language.refactoring.roles.resource.rolestext.IRolestextBackgroundParsingListener listener : bgParsingListeners) {
	...
	private void refreshMarkers(final org.eclipse.emf.ecore.resource.Resource resourceToRefresh) {
		...
		if (display != null) {
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextMarkerHelper.unmark(resourceToRefresh);
						org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextMarkerHelper.mark(resourceToRefresh);
					} catch (org.eclipse.core.runtime.CoreException e) {
						org.emftext.language.refactoring.roles.resource.rolestext.mopp.RolestextPlugin.logError("Exception while updating markers on resource", e);
					}
				}
			});
		}

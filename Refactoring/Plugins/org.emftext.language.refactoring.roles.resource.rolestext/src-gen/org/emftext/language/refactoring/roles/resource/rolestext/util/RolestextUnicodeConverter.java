...
// bytes).
//
public class RolestextUnicodeConverter extends org.emftext.language.refactoring.roles.resource.rolestext.mopp.RolestextInputStreamProcessor {
	...
	public RolestextUnicodeConverter(java.io.InputStream inputStream) {

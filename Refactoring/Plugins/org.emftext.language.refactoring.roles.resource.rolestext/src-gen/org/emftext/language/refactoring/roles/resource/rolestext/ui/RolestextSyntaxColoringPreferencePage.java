...
///
public class RolestextSyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextSyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextSyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextSyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextSyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextSyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextSyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextSyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextPixelConverter pixelConverter = new org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextPixelConverter(composite);
	...
	public RolestextSyntaxColoringPreferencePage() {
		...
		org.emftext.language.refactoring.roles.resource.rolestext.IRolestextMetaInformation syntaxPlugin = new org.emftext.language.refactoring.roles.resource.rolestext.mopp.RolestextMetaInformation();
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextEditor) {
			org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextEditor emfTextEditor = (org.emftext.language.refactoring.roles.resource.rolestext.ui.RolestextEditor) editor;

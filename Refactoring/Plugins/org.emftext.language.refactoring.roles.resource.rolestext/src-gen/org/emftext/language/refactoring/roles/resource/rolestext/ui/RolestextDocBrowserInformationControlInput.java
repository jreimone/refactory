...
public class RolestextDocBrowserInformationControlInput {
	
	private final RolestextDocBrowserInformationControlInput fPrevious;
	private RolestextDocBrowserInformationControlInput fNext;
	...
	///
	public RolestextDocBrowserInformationControlInput(RolestextDocBrowserInformationControlInput previous, org.eclipse.emf.ecore.EObject element, org.eclipse.emf.ecore.resource.Resource resource, String htmlContent, String tokenText) {
		fPrevious= previous;
		if (previous != null) {
			previous.fNext= this;
		}
	...
	public RolestextDocBrowserInformationControlInput getPrevious() {
		return fPrevious;
	}
	...
	public RolestextDocBrowserInformationControlInput getNext() {
		return fNext;
	}

...
public class RolestextPlugin extends org.eclipse.ui.plugin.AbstractUIPlugin {
	
	public static final String PLUGIN_ID = "org.emftext.language.refactoring.roles.resource.rolestext";
	...
	private static RolestextPlugin plugin;
	
	public RolestextPlugin() {
		super();
	}
	...
	public static RolestextPlugin getDefault() {
		return plugin;
	}
	...
	public static org.eclipse.core.runtime.IStatus logError(String message, Throwable exception) {
		...
		if (exception != null) {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, RolestextPlugin.PLUGIN_ID, 0, message, exception);
		} else {
			status = new org.eclipse.core.runtime.Status(org.eclipse.core.runtime.IStatus.ERROR, RolestextPlugin.PLUGIN_ID, message);
		}
		final RolestextPlugin pluginInstance = RolestextPlugin.getDefault();

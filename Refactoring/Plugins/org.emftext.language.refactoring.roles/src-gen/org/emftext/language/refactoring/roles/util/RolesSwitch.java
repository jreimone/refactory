...
public class RolesSwitch<T> {
   ...
   */
    ...
    switch (classifierID)
    {
      ...
      case RolesPackage.MULTIPLICITY_RELATION:
      {
        MultiplicityRelation multiplicityRelation = (MultiplicityRelation)theEObject;
        T result = caseMultiplicityRelation(multiplicityRelation);
        if (result == null) result = caseRelation(multiplicityRelation);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case RolesPackage.ROLE_USE:
      {
        RoleUse roleUse = (RoleUse)theEObject;
        T result = caseRoleUse(roleUse);
        if (result == null) result = caseMultiplicityRelation(roleUse);
        if (result == null) result = caseRelation(roleUse);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case RolesPackage.ROLE_ASSOCIATION:
      {
        ...
        if (result == null) result = caseMultiplicityRelation(roleAssociation);
        if (result == null) result = caseRelation(roleAssociation);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case RolesPackage.ROLE_COMPOSITION:
      {
        ...
        if (result == null) result = caseMultiplicityRelation(roleComposition);
        if (result == null) result = caseRelation(roleComposition);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
   ...
   */
	...
	/**
   * Returns the result of interpreting the object as an instance of '<em>Multiplicity Relation</em>'.
   * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Multiplicity Relation</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
	public T caseMultiplicityRelation(MultiplicityRelation object) {
    return null;
  }

 ...
 * <ul>
 *   <li>{@link org.emftext.language.refactoring.roles.impl.RoleModelImpl#getRoles <em>Roles</em>}</li>
 *   <li>{@link org.emftext.language.refactoring.roles.impl.RoleModelImpl#getRelations <em>Relations</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RoleModelImpl extends NamedElementImpl implements RoleModel {
   ...
   */
    ...
    if (relations == null)
    {
      relations = new EObjectContainmentEList<Relation>(Relation.class, this, RolesPackage.ROLE_MODEL__RELATIONS);
    }
    return relations;
  }

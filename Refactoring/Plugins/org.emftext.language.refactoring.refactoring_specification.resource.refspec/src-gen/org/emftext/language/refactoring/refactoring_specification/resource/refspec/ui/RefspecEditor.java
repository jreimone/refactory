...
//
// A text editor for 'refspec' models.
//
public class RefspecEditor extends org.eclipse.ui.editors.text.TextEditor implements org.eclipse.emf.edit.domain.IEditingDomainProvider {
	
	private org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecHighlighting highlighting;
	private org.eclipse.jface.text.source.projection.ProjectionSupport projectionSupport;
	private org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecCodeFoldingManager codeFoldingManager;
	private org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecBackgroundParsingStrategy bgParsingStrategy = new org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecBackgroundParsingStrategy();
	private java.util.Collection<org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecBackgroundParsingListener> bgParsingListeners = new java.util.ArrayList<org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecBackgroundParsingListener>();
	private org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecColorManager colorManager = new org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecColorManager();
	private org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecOutlinePage outlinePage;
	...
	private org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecPropertySheetPage propertySheetPage;
	...
	public RefspecEditor() {
		super();
		setDocumentProvider(new org.eclipse.ui.editors.text.FileDocumentProvider());
		setSourceViewerConfiguration(new org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecEditorConfiguration(this, colorManager));
	...
	private final class MarkerUpdateListener implements org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecBackgroundParsingListener {
	...
	private final class DocumentListener implements org.eclipse.jface.text.IDocumentListener {
		...
		public void documentChanged(org.eclipse.jface.text.DocumentEvent event) {
			bgParsingStrategy.parse(event, getResource(), RefspecEditor.this);
		}
	}
	...
	private class ModelResourceChangeListener implements org.eclipse.core.resources.IResourceChangeListener {
		public void resourceChanged(org.eclipse.core.resources.IResourceChangeEvent event) {
			...
			try {
					...
					public boolean visit(org.eclipse.core.resources.IResourceDelta delta) {
						...
						if (deltaKind == org.eclipse.core.resources.IResourceDelta.CHANGED && delta.getFlags() != org.eclipse.core.resources.IResourceDelta.MARKERS) {
							...
							if (changedResource != null) {
								...
								org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecTextResource currentResource = getResource();
				...
				org.emftext.language.refactoring.refactoring_specification.resource.refspec.mopp.RefspecPlugin.logError("Unexpected Error: ", exception);
			}
		}
	}
	...
	public void createPartControl(org.eclipse.swt.widgets.Composite parent) {
		...
		highlighting = new org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecHighlighting(getResource(), viewer, colorManager, this);
		...
		codeFoldingManager = new org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecCodeFoldingManager(viewer, this);
	}
	...
	private void initializeResourceObject(org.eclipse.ui.IEditorInput editorInput) {
		...
		org.emftext.language.refactoring.refactoring_specification.resource.refspec.mopp.RefspecNature.activate(inputFile.getProject());
		...
		org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecTextResource loadedResource = (org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecTextResource) resourceSet.getResource(uri, false);
		if (loadedResource == null) {
			try {
				...
				org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecTextResource currentResource = this.resource;
				...
				if (demandLoadedResource instanceof org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecTextResource) {
					setResource((org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecTextResource) demandLoadedResource);
				} else {
					// the resource was not loaded by an EMFText resource, but
					// some other EMF resource
					org.emftext.language.refactoring.refactoring_specification.resource.refspec.mopp.RefspecPlugin.showErrorDialog("No EMFText resource.", "The file '" + uri.lastSegment() + "' of type '" + uri.fileExtension() + "' can not be handled by the RefspecEditor.");
					//close this editor because it can not present the resource
					close(false);
				}
			} catch (java.lang.Exception e) {
				org.emftext.language.refactoring.refactoring_specification.resource.refspec.mopp.RefspecPlugin.logError("Exception while loading resource in " + this.getClass().getSimpleName() + ".", e);
			}
		} else {
	...
	private void setResource(org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecTextResource resource) {
		assert resource != null;
	...
	private java.lang.Object getOutlinePage() {
		if (outlinePage == null) {
			outlinePage = new org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecOutlinePage(this);
	...
	public org.eclipse.ui.views.properties.IPropertySheetPage getPropertySheetPage() {
		if (propertySheetPage == null) {
			propertySheetPage = new org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecPropertySheetPage();
	...
	public void setCaret(org.eclipse.emf.ecore.EObject element, String text) {
		try {
			...
			org.eclipse.jface.text.source.ISourceViewer viewer = getSourceViewer();
			org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecTextResource textResource = (org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecTextResource) element.eResource();
			...
			org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecTextScanner lexer = getResource().getMetaInformation().createLexer();
			try {
				lexer.setText(viewer.getDocument().get(destination, length));
				org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecTextToken token = lexer.getNextToken();
			...
			org.emftext.language.refactoring.refactoring_specification.resource.refspec.mopp.RefspecPlugin.logError("java.lang.Exception in setCaret()", e);
		}
	}
	...
	public void addBackgroundParsingListener(org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecBackgroundParsingListener listener) {
		bgParsingListeners.add(listener);
	}
	
	public void notifyBackgroundParsingFinished() {
		for (org.emftext.language.refactoring.refactoring_specification.resource.refspec.IRefspecBackgroundParsingListener listener : bgParsingListeners) {
	...
	private void refreshMarkers(final org.eclipse.emf.ecore.resource.Resource resourceToRefresh) {
		...
		if (display != null) {
			display.asyncExec(new java.lang.Runnable() {
				public void run() {
					try {
						org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecMarkerHelper.unmark(resourceToRefresh);
						org.emftext.language.refactoring.refactoring_specification.resource.refspec.ui.RefspecMarkerHelper.mark(resourceToRefresh);
					} catch (org.eclipse.core.runtime.CoreException e) {
						org.emftext.language.refactoring.refactoring_specification.resource.refspec.mopp.RefspecPlugin.logError("Exception while updating markers on resource", e);
					}
				}
			});
		}

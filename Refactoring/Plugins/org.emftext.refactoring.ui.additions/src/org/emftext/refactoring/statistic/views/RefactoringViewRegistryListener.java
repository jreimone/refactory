...
import org.emftext.refactoring.statistic.views.RefactoringStatisticView.ViewContentProvider;
...
public class RefactoringViewRegistryListener implements IRoleModelRegistryListener, IRefactoringSpecificationRegistryListener, IRoleMappingRegistryListener {
	...
	public RefactoringViewRegistryListener(ViewContentProvider contentProvider) {
		super();

...
import org.emftext.language.refactoring.roles.diagram.providers.RolesMarkerNavigationProvider;
import org.emftext.language.refactoring.roles.diagram.providers.RolesValidationProvider;
...
public class ValidateAction extends Action {
	...
	*/
	private static void createMarkers(
		...
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			...
			View view = RolesDiagramEditorUtil.findView(
					diagramEditPart, nextStatus.getTarget(), element2ViewMap);
			addMarker(diagramEditPart.getViewer(), target,
	...
	*/
	private static void createMarkers(
		...
		RolesDiagramEditorUtil.LazyElement2ViewMap element2ViewMap =
				new RolesDiagramEditorUtil.LazyElement2ViewMap(
						diagramEditPart.getDiagramView(),
						collectTargetElements(rootStatus,
	...
	*/
	private static void addMarker(EditPartViewer viewer,
		...
		RolesMarkerNavigationProvider.addMarker(

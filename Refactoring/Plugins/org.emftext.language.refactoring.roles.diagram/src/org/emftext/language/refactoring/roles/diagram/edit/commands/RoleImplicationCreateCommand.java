 ...
 * @generated
 */
public class RoleImplicationCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RoleImplicationCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	public boolean canExecute() {
		...
		return RolesBaseItemSemanticEditPolicy.getLinkConstraints().canCreateRoleImplication_4001(getContainer(), getSource(), getTarget());
	}
	 ...
	 * @generated
	 */
	protected void doConfigure(RoleImplication newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {

 ...
 * @generated
 */
public class RoleProhibitionReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RoleProhibitionReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof RoleProhibition) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return RolesBaseItemSemanticEditPolicy.LinkConstraints.canExistRoleProhibition_4002(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		RoleModel container = (RoleModel) getLink().eContainer();
		return RolesBaseItemSemanticEditPolicy.LinkConstraints.canExistRoleProhibition_4002(container, source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected RoleProhibition getLink() {
		return (RoleProhibition) getElementToEdit();
	}

 ...
 * @generated
 */
public class RoleAssociationCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return RolesBaseItemSemanticEditPolicy.getLinkConstraints().canCreateRoleAssociation_4003(
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ElementInitializers.getInstance().init_RoleAssociation_4003(newElement);

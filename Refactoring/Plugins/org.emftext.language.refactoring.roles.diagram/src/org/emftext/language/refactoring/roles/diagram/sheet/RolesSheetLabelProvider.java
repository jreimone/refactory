package org.emftext.language.refactoring.roles.diagram.sheet;
...
import org.emftext.language.refactoring.roles.diagram.navigator.RolesNavigatorGroup;
...
public class RolesSheetLabelProvider extends BaseLabelProvider implements
	...
	public String getText(Object element) {
		...
		if (element instanceof RolesNavigatorGroup) {
			return ((RolesNavigatorGroup) element).getGroupName();
		}
	...
	public Image getImage(Object element) {
		...
		return etype == null ? null : RolesElementTypes.getImage(etype);
	}

 ...
 * @generated
 */
public class RoleImplicationReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RoleImplicationReorientCommand(ReorientRelationshipRequest request) {
	...
	public boolean canExecute() {
		if (false == getElementToEdit() instanceof RoleImplication) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		...
		return RolesBaseItemSemanticEditPolicy.getLinkConstraints().canExistRoleImplication_4001(container, getLink(), getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		RoleModel container = (RoleModel) getLink().eContainer();
		return RolesBaseItemSemanticEditPolicy.getLinkConstraints().canExistRoleImplication_4001(container, getLink(), source, getNewTarget());
	}
	 ...
	 * @generated
	 */
	protected RoleImplication getLink() {
		return (RoleImplication) getElementToEdit();
	}

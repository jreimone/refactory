...
public class RoleCompositionReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return RolesBaseItemSemanticEditPolicy.LinkConstraints.canExistRoleComposition_4004(container, getNewSource(), target);
	}
	...
	protected boolean canReorientTarget() {
		...
		RoleModel container = (RoleModel) getLink().eContainer();
		return RolesBaseItemSemanticEditPolicy.LinkConstraints.canExistRoleComposition_4004(container, source, getNewTarget());
	}

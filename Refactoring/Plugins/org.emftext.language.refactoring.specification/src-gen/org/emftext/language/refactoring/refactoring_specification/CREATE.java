 ...
 * @generated
 */
public interface CREATE extends ContainmentCommand {
	/**
	 * Returns the value of the '<em><b>Var Declaration</b></em>' containment reference.
	 * It is bidirectional and its opposite is '{@link org.emftext.language.refactoring.refactoring_specification.Variable#getCreateCommand <em>Create Command</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @model opposite="createCommand" containment="true"
	 * @generated
	 */

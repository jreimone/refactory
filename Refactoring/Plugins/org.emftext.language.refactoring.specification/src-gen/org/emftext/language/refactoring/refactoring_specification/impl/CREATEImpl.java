	...
	public void setVarDeclaration(Variable newVarDeclaration) {
		if (newVarDeclaration != varDeclaration) {
			...
			if (varDeclaration != null)
				msgs = ((InternalEObject)varDeclaration).eInverseRemove(this, RefactoringSpecificationPackage.VARIABLE__CREATE_COMMAND, Variable.class, msgs);
			if (newVarDeclaration != null)
				msgs = ((InternalEObject)newVarDeclaration).eInverseAdd(this, RefactoringSpecificationPackage.VARIABLE__CREATE_COMMAND, Variable.class, msgs);
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RefactoringSpecificationPackage.CREATE__VAR_DECLARATION:
				...
				return basicSetVarDeclaration((Variable)otherEnd, msgs);
		}
